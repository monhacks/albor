...
void CB2_InitOptionMenu(void)
{
    ...
    case 4:
        ...
        LoadPalette(GetWindowFrameTilesPal(gSaveBlockPtr->optionsWindowFrameType)->pal, BG_PLTT_ID(7), PLTT_SIZE_4BPP);
        gMain.state++;
        break;
    case 5:
    ...
    case 10:
    {
        ...
        gTasks[taskId].tTextSpeed = gSaveBlockPtr->optionsTextSpeed;
        gTasks[taskId].tBattleSceneOff = gSaveBlockPtr->optionsBattleSceneOff;
        gTasks[taskId].tBattleStyle = gSaveBlockPtr->optionsBattleStyle;
        gTasks[taskId].tSound = gSaveBlockPtr->optionsSound;
        gTasks[taskId].tButtonMode = gSaveBlockPtr->optionsButtonMode;
        gTasks[taskId].tWindowFrameType = gSaveBlockPtr->optionsWindowFrameType;
...
static void Task_OptionMenuSave(u8 taskId)
{
    gSaveBlockPtr->optionsTextSpeed = gTasks[taskId].tTextSpeed;
    gSaveBlockPtr->optionsBattleSceneOff = gTasks[taskId].tBattleSceneOff;
    gSaveBlockPtr->optionsBattleStyle = gTasks[taskId].tBattleStyle;
    gSaveBlockPtr->optionsSound = gTasks[taskId].tSound;
