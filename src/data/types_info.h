...
{//                   Defender -->
 //  Attacker             Ninguno  Normal  Lucha   Volador Veneno  Tierra  Roca    Bicho   Fantasma Acero   Misterio Fuego   Agua    Planta  Eléctrico Psíquico Hielo   Dragón  Siniestro Hada
    ...
    [TIPO_VOLADOR]      = {______, ______, X(2.0), ______, ______, ______, X(0.5), X(2.0), ______,  X(0.5), ______,  ______, ______, X(2.0), X(0.5),   ______,  ______, ______, ______,   ______},
    ...
    [TIPO_TIERRA]       = {______, ______, ______, X(0.0), X(2.0), ______, X(2.0), X(0.5), ______,  X(2.0), ______,  X(2.0), ______, X(0.5), X(2.0),   ______,  ______, ______, ______,   ______},
    ...
    [TIPO_ELECTRICO]    = {______, ______, ______, X(2.0), ______, X(0.0), ______, ______, ______,  ______, ______,  ______, X(2.0), X(0.5), X(0.5),   ______,  ______, X(0.5), ______,   ______},
