...
const u8 gEasyChatWord_Give[] = _("Dar");
...
const u8 gEasyChatWord_Search[] = _("Buscar");
...
const u8 gEasyChatWord_Use[] = _("Usar");
...
const u8 gEasyChatWord_Show[] = _("Mostrar");
...
const u8 gEasyChatWord_Take[] = _("Tomar");
