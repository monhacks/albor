...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    [SPECIES_RATTATA_ALOLA] =
    {
        ...
        HABILIDADES(GLUTTONY, THICK_FAT, PESTE_BUBONICA),
        SOMBRA(-2, 2, S),
    ...
    [SPECIES_SPEAROW] =
    {
        ...
        AMISTAD(NORMAL),
        EV_VELOCIDAD(1),
        OBJETO_RARO(SHARP_BEAK),
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(PAJARO),
        HABILIDADES(LONG_REACH, CARPINTERO, AVE_RAPAZ),
        NOMBRE(Spearow),
        GRITO(SPEAROW),
        POKEDEX(SPEAROW),
        SOMBRA(0, 1, S),
    ...
    [SPECIES_ODDISH] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(75)),
        GRUPO_HUEVO(PLANTA),
        HABILIDADES(VENENOSO, ALERGIA, ESPORA_TOXICA),
        SOMBRA(1, -2, S),
        NOMBRE(Oddish),
        GRITO(ODDISH),
        POKEDEX(ODDISH),
    ...
    [SPECIES_BELLOSSOM] =
    {
        ...
        HABILIDADES(CHLOROPHYLL, BAILARIN, FLOWER_VEIL),
        SOMBRA(0, 0, S),
        NOMBRE(Bellossom),
        GRITO(BELLOSSOM),
        POKEDEX(BELLOSSOM),
    ...
    [SPECIES_DIGLETT] =
    {
        ...
        DEFENSA_ESPECIAL(45),
        TIPO(TIERRA),
        HABILIDADES(ARENA_TRAP, GUACAMOLE, SAND_VEIL),
        SIN_SOMBRA,
    ...
    [SPECIES_DUGTRIO] =
    {
        ...
        DEFENSA_ESPECIAL(100),
        TIPO(TIERRA),
        HABILIDADES(ARENA_TRAP, GUACAMOLE, HAZLO_TRIPLE),
        SIN_SOMBRA,
    ...
    [SPECIES_MEOWTH_ALOLA] =
    {
        ...
        EV_DEFENSA(1),
        TIPO(SINIESTRO),
        HABILIDADES(RATTLED, TECHNICIAN, EN_METALICO),
        SOMBRA(-2, 4, S),
    ...
    [SPECIES_GROWLITHE_HISUI] =
    {
        ...
        DEFENSA_ESPECIAL(50),
        TIPOS(FUEGO, ROCA),
        HABILIDADES(INTIMIDATE, ROCK_HEAD, GUARDIAN),
        SOMBRA(0, 3, S),
        RATIO_CAPTURA(ESPECIAL_1_EVO),
        CAMPO_EXPERIENCIA(ESPECIAL_1_EVO),
        CICLO_HUEVO(ESPECIAL),
    ...
    [SPECIES_GEODUDE_ALOLA] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(MINERAL),
        HABILIDADES(MAGNET_PULL, STURDY, GALVANIZE),
        NOMBRE(A-Geodude),
        GRITO(GEODUDE),
    ...
    {
        HABILIDADES(RUN_AWAY, PASTEL_VEIL, ANTICIPATION),
        PS(50),
        ATAQUE(85),
        DEFENSA(55),
        VELOCIDAD(90),
    ...
    [SPECIES_SLOWPOKE] =
    {
        ...
        POKEDEX(SLOWPOKE),
        TIPOS(AGUA, PSIQUICO),
        OBJETO_RARO(LAGGING_TAIL),
        HABILIDADES(OBLIVIOUS, OWN_TEMPO, REGENERATOR),
        GRITO(SLOWPOKE),
    ...
    [SPECIES_DODUO] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(PAJARO),
        HABILIDADES(RUN_AWAY, EARLY_BIRD, TANGLED_FEET),
        NOMBRE(Doduo),
        GRITO(DODUO),
        POKEDEX(DODUO),
    ...
    [SPECIES_DODRIO] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(PAJARO),
        HABILIDADES(RUN_AWAY, EARLY_BIRD, HAZLO_TRIPLE),
        NOMBRE(Dodrio),
        GRITO(DODRIO),
        POKEDEX(DODRIO),
    ...
    [SPECIES_SEEL] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPOS_HUEVO(ANFIBIO, CAMPESTRE),
        HABILIDADES(THICK_FAT, HYDRATION, ICE_BODY),
        NOMBRE(Seel),
        GRITO(SEEL),
        POKEDEX(SEEL),
    ...
    [SPECIES_WOOPER] =
    {
        ...
        POKEDEX(WOOPER),
        TIPOS(AGUA, TIERRA),
        HABILIDADES(DAMP, WATER_ABSORB, UNAWARE),
    ...
    [SPECIES_WOOPER_PALDEA] =
    {
        ...
        TIPOS(VENENO, TIERRA),
        HABILIDADES(POISON_POINT, WATER_ABSORB, UNAWARE),
    ...
    [SPECIES_PINECO] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(BICHO),
        HABILIDADES(STURDY, NONE, OVERCOAT),
        NOMBRE(Pineco),
        GRITO(PINECO),
        POKEDEX(PINECO),
    ...
    [SPECIES_REMORAID] =
    {
        ...
        HABILIDADES(HUSTLE, SNIPER, MOODY),
        NOMBRE(Remoraid),
        GRITO(REMORAID),
        POKEDEX(REMORAID),
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPOS_HUEVO(ANFIBIO, PEZ),
        HABILIDADES(SUCTION_CUPS, SNIPER, MOODY),
        NOMBRE(Octillery),
        GRITO(OCTILLERY),
        POKEDEX(OCTILLERY),
    ...
    [SPECIES_MILTANK] =
    {
        ...
        AMISTAD(ESPECIAL),
        EV_DEFENSA(2),
        OBJETO_COMUN(MOOMOO_MILK),
        OBJETO_RARO(MOOMOO_MILK),
        GENERO(MON_FEMALE),
        GRUPO_HUEVO(CAMPESTRE),
        HABILIDADES(THICK_FAT, SCRAPPY, SAP_SIPPER),
        NOMBRE(Miltank),
        GRITO(MILTANK),
        POKEDEX(MILTANK),
    ...
    [SPECIES_ZIGZAGOON] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(CAMPESTRE),
        HABILIDADES(PICKUP, GLUTTONY, QUICK_FEET),
        SOMBRA(-1, -3, S),
        NOMBRE(Zigzagoon),
        GRITO(ZIGZAGOON),
        POKEDEX(ZIGZAGOON),
    ...
    [SPECIES_SHROOMISH] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPOS_HUEVO(HADA, PLANTA),
        HABILIDADES(EFFECT_SPORE, POISON_HEAL, QUICK_FEET),
        NOMBRE(Shroomish),
        GRITO(SHROOMISH),
        POKEDEX(SHROOMISH),
    ...
    [SPECIES_BRELOOM] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPOS_HUEVO(HADA, PLANTA),
        HABILIDADES(EFFECT_SPORE, POISON_HEAL, TECHNICIAN),
        NOMBRE(Breloom),
        GRITO(BRELOOM),
        POKEDEX(BRELOOM),
    ...
    [SPECIES_SPOINK] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(CAMPESTRE),
        HABILIDADES(THICK_FAT, OWN_TEMPO, GLUTTONY),
        NOMBRE(Spoink),
        GRITO(SPOINK),
        POKEDEX(SPOINK),
    ...
    [SPECIES_PACHIRISU] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPOS_HUEVO(CAMPESTRE, HADA),
        HABILIDADES(RUN_AWAY, PICKUP, VOLT_ABSORB),
        NOMBRE(Pachirisu),
        GRITO(PACHIRISU),
        POKEDEX(PACHIRISU),
    ...
    [SPECIES_CHERUBI] =
    {
        ...
        AMISTAD(NORMAL),
        EV_ATAQUE_ESPECIAL(1),
        OBJETO_RARO(MIRACLE_SEED),
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPOS_HUEVO(HADA, PLANTA),
        HABILIDADES(CHLOROPHYLL, NONE, NONE),
        NOMBRE(Cherubi),
        GRITO(CHERUBI),
        POKEDEX(CHERUBI),
    ...
    [SPECIES_CHERRIM_OVERCAST] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPOS_HUEVO(HADA, PLANTA),
        HABILIDADES(FLOWER_GIFT, NONE, NONE),
        NOMBRE(Cherrim),
        GRITO(CHERRIM),
        POKEDEX(CHERRIM),
        MOVIMIENTOS(Cherrim),
    ...
    [SPECIES_SHELLOS_WEST] =
    {
        ...
        HABILIDADES(STICKY_HOLD, STORM_DRAIN, SAND_FORCE),
        NOMBRE(Shellos),
        GRITO(SHELLOS),
        POKEDEX(SHELLOS),
    ...
    [SPECIES_BRONZOR] =
    {
        ...
        GENERO(MON_GENDERLESS),
        GRUPO_HUEVO(MINERAL),
        HABILIDADES(LEVITATE, HEATPROOF, HEAVY_METAL),
        NOMBRE(Bronzor),
        GRITO(BRONZOR),
        POKEDEX(BRONZOR),
    ...
    [SPECIES_BLITZLE] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(CAMPESTRE),
        HABILIDADES(LIGHTNING_ROD, MOTOR_DRIVE, SAP_SIPPER),
        NOMBRE(Blitzle),
        GRITO(BLITZLE),
        POKEDEX(BLITZLE),
    ...
    [SPECIES_TIMBURR] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(25)),
        GRUPO_HUEVO(HUMANOIDE),
        HABILIDADES(GUTS, SHEER_FORCE, IRON_FIST),
        NOMBRE(Timburr),
        GRITO(TIMBURR),
        POKEDEX(TIMBURR),
    ...
    [SPECIES_SANDILE] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(CAMPESTRE),
        HABILIDADES(INTIMIDATE, MOXIE, ANGER_POINT),
        NOMBRE(Sandile),
        GRITO(SANDILE),
        POKEDEX(SANDILE),
    ...
    [SPECIES_SCRAGGY] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPOS_HUEVO(CAMPESTRE, DRAGON),
        HABILIDADES(SHED_SKIN, MOXIE, INTIMIDATE),
        NOMBRE(Scraggy),
        GRITO(SCRAGGY),
        POKEDEX(SCRAGGY),
    ...
    [SPECIES_GOTHITA] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(75)),
        GRUPO_HUEVO(HUMANOIDE),
        HABILIDADES(FRISK, COMPETITIVE, SHADOW_TAG),
        NOMBRE(Gothita),
        GRITO(GOTHITA),
        POKEDEX(GOTHITA),
    ...
    [SPECIES_FOONGUS] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(PLANTA),
        HABILIDADES(EFFECT_SPORE, NONE, REGENERATOR),
        NOMBRE(Foongus),
        GRITO(FOONGUS),
        POKEDEX(FOONGUS),
    ...
    [SPECIES_GOLETT] =
    {
        ...
        GENERO(MON_GENDERLESS),
        GRUPO_HUEVO(MINERAL),
        HABILIDADES(IRON_FIST, KLUTZ, NO_GUARD),
        NO_VOLTEAR,
        NOMBRE(Golett),
        GRITO(GOLETT),
        POKEDEX(GOLETT),
    ...
    [SPECIES_RUFFLET] =
    {
        ...
        GENERO(MON_MALE),
        GRUPO_HUEVO(PAJARO),
        HABILIDADES(KEEN_EYE, SHEER_FORCE, HUSTLE),
        NOMBRE(Rufflet),
        GRITO(RUFFLET),
        POKEDEX(RUFFLET),
    ...
    [SPECIES_BRAVIARY] =
    {
        ...
        TIPOS(NORMAL, VOLADOR),
        EV_ATAQUE(2),
        HABILIDADES(KEEN_EYE, SHEER_FORCE, DEFIANT),
    ...
    [SPECIES_BRAVIARY_HISUI] =
    {
        ...
        TIPOS(PSIQUICO, VOLADOR),
        EV_ATAQUE_ESPECIAL(2),
        HABILIDADES(KEEN_EYE, SHEER_FORCE, TINTED_LENS),
    ...
    [SPECIES_VULLABY] =
    {
        ...
        GENERO(MON_FEMALE),
        GRUPO_HUEVO(PAJARO),
        HABILIDADES(BIG_PECKS, OVERCOAT, WEAK_ARMOR),
        NOMBRE(Vullaby),
        GRITO(VULLABY),
        POKEDEX(VULLABY),
    ...
    [SPECIES_BUNNELBY] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(CAMPESTRE),
        HABILIDADES(PICKUP, CHEEK_POUCH, HUGE_POWER),
        NOMBRE(Bunnelby),
        GRITO(BUNNELBY),
        POKEDEX(BUNNELBY),
    ...
    [SPECIES_SKIDDO] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(CAMPESTRE),
        HABILIDADES(SAP_SIPPER, NONE, GRASS_PELT),
        NOMBRE(Skiddo),
        GRITO(SKIDDO),
        POKEDEX(SKIDDO),
    ...
    [SPECIES_PHANTUMP] =
    {
        ...
        HABILIDADES(NATURAL_CURE, FRISK, HARVEST),
        NOMBRE(Phantump),
        GRITO(PHANTUMP),
        POKEDEX(PHANTUMP),
    ...
    [SPECIES_DECIDUEYE_HISUI] =
    {
        ...
        DEFENSA_ESPECIAL(95),
        TIPOS(PLANTA, LUCHA),
        HABILIDADES(OVERGROW, NONE, SCRAPPY),
    ...
    [SPECIES_ROCKRUFF] =
    {
        ...
        HABILIDADES(KEEN_EYE, VITAL_SPIRIT, STEADFAST),
    ...
    [SPECIES_LYCANROC_MIDDAY] =
    {
        ...
        ATAQUE_ESPECIAL(55),
        DEFENSA_ESPECIAL(65),
        HABILIDADES(KEEN_EYE, SAND_RUSH, STEADFAST),
    ...
    [SPECIES_LYCANROC_MIDNIGHT] =
    {
        ...
        ATAQUE_ESPECIAL(55),
        DEFENSA_ESPECIAL(75),
        HABILIDADES(KEEN_EYE, VITAL_SPIRIT, NO_GUARD),
    ...
    [SPECIES_LYCANROC_DUSK] =
    {
        ...
        ATAQUE_ESPECIAL(55),
        DEFENSA_ESPECIAL(65),
        HABILIDADES(TOUGH_CLAWS, NONE, NONE),
        GRITO(LYCANROC_DUSK),
    ...
    [SPECIES_MIMIKYU_DISGUISED] =
    {
        ...
        AMISTAD(ESPECIAL),
        EV_DEFENSA_ESPECIAL(2),
        OBJETO_RARO(CHESTO_BERRY),
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(AMORFO),
        HABILIDADES(DISGUISE, NONE, NONE),
        NOMBRE(Mimikyu),
        GRITO(MIMIKYU),
        POKEDEX(MIMIKYU),
        MOVIMIENTOS(Mimikyu),
    ...
    [SPECIES_TOXEL] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(BEBE),
        HABILIDADES(RATTLED, STATIC, KLUTZ ),
        NOMBRE(Toxel),
        GRITO(TOXEL),
        POKEDEX(TOXEL),
    ...
    [SPECIES_TOXTRICITY_AMPED] =
    {
        ...
        HABILIDADES(PUNK_ROCK, PLUS, TECHNICIAN),
    ...
    [SPECIES_TOXTRICITY_LOW_KEY] =
    {
        ...
        POKEDEX(TOXTRICITY),
        .formSpeciesIdTable = sToxtricityFormSpeciesIdTable,
        HABILIDADES(PUNK_ROCK, MINUS, TECHNICIAN),
    ...
    [SPECIES_REGIELEKI] =
    {
        ...
        GENERO(MON_GENDERLESS),
        GRUPO_HUEVO(BEBE),
        HABILIDADES(TRANSISTOR, NONE, NONE),
        NOMBRE(Regieleki),
        GRITO(REGIELEKI),
        POKEDEX(REGIELEKI),
    ...
    [SPECIES_REGIDRAGO] =
    {
        ...
        GENERO(MON_GENDERLESS),
        GRUPO_HUEVO(BEBE),
        HABILIDADES(DRAGONS_MAW, NONE, NONE),
        LEGENDARIO,
        NOMBRE(Regidrago),
        GRITO(REGIDRAGO),
        POKEDEX(REGIDRAGO),
    ...
    [SPECIES_GLIMMET] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(MINERAL),
        HABILIDADES(TOXIC_DEBRIS, NONE, CORROSION),
        NOMBRE(Glimmet),
        GRITO(GLIMMET),
        POKEDEX(GLIMMET),
    ...
    [SPECIES_GREAVARD] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(CAMPESTRE),
        HABILIDADES(PICKUP, NONE, FLUFFY),
        NOMBRE(Greavard),
        GRITO(GREAVARD),
        POKEDEX(GREAVARD),
    ...
    [SPECIES_HOUNDSTONE] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(CAMPESTRE),
        HABILIDADES(SAND_RUSH, NONE, FLUFFY),
        NOMBRE(Houndstone),
        GRITO(HOUNDSTONE),
        POKEDEX(HOUNDSTONE),
