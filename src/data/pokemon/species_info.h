...
#define PALETA(pal) .palette = gMonPalette_## pal,  .shinyPalette = gMonShinyPalette_## pal

#define PALETA_HEMBRA(pal)  .paletteFemale = gMonPalette_## pal##F, .shinyPaletteFemale = gMonShinyPalette_## pal##F
...
#define TIPOS(type1, type2) .types = {TYPE_##type1, TYPE_##type2}

#define TIPO(type) .types = {TYPE_##type, TYPE_##type}
...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    [SPECIES_DARMANITAN_GALAR_STANDARD] =
    {
        ...
        .backPicYOffset = 2,
        //.backAnimId = BACK_ANIM_NONE,
        PALETA(DarmanitanGalarStandard),
        .itemRare = ITEM_SNOWBALL,
