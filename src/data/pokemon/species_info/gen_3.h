...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TREECKO] =
    {
        ...
        ICON(Treecko),
        FOOTPRINT(Treecko)
        FOLLOWER(Treecko, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Treecko),
    ...
    [SPECIES_GROVYLE] =
    {
        ...
        ICON(Grovyle),
        FOOTPRINT(Grovyle)
        FOLLOWER(Grovyle, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Grovyle),
...
#define SCEPTILE_MISC_INFO                                              \
    ...
    [SPECIES_SCEPTILE] =
    {
        ...
        PALETTES(Sceptile),
        ICON(Sceptile),
        FOLLOWER(Sceptile, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        ICON(Torchic),
        FOOTPRINT(Torchic)
        FOLLOWER(Torchic, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Torchic),
    ...
    [SPECIES_COMBUSKEN] =
    {
        ...
        ICON(Combusken),
        FOOTPRINT(Combusken)
        FOLLOWER(Combusken, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Combusken),
...
#define BLAZIKEN_MISC_INFO                                  \
    ...
    [SPECIES_BLAZIKEN] =
    {
        ...
        PALETTES(Blaziken),
        ICON(Blaziken),
        FOLLOWER(Blaziken, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_MUDKIP] =
    {
        ...
        ICON(Mudkip),
        FOOTPRINT(Mudkip)
        FOLLOWER(Mudkip, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Mudkip),
    ...
    [SPECIES_MARSHTOMP] =
    {
        ...
        ICON(Marshtomp),
        FOOTPRINT(Marshtomp)
        FOLLOWER(Marshtomp, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Marshtomp),
...
#define SWAMPERT_MISC_INFO                                               \
    ...
    [SPECIES_SWAMPERT] =
    {
        ...
        PALETTES(Swampert),
        ICON(Swampert),
        FOLLOWER(Swampert, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_POOCHYENA] =
    {
        ...
        ICON(Poochyena),
        FOOTPRINT(Poochyena)
        FOLLOWER(Poochyena, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Poochyena),
    ...
    [SPECIES_MIGHTYENA] =
    {
        ...
        ICON(Mightyena),
        FOOTPRINT(Mightyena)
        FOLLOWER(Mightyena, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Mightyena),
    },
...
#define LINOONE_MISC_INFO                                                       \
    ...
    [SPECIES_ZIGZAGOON] =
    {
        ...
        PALETTES(Zigzagoon),
        ICON(Zigzagoon),
        FOLLOWER(Zigzagoon, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Zigzagoon),
    ...
    [SPECIES_LINOONE] =
    {
        ...
        PALETTES(Linoone),
        ICON(Linoone),
        FOLLOWER(Linoone, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Linoone),
    },
    ...
    [SPECIES_ZIGZAGOON_GALARIAN] =
    {
        ...
        FOLLOWER(ZigzagoonGalarian, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_LINOONE_GALARIAN] =
    {
        ...
        FOLLOWER(LinooneGalarian, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_OBSTAGOON] =
    {
        ...
        ICON(Obstagoon),
        FOOTPRINT(Obstagoon)
        FOLLOWER(Obstagoon, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Obstagoon),
    },
    ...
    [SPECIES_WURMPLE] =
    {
        ...
        ICON(Wurmple),
        FOOTPRINT(Wurmple)
        FOLLOWER(Wurmple, SHADOW_SIZE_M, TRACKS_BUG)
        LEARNSETS(Wurmple),
        .tmIlliterate = TRUE,
    ...
    [SPECIES_SILCOON] =
    {
        ...
        ICON(Silcoon),
        FOOTPRINT(Silcoon)
        FOLLOWER(Silcoon, SHADOW_SIZE_M, TRACKS_BUG)
        LEARNSETS(Silcoon),
        .tmIlliterate = TRUE,
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        ICON(Beautifly),
        FOOTPRINT(Beautifly)
        FOLLOWER(Beautifly, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Beautifly),
    },
    ...
    [SPECIES_CASCOON] =
    {
        ...
        ICON(Cascoon),
        FOOTPRINT(Cascoon)
        FOLLOWER(Cascoon, SHADOW_SIZE_M, TRACKS_BUG)
        LEARNSETS(Cascoon),
        .tmIlliterate = TRUE,
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        ICON(Dustox),
        FOOTPRINT(Dustox)
        FOLLOWER(Dustox, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Dustox),
    },
    ...
    [SPECIES_LOTAD] =
    {
        ...
        ICON(Lotad),
        FOOTPRINT(Lotad)
        FOLLOWER(Lotad, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Lotad),
    ...
    [SPECIES_LOMBRE] =
    {
        ...
        ICON(Lombre),
        FOOTPRINT(Lombre)
        FOLLOWER(Lombre, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Lombre),
    ...
    [SPECIES_LUDICOLO] =
    {
        ...
        ICON(Ludicolo),
        FOOTPRINT(Ludicolo)
        FOLLOWER(Ludicolo, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Ludicolo),
    },
    ...
    [SPECIES_SEEDOT] =
    {
        ...
        ICON(Seedot),
        FOOTPRINT(Seedot)
        FOLLOWER(Seedot, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Seedot),
    ...
    [SPECIES_NUZLEAF] =
    {
        ...
        FOOTPRINT(Nuzleaf)
        .itemRare = ITEM_BLACK_GLASSES,
        FOLLOWER(Nuzleaf, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Nuzleaf),
    ...
    [SPECIES_SHIFTRY] =
    {
        ...
        ICON(Shiftry),
        FOOTPRINT(Shiftry)
        FOLLOWER(Shiftry, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Shiftry),
    },
    ...
    [SPECIES_TAILLOW] =
    {
        ...
        ICON(Taillow),
        FOOTPRINT(Taillow)
        FOLLOWER(Taillow, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Taillow),
    ...
    [SPECIES_SWELLOW] =
    {
        ...
        ICON(Swellow),
        FOOTPRINT(Swellow)
        FOLLOWER(Swellow, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Swellow),
    },
    ...
    [SPECIES_WINGULL] =
    {
        ...
        ICON(Wingull),
        FOOTPRINT(Wingull)
        FOLLOWER(Wingull, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Wingull),
    ...
    [SPECIES_PELIPPER] =
    {
        ...
        ICON(Pelipper),
        FOOTPRINT(Pelipper)
        FOLLOWER(Pelipper, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Pelipper),
    },
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_RALTS] =
    {
        ...
        ICON(Ralts),
        FOOTPRINT(Ralts)
        FOLLOWER(Ralts, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Ralts),
    ...
    [SPECIES_KIRLIA] =
    {
        ...
        ICON(Kirlia),
        FOOTPRINT(Kirlia)
        FOLLOWER(Kirlia, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Kirlia),
...
#define GARDEVOIR_MISC_INFO                                 \
    ...
    [SPECIES_GARDEVOIR] =
    {
        ...
        PALETTES(Gardevoir),
        ICON(Gardevoir),
        FOLLOWER(Gardevoir, SHADOW_SIZE_M, TRACKS_FOOT)
    },
...
#define GALLADE_MISC_INFO                                   \
    ...
    [SPECIES_GALLADE] =
    {
        ...
        PALETTES(Gallade),
        ICON(Gallade),
        FOLLOWER(Gallade, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_SURSKIT] =
    {
        ...
        ICON(Surskit),
        FOOTPRINT(Surskit)
        FOLLOWER(Surskit, SHADOW_SIZE_M, TRACKS_BUG)
        LEARNSETS(Surskit),
    ...
    [SPECIES_MASQUERAIN] =
    {
        ...
        FOLLOWER(Masquerain, SHADOW_SIZE_M, TRACKS_NONE)
    ...
    [SPECIES_SHROOMISH] =
    {
        ...
        ICON(Shroomish),
        FOOTPRINT(Shroomish)
        FOLLOWER(Shroomish, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Shroomish),
    ...
    [SPECIES_BRELOOM] =
    {
        ...
        ICON(Breloom),
        FOOTPRINT(Breloom)
        FOLLOWER(Breloom, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Breloom),
    },
    ...
    [SPECIES_SLAKOTH] =
    {
        ...
        ICON(Slakoth),
        FOOTPRINT(Slakoth)
        FOLLOWER(Slakoth, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Slakoth),
    ...
    [SPECIES_VIGOROTH] =
    {
        ...
        ICON(Vigoroth),
        FOOTPRINT(Vigoroth)
        FOLLOWER(Vigoroth, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Vigoroth),
    ...
    [SPECIES_SLAKING] =
    {
        ...
        ICON(Slaking),
        FOOTPRINT(Slaking)
        FOLLOWER(Slaking, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Slaking),
    },
    ...
    [SPECIES_NINCADA] =
    {
        ...
        ICON(Nincada),
        FOOTPRINT(Nincada)
        FOLLOWER(Nincada, SHADOW_SIZE_M, TRACKS_BUG)
        LEARNSETS(Nincada),
    ...
    [SPECIES_NINJASK] =
    {
        ...
        ICON(Ninjask),
        FOOTPRINT(Ninjask)
        FOLLOWER(Ninjask, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Ninjask),
    },
    ...
    [SPECIES_SHEDINJA] =
    {
        ...
        ICON(Shedinja),
        FOOTPRINT(Shedinja)
        FOLLOWER(Shedinja, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Shedinja),
    },
    ...
    [SPECIES_WHISMUR] =
    {
        ...
        ICON(Whismur),
        FOOTPRINT(Whismur)
        FOLLOWER(Whismur, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Whismur),
    ...
    [SPECIES_LOUDRED] =
    {
        ...
        ICON(Loudred),
        FOOTPRINT(Loudred)
        FOLLOWER(Loudred, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Loudred),
    ...
    [SPECIES_EXPLOUD] =
    {
        ...
        ICON(Exploud),
        FOOTPRINT(Exploud)
        FOLLOWER(Exploud, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Exploud),
    },
    ...
    [SPECIES_MAKUHITA] =
    {
        ...
        ICON(Makuhita),
        FOOTPRINT(Makuhita)
        FOLLOWER(Makuhita, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Makuhita),
    ...
    [SPECIES_HARIYAMA] =
    {
        ...
        ICON(Hariyama),
        FOOTPRINT(Hariyama)
        FOLLOWER(Hariyama, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Hariyama),
    },
    ...
    [SPECIES_NOSEPASS] =
    {
        ...
        ICON(Nosepass),
        FOOTPRINT(Nosepass)
        FOLLOWER(Nosepass, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Nosepass),
    ...
    [SPECIES_PROBOPASS] =
    {
        ...
        ICON(Probopass),
        FOOTPRINT(Probopass)
        FOLLOWER(Probopass, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Probopass),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_SKITTY] =
    {
        ...
        ICON(Skitty),
        FOOTPRINT(Skitty)
        FOLLOWER(Skitty, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Skitty),
    ...
    [SPECIES_DELCATTY] =
    {
        ...
        ICON(Delcatty),
        FOOTPRINT(Delcatty)
        FOLLOWER(Delcatty, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Delcatty),
    },
...
#define SABLEYE_MISC_INFO                                           \
    ...
    [SPECIES_SABLEYE] =
    {
        ...
        PALETTES(Sableye),
        ICON(Sableye),
        FOLLOWER(Sableye, SHADOW_SIZE_M, TRACKS_FOOT)
    },
...
#define MAWILE_MISC_INFO                                             \
    ...
    [SPECIES_MAWILE] =
    {
        ...
        PALETTES(Mawile),
        ICON(Mawile),
        FOLLOWER(Mawile, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_ARON] =
    {
        ...
        ICON(Aron),
        FOOTPRINT(Aron)
        FOLLOWER(Aron, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Aron),
    ...
    [SPECIES_LAIRON] =
    {
        ...
        ICON(Lairon),
        FOOTPRINT(Lairon)
        FOLLOWER(Lairon, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Lairon),
...
#define AGGRON_MISC_INFO                                        \
    ...
    [SPECIES_AGGRON] =
    {
        ...
        PALETTES(Aggron),
        ICON(Aggron),
        FOLLOWER(Aggron, SHADOW_SIZE_M, TRACKS_FOOT)
    },
#endif //P_FAMILY_ARON
    ...
    [SPECIES_MEDITITE] =
    {
        ...
        ICON(Meditite),
        FOOTPRINT(Meditite)
        FOLLOWER(Meditite, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Meditite),
...
#define MEDICHAM_MISC_INFO                                          \
    ...
    [SPECIES_MEDICHAM] =
    {
        ...
        PALETTES(Medicham),
        ICON(Medicham),
        FOLLOWER(Medicham, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_ELECTRIKE] =
    {
        ...
        ICON(Electrike),
        FOOTPRINT(Electrike)
        FOLLOWER(Electrike, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Electrike),
...
#define MANECTRIC_MISC_INFO                                 \
    ...
    [SPECIES_MANECTRIC] =
    {
        ...
        PALETTES(Manectric),
        ICON(Manectric),
        FOLLOWER(Manectric, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_BUDEW] =
    {
        ...
        ICON(Budew),
        FOOTPRINT(Budew)
        FOLLOWER(Budew, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Budew),
    ...
    [SPECIES_ROSELIA] =
    {
        ...
        ICON(Roselia),
        FOOTPRINT(Roselia)
        FOLLOWER(Roselia, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Roselia),
    ...
    [SPECIES_ROSERADE] =
    {
        ...
        ICON(Roserade),
        FOOTPRINT(Roserade)
        FOLLOWER(Roserade, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Roserade),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_GULPIN] =
    {
        ...
        ICON(Gulpin),
        FOOTPRINT(Gulpin)
        FOLLOWER(Gulpin, SHADOW_SIZE_M, TRACKS_SPOT)
        LEARNSETS(Gulpin),
    ...
    [SPECIES_SWALOT] =
    {
        ...
        ICON(Swalot),
        FOOTPRINT(Swalot)
        FOLLOWER(Swalot, SHADOW_SIZE_M, TRACKS_SLITHER)
        LEARNSETS(Swalot),
    },
    ...
    [SPECIES_CARVANHA] =
    {
        ...
        ICON(Carvanha),
        FOOTPRINT(Carvanha)
        FOLLOWER(Carvanha, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Carvanha),
...
#define SHARPEDO_MISC_INFO                                      \
    ...
    [SPECIES_SHARPEDO] =
    {
        ...
        PALETTES(Sharpedo),
        ICON(Sharpedo),
        FOLLOWER(Sharpedo, SHADOW_SIZE_M, TRACKS_NONE)
    },
    ...
    [SPECIES_WAILMER] =
    {
        ...
        ICON(Wailmer),
        FOOTPRINT(Wailmer)
        FOLLOWER(Wailmer, SHADOW_SIZE_M, TRACKS_SPOT)
        LEARNSETS(Wailmer),
    ...
    [SPECIES_WAILORD] =
    {
        ...
        ICON(Wailord),
        FOOTPRINT(Wailord)
        FOLLOWER(Wailord, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Wailord),
    },
    ...
    [SPECIES_NUMEL] =
    {
        ...
        ICON(Numel),
        FOOTPRINT(Numel)
        FOLLOWER(Numel, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Numel),
...
#define CAMERUPT_MISC_INFO                                  \
    ...
    [SPECIES_CAMERUPT] =
    {
        ...
        PALETTES(Camerupt),
        ICON(Camerupt),
        FOLLOWER(Camerupt, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_TORKOAL] =
    {
        ...
        ICON(Torkoal),
        FOOTPRINT(Torkoal)
        FOLLOWER(Torkoal, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Torkoal),
    },
    ...
    [SPECIES_SPOINK] =
    {
        ...
        ICON(Spoink),
        FOOTPRINT(Spoink)
        FOLLOWER(Spoink, SHADOW_SIZE_M, TRACKS_SPOT)
        LEARNSETS(Spoink),
    ...
    [SPECIES_GRUMPIG] =
    {
        ...
        ICON(Grumpig),
        FOOTPRINT(Grumpig)
        FOLLOWER(Grumpig, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Grumpig),
    },
    ...
    [SPECIES_SPINDA] =
    {
        ...
        ICON(Spinda),
        FOOTPRINT(Spinda)
        FOLLOWER(Spinda, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Spinda),
    },
    ...
    [SPECIES_TRAPINCH] =
    {
        ...
        ICON(Trapinch),
        FOOTPRINT(Trapinch)
        FOLLOWER(Trapinch, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Trapinch),
    ...
    [SPECIES_VIBRAVA] =
    {
        ...
        ICON(Vibrava),
        FOOTPRINT(Vibrava)
        FOLLOWER(Vibrava, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Vibrava),
    ...
    [SPECIES_FLYGON] =
    {
        ...
        ICON(Flygon),
        FOOTPRINT(Flygon)
        FOLLOWER(Flygon, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Flygon),
    },
    ...
    [SPECIES_CACNEA] =
    {
        ...
        ICON(Cacnea),
        FOOTPRINT(Cacnea)
        FOLLOWER(Cacnea, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Cacnea),
    ...
    [SPECIES_CACTURNE] =
    {
        ...
        ICON(Cacturne),
        FOOTPRINT(Cacturne)
        FOLLOWER(Cacturne, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Cacturne),
    },
    ...
    [SPECIES_SWABLU] =
    {
        ...
        ICON(Swablu),
        FOOTPRINT(Swablu)
        FOLLOWER(Swablu, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Swablu),
...
#define ALTARIA_MISC_INFO                                              \
    ...
    [SPECIES_ALTARIA] =
    {
        ...
        PALETTES(Altaria),
        ICON(Altaria),
        FOLLOWER(Altaria, SHADOW_SIZE_M, TRACKS_NONE)
    },
    ...
    [SPECIES_ZANGOOSE] =
    {
        ...
        ICON(Zangoose),
        FOOTPRINT(Zangoose)
        FOLLOWER(Zangoose, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Zangoose),
    },
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        ICON(Seviper),
        FOOTPRINT(Seviper)
        FOLLOWER(Seviper, SHADOW_SIZE_M, TRACKS_BIKE_TIRE)
        LEARNSETS(Seviper),
    },
    ...
    [SPECIES_LUNATONE] =
    {
        ...
        ICON(Lunatone),
        FOOTPRINT(Lunatone)
        FOLLOWER(Lunatone, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Lunatone),
    },
    ...
    [SPECIES_SOLROCK] =
    {
        ...
        ICON(Solrock),
        FOOTPRINT(Solrock)
        FOLLOWER(Solrock, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Solrock),
    },
    ...
    [SPECIES_BARBOACH] =
    {
        ...
        ICON(Barboach),
        FOOTPRINT(Barboach)
        FOLLOWER(Barboach, SHADOW_SIZE_M, TRACKS_SPOT)
        LEARNSETS(Barboach),
    ...
    [SPECIES_WHISCASH] =
    {
        ...
        ICON(Whiscash),
        FOOTPRINT(Whiscash)
        FOLLOWER(Whiscash, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Whiscash),
    },
    ...
    [SPECIES_CORPHISH] =
    {
        ...
        ICON(Corphish),
        FOOTPRINT(Corphish)
        FOLLOWER(Corphish, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Corphish),
    ...
    [SPECIES_CRAWDAUNT] =
    {
        ...
        ICON(Crawdaunt),
        FOOTPRINT(Crawdaunt)
        FOLLOWER(Crawdaunt, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Crawdaunt),
    },
    ...
    [SPECIES_BALTOY] =
    {
        ...
        ICON(Baltoy),
        FOOTPRINT(Baltoy)
        FOLLOWER(Baltoy, SHADOW_SIZE_M, TRACKS_SPOT)
        LEARNSETS(Baltoy),
    ...
    [SPECIES_CLAYDOL] =
    {
        ...
        ICON(Claydol),
        FOOTPRINT(Claydol)
        FOLLOWER(Claydol, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Claydol),
    },
    ...
    [SPECIES_LILEEP] =
    {
        ...
        ICON(Lileep),
        FOOTPRINT(Lileep)
        FOLLOWER(Lileep, SHADOW_SIZE_M, TRACKS_SLITHER)
        LEARNSETS(Lileep),
    ...
    [SPECIES_CRADILY] =
    {
        ...
        ICON(Cradily),
        FOOTPRINT(Cradily)
        FOLLOWER(Cradily, SHADOW_SIZE_M, TRACKS_SLITHER)
        LEARNSETS(Cradily),
    },
    ...
    [SPECIES_ANORITH] =
    {
        ...
        ICON(Anorith),
        FOOTPRINT(Anorith)
        FOLLOWER(Anorith, SHADOW_SIZE_M, TRACKS_BUG)
        LEARNSETS(Anorith),
    ...
    [SPECIES_ARMALDO] =
    {
        ...
        ICON(Armaldo),
        FOOTPRINT(Armaldo)
        FOLLOWER(Armaldo, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Armaldo),
    },
    ...
    [SPECIES_FEEBAS] =
    {
        ...
        ICON(Feebas),
        FOOTPRINT(Feebas)
        FOLLOWER(Feebas, SHADOW_SIZE_M, TRACKS_SPOT)
        LEARNSETS(Feebas),
    ...
    [SPECIES_MILOTIC] =
    {
        ...
        ICON(Milotic),
        FOOTPRINT(Milotic)
        FOLLOWER(Milotic, SHADOW_SIZE_M, TRACKS_SLITHER)
        LEARNSETS(Milotic),
    },
...
#define CASTFORM_MISC_INFO                                               \
    ...
    [SPECIES_CASTFORM_NORMAL] =
    {
        ...
        ICON(CastformNormal),
        FOLLOWER(CastformNormal, SHADOW_SIZE_M, TRACKS_NONE)
    },
    ...
    [SPECIES_CASTFORM_SUNNY] =
    {
        ...
        ICON(CastformSunny),
        FOLLOWER(CastformSunny, SHADOW_SIZE_M, TRACKS_NONE)
    },
    ...
    [SPECIES_CASTFORM_RAINY] =
    {
        ...
        ICON(CastformRainy),
        FOLLOWER(CastformRainy, SHADOW_SIZE_M, TRACKS_NONE)
    },
    ...
    [SPECIES_CASTFORM_SNOWY] =
    {
        ...
        ICON(CastformSnowy),
        FOLLOWER(CastformSnowy, SHADOW_SIZE_M, TRACKS_NONE)
    },
    ...
    [SPECIES_KECLEON] =
    {
        ...
        ICON(Kecleon),
        FOOTPRINT(Kecleon)
        FOLLOWER(Kecleon, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Kecleon),
    },
    ...
    [SPECIES_SHUPPET] =
    {
        ...
        ICON(Shuppet),
        FOOTPRINT(Shuppet)
        FOLLOWER(Shuppet, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Shuppet),
...
#define BANETTE_MISC_INFO                                           \
    ...
    [SPECIES_BANETTE] =
    {
        ...
        PALETTES(Banette),
        ICON(Banette),
        FOLLOWER(Banette, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_DUSKULL] =
    {
        ...
        ICON(Duskull),
        FOOTPRINT(Duskull)
        FOLLOWER(Duskull, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Duskull),
    ...
    [SPECIES_DUSCLOPS] =
    {
        ...
        ICON(Dusclops),
        FOOTPRINT(Dusclops)
        FOLLOWER(Dusclops, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Dusclops),
    ...
    [SPECIES_DUSKNOIR] =
    {
        ...
        ICON(Dusknoir),
        FOOTPRINT(Dusknoir)
        FOLLOWER(Dusknoir, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Dusknoir),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_TROPIUS] =
    {
        ...
        ICON(Tropius),
        FOOTPRINT(Tropius)
        FOLLOWER(Tropius, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Tropius),
    },
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        ICON(Chingling),
        FOOTPRINT(Chingling)
        FOLLOWER(Chingling, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Chingling),
    ...
    [SPECIES_CHIMECHO] =
    {
        ...
        ICON(Chimecho),
        FOOTPRINT(Chimecho)
        FOLLOWER(Chimecho, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Chimecho),
    },
...
#define ABSOL_MISC_INFO                                     \
    ...
    [SPECIES_ABSOL] =
    {
        ...
        PALETTES(Absol),
        ICON(Absol),
        FOLLOWER(Absol, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_SNORUNT] =
    {
        ...
        ICON(Snorunt),
        FOOTPRINT(Snorunt)
        FOLLOWER(Snorunt, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Snorunt),
...
#define GLALIE_MISC_INFO                                    \
    ...
    [SPECIES_GLALIE] =
    {
        ...
        PALETTES(Glalie),
        ICON(Glalie),
        FOLLOWER(Glalie, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        ICON(Froslass),
        FOOTPRINT(Froslass)
        FOLLOWER(Froslass, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Froslass),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_SPHEAL] =
    {
        ...
        ICON(Spheal),
        FOOTPRINT(Spheal)
        FOLLOWER(Spheal, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Spheal),
    ...
    [SPECIES_SEALEO] =
    {
        ...
        ICON(Sealeo),
        FOOTPRINT(Sealeo)
        FOLLOWER(Sealeo, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Sealeo),
    ...
    [SPECIES_WALREIN] =
    {
        ...
        ICON(Walrein),
        FOOTPRINT(Walrein)
        FOLLOWER(Walrein, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Walrein),
    },
    ...
    [SPECIES_CLAMPERL] =
    {
        ...
        ICON(Clamperl),
        FOOTPRINT(Clamperl)
        FOLLOWER(Clamperl, SHADOW_SIZE_M, TRACKS_SPOT)
        LEARNSETS(Clamperl),
    ...
    [SPECIES_HUNTAIL] =
    {
        ...
        ICON(Huntail),
        FOOTPRINT(Huntail)
        FOLLOWER(Huntail, SHADOW_SIZE_M, TRACKS_SLITHER)
        LEARNSETS(Huntail),
    },
    ...
    [SPECIES_GOREBYSS] =
    {
        ...
        ICON(Gorebyss),
        FOOTPRINT(Gorebyss)
        FOLLOWER(Gorebyss, SHADOW_SIZE_M, TRACKS_SLITHER)
        LEARNSETS(Gorebyss),
    },
    ...
    [SPECIES_RELICANTH] =
    {
        ...
        ICON(Relicanth),
        FOOTPRINT(Relicanth)
        FOLLOWER(Relicanth, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Relicanth),
    },
    ...
    [SPECIES_LUVDISC] =
    {
        ...
        ICON(Luvdisc),
        FOOTPRINT(Luvdisc)
        FOLLOWER(Luvdisc, SHADOW_SIZE_M, TRACKS_SPOT)
        LEARNSETS(Luvdisc),
    },
    ...
    [SPECIES_BAGON] =
    {
        ...
        ICON(Bagon),
        FOOTPRINT(Bagon)
        FOLLOWER(Bagon, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Bagon),
    ...
    [SPECIES_SHELGON] =
    {
        ...
        ICON(Shelgon),
        FOOTPRINT(Shelgon)
        FOLLOWER(Shelgon, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Shelgon),
...
#define SALAMENCE_MISC_INFO                                 \
    ...
    [SPECIES_SALAMENCE] =
    {
        ...
        PALETTES(Salamence),
        ICON(Salamence),
        FOLLOWER(Salamence, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_BELDUM] =
    {
        ...
        ICON(Beldum),
        FOOTPRINT(Beldum)
        FOLLOWER(Beldum, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Beldum),
        .tmIlliterate = TRUE,
    ...
    [SPECIES_METANG] =
    {
        ...
        ICON(Metang),
        FOOTPRINT(Metang)
        FOLLOWER(Metang, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Metang),
...
#define METAGROSS_MISC_INFO                                     \
    ...
    [SPECIES_METAGROSS] =
    {
        ...
        PALETTES(Metagross),
        ICON(Metagross),
        FOLLOWER(Metagross, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_REGIROCK] =
    {
        ...
        ICON(Regirock),
        FOOTPRINT(Regirock)
        FOLLOWER(Regirock, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Regirock),
    },
    ...
    [SPECIES_REGICE] =
    {
        ...
        ICON(Regice),
        FOOTPRINT(Regice)
        FOLLOWER(Regice, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Regice),
    },
    ...
    [SPECIES_REGISTEEL] =
    {
        ...
        ICON(Registeel),
        FOOTPRINT(Registeel)
        FOLLOWER(Registeel, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Registeel),
    },
...
#define LATIAS_MISC_INFO                                                \
    ...
    [SPECIES_LATIAS] =
    {
        ...
        PALETTES(Latias),
        ICON(Latias),
        FOLLOWER(Latias, SHADOW_SIZE_M, TRACKS_NONE)
    },
...
#define LATIOS_MISC_INFO                                                \
    ...
    [SPECIES_LATIOS] =
    {
        ...
        PALETTES(Latios),
        ICON(Latios),
        FOLLOWER(Latios, SHADOW_SIZE_M, TRACKS_NONE)
    },
...
#define KYOGRE_MISC_INFO                                                            \
    ...
    [SPECIES_KYOGRE] =
    {
        ...
        PALETTES(Kyogre),
        ICON(Kyogre),
        FOLLOWER(Kyogre, SHADOW_SIZE_M, TRACKS_NONE)
    },
...
#define GROUDON_MISC_INFO                                                           \
    ...
    [SPECIES_GROUDON] =
    {
        ...
        PALETTES(Groudon),
        ICON(Groudon),
        FOLLOWER(Groudon, SHADOW_SIZE_M, TRACKS_FOOT)
    },
...
#define RAYQUAZA_MISC_INFO                                                          \
    ...
    [SPECIES_RAYQUAZA] =
    {
        ...
        PALETTES(Rayquaza),
        ICON(Rayquaza),
        FOLLOWER(Rayquaza, SHADOW_SIZE_M, TRACKS_NONE)
    },
    ...
    [SPECIES_JIRACHI] =
    {
        ...
        ICON(Jirachi),
        FOOTPRINT(Jirachi)
        FOLLOWER(Jirachi, SHADOW_SIZE_M, TRACKS_NONE)
        LEARNSETS(Jirachi),
    },
...
#define DEOXYS_MISC_INFO                                                            \
    ...
    [SPECIES_DEOXYS_NORMAL] =
    {
        ...
        ICON(DeoxysNormal),
        FOLLOWER(DeoxysNormal, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_DEOXYS_ATTACK] =
    {
        ...
        ICON(DeoxysAttack),
        FOLLOWER(DeoxysAttack, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_DEOXYS_DEFENSE] =
    {
        ...
        ICON(DeoxysDefense),
        FOLLOWER(DeoxysDefense, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_DEOXYS_SPEED] =
    {
        ...
        ICON(DeoxysSpeed),
        FOLLOWER(DeoxysSpeed, SHADOW_SIZE_M, TRACKS_FOOT)
