...
#define MANECTRIC_MISC_INFO                                 \
    ...
    [SPECIES_SWALOT] =
    {
        ...
        ICON(Swalot),
        FOOTPRINT(Swalot)
        FOLLOWER(Swalot, TRACKS_SLITHER)
        LEARNSETS(Swalot),
    },
...
#define ALTARIA_MISC_INFO                                              \
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        ICON(Seviper),
        FOOTPRINT(Seviper)
        FOLLOWER(Seviper, TRACKS_BIKE_TIRE)
        LEARNSETS(Seviper),
    },
    ...
    [SPECIES_CRAWDAUNT] =
    {
        ...
        ICON(Crawdaunt),
        FOOTPRINT(Crawdaunt)
        FOLLOWER(Crawdaunt, TRACKS_FOOT)
        LEARNSETS(Crawdaunt),
    },
