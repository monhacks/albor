...
#define RILLABOOM_MISC_INFO                                                     \
    ...
    [SPECIES_SCORBUNNY] =
    {
        ...
        ICON(Scorbunny),
        FOOTPRINT(Scorbunny)
        FOLLOWER(Scorbunny, TRACKS_FOOT)
        LEARNSETS(Scorbunny),
...
#define ORBEETLE_MISC_INFO                                                  \
    ...
    [SPECIES_GOSSIFLEUR] =
    {
        ...
        FOLLOWER(Gossifleur, TRACKS_FOOT)
...
#define APPLETUN_MISC_INFO                                                      \
    ...
    [SPECIES_SILICOBRA] =
    {
        ...
        ICON(Silicobra),
        FOOTPRINT(Silicobra)
        FOLLOWER(Silicobra, TRACKS_FOOT)
        LEARNSETS(Silicobra),
...
#define CRAMORANT_MISC_INFO                                             \
    ...
    [SPECIES_CRAMORANT] =
    {
        ...
        PALETTES(Cramorant),
        ICON(Cramorant),
        FOLLOWER(Cramorant, TRACKS_FOOT)
    },
    ...
    [SPECIES_BARRASKEWDA] =
    {
        ...
        FOLLOWER(Barraskewda, TRACKS_FOOT)
...
#define TOXTRICITY_MISC_INFO                                            \
    ...
    [SPECIES_SIZZLIPEDE] =
    {
        ...
        FOLLOWER(Sizzlipede, TRACKS_FOOT)
...
#define CENTISKORCH_MISC_INFO                                                           \
    ...
    [SPECIES_CENTISKORCH] =
    {
        ...
        ICON(Centiskorch),
        FOLLOWER(Centiskorch, TRACKS_FOOT)
    },
    ...
    [SPECIES_CLOBBOPUS] =
    {
        ...
        ICON(Clobbopus),
        FOOTPRINT(Clobbopus)
        FOLLOWER(Clobbopus, TRACKS_FOOT)
        LEARNSETS(Clobbopus),
    ...
    [SPECIES_GRAPPLOCT] =
    {
        ...
        ICON(Grapploct),
        FOOTPRINT(Grapploct)
        FOLLOWER(Grapploct, TRACKS_FOOT)
        LEARNSETS(Grapploct),
    },
...
#define POLTEAGEIST_MISC_INFO                                                   \
        ...
        FOLLOWER(Polteageist, TRACKS_FOOT)           \
...
#define HATTERENE_MISC_INFO                                                             \
    ...
    [SPECIES_HATTERENE] =
    {
        ...
        PALETTES(Hatterene),
        ICON(Hatterene),
        FOLLOWER(Hatterene, TRACKS_FOOT)
    },
...
#define GRIMMSNARL_MISC_INFO                                                    \
    ...
    [SPECIES_GRIMMSNARL] =
    {
        ...
        PALETTES(Grimmsnarl),
        ICON(Grimmsnarl),
        FOLLOWER(Grimmsnarl, TRACKS_FOOT)
    },
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                  \
    {                                                                                       \
        ...
        FOOTPRINT(Alcremie)                                                                 \
        FOLLOWER(AlcremieStrawberryVanillaCream, TRACKS_FOOT)    \
        LEARNSETS(Alcremie),                                                                \
    ...
    [SPECIES_PINCURCHIN] =
    {
        ...
        FOLLOWER(Pincurchin, TRACKS_FOOT)
    ...
    [SPECIES_STONJOURNER] =
    {
        ...
        FOLLOWER(Stonjourner, TRACKS_FOOT)
...
#define EISCUE_MISC_INFO                                               \
    ...
    [SPECIES_EISCUE_ICE_FACE] =
    {
        ...
        ICON(EiscueIceFace),
        FOLLOWER(EiscueIceFace, TRACKS_FOOT)
    },
...
#define INDEEDEE_MISC_INFO                                  \
    ...
    [SPECIES_INDEEDEE_MALE] =
    {
        ...
        ICON(IndeedeeMale),
        FOLLOWER(IndeedeeMale, TRACKS_FOOT)
...
#define MORPEKO_MISC_INFO                                            \
    ...
    [SPECIES_MORPEKO_FULL_BELLY] =
    {
        ...
        FOLLOWER(MorpekoFullBelly, TRACKS_FOOT)
    },
...
#define COPPERAJAH_MISC_INFO                                                        \
    ...
    [SPECIES_COPPERAJAH] =
    {
        ...
        PALETTES(Copperajah),
        ICON(Copperajah),
        FOLLOWER(Copperajah, TRACKS_FOOT)
    },
    ...
    [SPECIES_DRACOZOLT] =
    {
        ...
        ICON(Dracozolt),
        FOOTPRINT(Dracozolt)
        FOLLOWER(Dracozolt, TRACKS_FOOT)
        LEARNSETS(Dracozolt),
    },
    ...
    [SPECIES_ARCTOZOLT] =
    {
        ...
        ICON(Arctozolt),
        FOOTPRINT(Arctozolt)
        FOLLOWER(Arctozolt, TRACKS_FOOT)
        LEARNSETS(Arctozolt),
    },
    ...
    [SPECIES_DRACOVISH] =
    {
        ...
        ICON(Dracovish),
        FOOTPRINT(Dracovish)
        FOLLOWER(Dracovish, TRACKS_FOOT)
        LEARNSETS(Dracovish),
    },
    ...
    [SPECIES_ARCTOVISH] =
    {
        ...
        ICON(Arctovish),
        FOOTPRINT(Arctovish)
        FOLLOWER(Arctovish, TRACKS_FOOT)
        LEARNSETS(Arctovish),
    },
...
#define DURALUDON_MISC_INFO                                                             \
    ...
    [SPECIES_DURALUDON] =
    {
        ...
        PALETTES(Duraludon),
        ICON(Duraludon),
        FOLLOWER(Duraludon, TRACKS_FOOT)
...
#define ZACIAN_MISC_INFO                                                                \
    ...
    [SPECIES_ZACIAN_HERO_OF_MANY_BATTLES] =
    {
        ...
        FOLLOWER(ZacianHeroOfManyBattles, TRACKS_FOOT)
    },
    ...
    [SPECIES_ZACIAN_CROWNED_SWORD] =
    {
        ...
        FOLLOWER(ZacianCrownedSword, TRACKS_FOOT)
    },
...
#define ZAMAZENTA_MISC_INFO                                                             \
    ...
    [SPECIES_ZAMAZENTA_CROWNED_SHIELD] =
    {
        ...
        FOLLOWER(ZamazentaCrownedShield, TRACKS_FOOT)
    },
...
#define ETERNATUS_MISC_INFO                                                             \
    ...
    [SPECIES_ETERNATUS] =
    {
        ...
        PALETTES(Eternatus),
        ICON(Eternatus),
        FOLLOWER(Eternatus, TRACKS_FOOT)
    },
...
#define ZARUDE_MISC_INFO                                                                \
    ...
    [SPECIES_GLASTRIER] =
    {
        ...
        ICON(Glastrier),
        FOOTPRINT(Glastrier)
        FOLLOWER(Glastrier, TRACKS_FOOT)
        LEARNSETS(Glastrier),
    },
    ...
    [SPECIES_SPECTRIER] =
    {
        ...
        ICON(Spectrier),
        FOOTPRINT(Spectrier)
        FOLLOWER(Spectrier, TRACKS_FOOT)
        LEARNSETS(Spectrier),
    },
...
#define CALYREX_MISC_INFO                                   \
    ...
    [SPECIES_CALYREX_ICE_RIDER] =
    {
        ...
        FOLLOWER(CalyrexIceRider, TRACKS_FOOT)
    ...
    [SPECIES_CALYREX_SHADOW_RIDER] =
    {
        ...
        FOLLOWER(CalyrexShadowRider, TRACKS_FOOT)
...
#define ENAMORUS_MISC_INFO                                                              \
    ...
    [SPECIES_ENAMORUS_INCARNATE] =
    {
        ...
        FOLLOWER(EnamorusIncarnate, TRACKS_NONE)
    ...
    [SPECIES_ENAMORUS_THERIAN] =
    {
        ...
        FOLLOWER(EnamorusTherian, TRACKS_NONE)
        //FOOTPRINT(Enamorus)
    },
