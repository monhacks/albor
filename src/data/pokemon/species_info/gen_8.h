...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_GROOKEY] =
    {
        ...
        ICON(Grookey),
        FOOTPRINT(Grookey)
        FOLLOWER(Grookey, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Grookey),
    ...
    [SPECIES_THWACKEY] =
    {
        ...
        ICON(Thwackey),
        FOOTPRINT(Thwackey)
        FOLLOWER(Thwackey, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Thwackey),
...
#define RILLABOOM_MISC_INFO                                                     \
    ...
    [SPECIES_RILLABOOM] =
    {
        ...
        PALETTES(Rillaboom),
        ICON(Rillaboom),
        FOLLOWER(Rillaboom, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_SCORBUNNY] =
    {
        ...
        ICON(Scorbunny),
        FOOTPRINT(Scorbunny)
        FOLLOWER(Scorbunny, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Scorbunny),
    ...
    [SPECIES_RABOOT] =
    {
        ...
        ICON(Raboot),
        FOOTPRINT(Raboot)
        FOLLOWER(Raboot, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Raboot),
...
#define CINDERACE_MISC_INFO                                               \
    ...
    [SPECIES_CINDERACE] =
    {
        ...
        PALETTES(Cinderace),
        ICON(Cinderace),
        FOLLOWER(Cinderace, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_SOBBLE] =
    {
        ...
        ICON(Sobble),
        FOOTPRINT(Sobble)
        FOLLOWER(Sobble, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Sobble),
    ...
    [SPECIES_DRIZZILE] =
    {
        ...
        ICON(Drizzile),
        FOOTPRINT(Drizzile)
        FOLLOWER(Drizzile, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Drizzile),
...
#define INTELEON_MISC_INFO                                              \
    ...
    [SPECIES_INTELEON] =
    {
        ...
        PALETTES(Inteleon),
        ICON(Inteleon),
        FOLLOWER(Inteleon, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_SKWOVET] =
    {
        ...
        ICON(Skwovet),
        FOOTPRINT(Skwovet)
        FOLLOWER(Skwovet, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Skwovet),
    ...
    [SPECIES_GREEDENT] =
    {
        ...
        ICON(Greedent),
        FOOTPRINT(Greedent)
        FOLLOWER(Greedent, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Greedent),
    },
    ...
    [SPECIES_ROOKIDEE] =
    {
        ...
        ICON(Rookidee),
        FOOTPRINT(Rookidee)
        FOLLOWER(Rookidee, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Rookidee),
    ...
    [SPECIES_CORVISQUIRE] =
    {
        ...
        FOLLOWER(Corvisquire, SHADOW_SIZE_M, TRACKS_FOOT)
...
#define CORVIKNIGHT_MISC_INFO                                                       \
    ...
    [SPECIES_CORVIKNIGHT] =
    {
        ...
        ICON(Corviknight),
        FOLLOWER(Corviknight, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_BLIPBUG] =
    {
        ...
        ICON(Blipbug),
        FOOTPRINT(Blipbug)
        FOLLOWER(Blipbug, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Blipbug),
        .tmIlliterate = TRUE,
    ...
    [SPECIES_DOTTLER] =
    {
        ...
        ICON(Dottler),
        FOOTPRINT(Dottler)
        FOLLOWER(Dottler, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Dottler),
...
#define ORBEETLE_MISC_INFO                                                  \
    ...
    [SPECIES_ORBEETLE] =
    {
        ...
        PALETTES(Orbeetle),
        ICON(Orbeetle),
        FOLLOWER(Orbeetle, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_NICKIT] =
    {
        ...
        ICON(Nickit),
        FOOTPRINT(Nickit)
        FOLLOWER(Nickit, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Nickit),
    ...
    [SPECIES_THIEVUL] =
    {
        ...
        ICON(Thievul),
        FOOTPRINT(Thievul)
        FOLLOWER(Thievul, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Thievul),
    },
    ...
    [SPECIES_GOSSIFLEUR] =
    {
        ...
        FOLLOWER(Gossifleur, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_ELDEGOSS] =
    {
        ...
        ICON(Eldegoss),
        FOOTPRINT(Eldegoss)
        FOLLOWER(Eldegoss, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Eldegoss),
    },
    ...
    [SPECIES_WOOLOO] =
    {
        ...
        ICON(Wooloo),
        FOOTPRINT(Wooloo)
        FOLLOWER(Wooloo, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Wooloo),
    ...
    [SPECIES_DUBWOOL] =
    {
        ...
        ICON(Dubwool),
        FOOTPRINT(Dubwool)
        FOLLOWER(Dubwool, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Dubwool),
    },
    ...
    [SPECIES_CHEWTLE] =
    {
        ...
        ICON(Chewtle),
        FOOTPRINT(Chewtle)
        FOLLOWER(Chewtle, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Chewtle),
...
#define DREDNAW_MISC_INFO                                                               \
    ...
    [SPECIES_DREDNAW] =
    {
        ...
        PALETTES(Drednaw),
        ICON(Drednaw),
        FOLLOWER(Drednaw, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_YAMPER] =
    {
        ...
        ICON(Yamper),
        FOOTPRINT(Yamper)
        FOLLOWER(Yamper, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Yamper),
    ...
    [SPECIES_BOLTUND] =
    {
        ...
        ICON(Boltund),
        FOOTPRINT(Boltund)
        FOLLOWER(Boltund, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Boltund),
    },
    ...
    [SPECIES_ROLYCOLY] =
    {
        ...
        ICON(Rolycoly),
        FOOTPRINT(Rolycoly)
        FOLLOWER(Rolycoly, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Rolycoly),
    ...
    [SPECIES_CARKOL] =
    {
        ...
        ICON(Carkol),
        FOOTPRINT(Carkol)
        FOLLOWER(Carkol, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Carkol),
...
#define COALOSSAL_MISC_INFO                                                             \
    ...
    [SPECIES_COALOSSAL] =
    {
        ...
        PALETTES(Coalossal),
        ICON(Coalossal),
        FOLLOWER(Coalossal, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_APPLIN] =
    {
        ...
        ICON(Applin),
        FOOTPRINT(Applin)
        FOLLOWER(Applin, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Applin),
        .tmIlliterate = TRUE,
...
#define FLAPPLE_MISC_INFO                                                   \
    ...
    [SPECIES_FLAPPLE] =
    {
        ...
        PALETTES(Flapple),
        ICON(Flapple),
        FOLLOWER(Flapple, SHADOW_SIZE_M, TRACKS_FOOT)
    },
...
#define APPLETUN_MISC_INFO                                                      \
    ...
    [SPECIES_APPLETUN] =
    {
        ...
        PALETTES(Appletun),
        ICON(Appletun),
        FOLLOWER(Appletun, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_SILICOBRA] =
    {
        ...
        ICON(Silicobra),
        FOOTPRINT(Silicobra)
        FOLLOWER(Silicobra, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Silicobra),
...
#define SANDACONDA_MISC_INFO                                                        \
    ...
    [SPECIES_SANDACONDA] =
    {
        ...
        PALETTES(Sandaconda),
        ICON(Sandaconda),
        FOLLOWER(Sandaconda, SHADOW_SIZE_M, TRACKS_FOOT)
    },
...
#define CRAMORANT_MISC_INFO                                             \
    ...
    [SPECIES_CRAMORANT] =
    {
        ...
        PALETTES(Cramorant),
        ICON(Cramorant),
        FOLLOWER(Cramorant, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_ARROKUDA] =
    {
        ...
        ICON(Arrokuda),
        FOOTPRINT(Arrokuda)
        FOLLOWER(Arrokuda, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Arrokuda),
    ...
    [SPECIES_BARRASKEWDA] =
    {
        ...
        FOLLOWER(Barraskewda, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_TOXEL] =
    {
        ...
        ICON(Toxel),
        FOOTPRINT(Toxel)
        FOLLOWER(Toxel, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Toxel),
...
#define TOXTRICITY_MISC_INFO                                            \
    ...
    [SPECIES_TOXTRICITY_AMPED] =
    {
        ...
        ICON(ToxtricityAmped),
        FOOTPRINT(Toxtricity)
        FOLLOWER(ToxtricityAmped, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_TOXTRICITY_LOW_KEY] =
    {
        ...
        ICON(ToxtricityLowKey),
        FOOTPRINT(Toxtricity)
        FOLLOWER(ToxtricityLowKey, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_SIZZLIPEDE] =
    {
        ...
        FOLLOWER(Sizzlipede, SHADOW_SIZE_M, TRACKS_FOOT)
...
#define CENTISKORCH_MISC_INFO                                                           \
    ...
    [SPECIES_CENTISKORCH] =
    {
        ...
        ICON(Centiskorch),
        FOLLOWER(Centiskorch, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_CLOBBOPUS] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_ANFIBIO, EGG_GROUP_HUMAN_LIKE),
        ...
        ICON(Clobbopus),
        FOOTPRINT(Clobbopus)
        FOLLOWER(Clobbopus, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Clobbopus),
    ...
    [SPECIES_GRAPPLOCT] =
    {
        ...
        ICON(Grapploct),
        FOOTPRINT(Grapploct)
        FOLLOWER(Grapploct, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Grapploct),
    },
...
#define SINISTEA_MISC_INFO                                                      \
        ...
        ICON(Sinistea),                                                      \
        FOOTPRINT(Sinistea)                                                     \
        FOLLOWER(Sinistea, SHADOW_SIZE_M, TRACKS_FOOT)              \
        LEARNSETS(Sinistea),                                                    \
...
#define POLTEAGEIST_MISC_INFO                                                   \
        ...
        FOLLOWER(Polteageist, SHADOW_SIZE_M, TRACKS_FOOT)           \
    ...
    [SPECIES_HATENNA] =
    {
        ...
        ICON(Hatenna),
        FOOTPRINT(Hatenna)
        FOLLOWER(Hatenna, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Hatenna),
    ...
    [SPECIES_HATTREM] =
    {
        ...
        ICON(Hattrem),
        FOOTPRINT(Hattrem)
        FOLLOWER(Hattrem, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Hattrem),
...
#define HATTERENE_MISC_INFO                                                             \
    ...
    [SPECIES_HATTERENE] =
    {
        ...
        PALETTES(Hatterene),
        ICON(Hatterene),
        FOLLOWER(Hatterene, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_IMPIDIMP] =
    {
        ...
        ICON(Impidimp),
        FOOTPRINT(Impidimp)
        FOLLOWER(Impidimp, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Impidimp),
    ...
    [SPECIES_MORGREM] =
    {
        ...
        ICON(Morgrem),
        FOOTPRINT(Morgrem)
        FOLLOWER(Morgrem, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Morgrem),
...
#define GRIMMSNARL_MISC_INFO                                                    \
    ...
    [SPECIES_GRIMMSNARL] =
    {
        ...
        PALETTES(Grimmsnarl),
        ICON(Grimmsnarl),
        FOLLOWER(Grimmsnarl, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_MILCERY] =
    {
        ...
        ICON(Milcery),
        FOOTPRINT(Milcery)
        FOLLOWER(Milcery, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Milcery),
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                  \
    {                                                                                       \
        ...
        ICON(AlcremieStrawberryVanillaCream),                                            \
        FOOTPRINT(Alcremie)                                                                 \
        FOLLOWER(AlcremieStrawberryVanillaCream, SHADOW_SIZE_M, TRACKS_FOOT)    \
        LEARNSETS(Alcremie),                                                                \
        .formSpeciesIdTable = sAlcremieFormSpeciesIdTable,                                  \
        .formChangeTable = sAlcremieFormChangeTable,                                        \
    }
        //ICON(AlcremieStrawberry##cream##),
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        //.backAnimId = BACK_ANIM_NONE,
    ...
    [SPECIES_FALINKS] =
    {
        ...
        ICON(Falinks),
        FOOTPRINT(Falinks)
        FOLLOWER(Falinks, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Falinks),
    },
    ...
    [SPECIES_PINCURCHIN] =
    {
        ...
        FOLLOWER(Pincurchin, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_SNOM] =
    {
        ...
        ICON(Snom),
        FOOTPRINT(Snom)
        FOLLOWER(Snom, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Snom),
    ...
    [SPECIES_FROSMOTH] =
    {
        ...
        ICON(Frosmoth),
        FOOTPRINT(Frosmoth)
        FOLLOWER(Frosmoth, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Frosmoth),
    },
#endif //P_FAMILY_SNOM
    ...
    [SPECIES_STONJOURNER] =
    {
        ...
        FOLLOWER(Stonjourner, SHADOW_SIZE_M, TRACKS_FOOT)
...
#define EISCUE_MISC_INFO                                               \
    ...
    [SPECIES_EISCUE_ICE_FACE] =
    {
        ...
        ICON(EiscueIceFace),
        FOLLOWER(EiscueIceFace, SHADOW_SIZE_M, TRACKS_FOOT)
    },
...
#define INDEEDEE_MISC_INFO                                  \
    ...
    [SPECIES_INDEEDEE_MALE] =
    {
        ...
        ICON(IndeedeeMale),
        FOLLOWER(IndeedeeMale, SHADOW_SIZE_M, TRACKS_FOOT)
...
#define MORPEKO_MISC_INFO                                            \
    ...
    [SPECIES_MORPEKO_FULL_BELLY] =
    {
        ...
        ICON(MorpekoFullBelly),
        FOLLOWER(MorpekoFullBelly, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_CUFANT] =
    {
        ...
        ICON(Cufant),
        FOOTPRINT(Cufant)
        FOLLOWER(Cufant, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Cufant),
...
#define COPPERAJAH_MISC_INFO                                                        \
    ...
    [SPECIES_COPPERAJAH] =
    {
        ...
        PALETTES(Copperajah),
        ICON(Copperajah),
        FOLLOWER(Copperajah, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_DRACOZOLT] =
    {
        ...
        ICON(Dracozolt),
        FOOTPRINT(Dracozolt)
        FOLLOWER(Dracozolt, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Dracozolt),
    },
    ...
    [SPECIES_ARCTOZOLT] =
    {
        ...
        ICON(Arctozolt),
        FOOTPRINT(Arctozolt)
        FOLLOWER(Arctozolt, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Arctozolt),
    },
    ...
    [SPECIES_DRACOVISH] =
    {
        ...
        ICON(Dracovish),
        FOOTPRINT(Dracovish)
        FOLLOWER(Dracovish, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Dracovish),
    },
    ...
    [SPECIES_ARCTOVISH] =
    {
        ...
        ICON(Arctovish),
        FOOTPRINT(Arctovish)
        FOLLOWER(Arctovish, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Arctovish),
    },
...
#define DURALUDON_MISC_INFO                                                             \
    ...
    [SPECIES_DURALUDON] =
    {
        ...
        PALETTES(Duraludon),
        ICON(Duraludon),
        FOLLOWER(Duraludon, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_DREEPY] =
    {
        ...
        ICON(Dreepy),
        FOOTPRINT(Dreepy)
        FOLLOWER(Dreepy, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Dreepy),
    ...
    [SPECIES_DRAKLOAK] =
    {
        ...
        ICON(Drakloak),
        FOOTPRINT(Drakloak)
        FOLLOWER(Drakloak, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Drakloak),
    ...
    [SPECIES_DRAGAPULT] =
    {
        ...
        ICON(Dragapult),
        FOOTPRINT(Dragapult)
        FOLLOWER(Dragapult, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Dragapult),
    },
...
#define ZACIAN_MISC_INFO                                                                \
    ...
    [SPECIES_ZACIAN_HERO_OF_MANY_BATTLES] =
    {
        ...
        ICON(ZacianHeroOfManyBattles),
        FOLLOWER(ZacianHeroOfManyBattles, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_ZACIAN_CROWNED_SWORD] =
    {
        ...
        ICON(ZacianCrownedSword),
        FOLLOWER(ZacianCrownedSword, SHADOW_SIZE_M, TRACKS_FOOT)
    },
...
#define ZAMAZENTA_MISC_INFO                                                             \
    ...
    [SPECIES_ZAMAZENTA_HERO_OF_MANY_BATTLES] =
    {
        ...
        ICON(ZamazentaHeroOfManyBattles),
    },
    ...
    [SPECIES_ZAMAZENTA_CROWNED_SHIELD] =
    {
        ...
        ICON(ZamazentaCrownedShield),
        FOLLOWER(ZamazentaCrownedShield, SHADOW_SIZE_M, TRACKS_FOOT)
    },
...
#define ETERNATUS_MISC_INFO                                                             \
    ...
    [SPECIES_ETERNATUS] =
    {
        ...
        PALETTES(Eternatus),
        ICON(Eternatus),
        FOLLOWER(Eternatus, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_KUBFU] =
    {
        ...
        ICON(Kubfu),
        FOOTPRINT(Kubfu)
        FOLLOWER(Kubfu, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Kubfu),
...
#define URSHIFU_SINGLE_STRIKE_STYLE_MISC_INFO       \
    ...
    [SPECIES_URSHIFU_SINGLE_STRIKE_STYLE_GIGANTAMAX] =
    {
        ...
        ICON(UrshifuSingleStrikeStyleGigantamax),
        .isGigantamax = TRUE,
    },
#endif //P_GIGANTAMAX_FORMS
...
#define URSHIFU_RAPID_STRIKE_STYLE_MISC_INFO            \
    ...
    [SPECIES_URSHIFU_RAPID_STRIKE_STYLE] =
    {
        ...
        ICON(Urshifu),
        FOLLOWER(Urshifu, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_URSHIFU_RAPID_STRIKE_STYLE_GIGANTAMAX] =
    {
        ...
        ICON(UrshifuRapidStrikeStyleGigantamax),
        .isGigantamax = TRUE,
    },
#endif //P_GIGANTAMAX_FORMS
...
#define ZARUDE_MISC_INFO                                                                \
    ...
    [SPECIES_ZARUDE] =
    {
        ...
        PALETTES(Zarude),
        ICON(Zarude),
        FOLLOWER(Zarude, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    [SPECIES_ZARUDE_DADA] =
    {
        ZARUDE_MISC_INFO,
    ...
    [SPECIES_REGIELEKI] =
    {
        ...
        ICON(Regieleki),
        FOOTPRINT(Regieleki)
        FOLLOWER(Regieleki, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Regieleki),
        .isLegendary = TRUE,
    },
    ...
    [SPECIES_REGIDRAGO] =
    {
        ...
        ICON(Regidrago),
        FOOTPRINT(Regidrago)
        FOLLOWER(Regidrago, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Regidrago),
    },
    ...
    [SPECIES_GLASTRIER] =
    {
        ...
        ICON(Glastrier),
        FOOTPRINT(Glastrier)
        FOLLOWER(Glastrier, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Glastrier),
    },
    ...
    [SPECIES_SPECTRIER] =
    {
        ...
        ICON(Spectrier),
        FOOTPRINT(Spectrier)
        FOLLOWER(Spectrier, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Spectrier),
    },
...
#define CALYREX_MISC_INFO                                   \
    ...
    [SPECIES_CALYREX] =
    {
        ...
        PALETTES(Calyrex),
        ICON(Calyrex),
        FOLLOWER(Calyrex, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Calyrex),
    },
    ...
    [SPECIES_CALYREX_ICE_RIDER] =
    {
        ...
        ICON(CalyrexIceRider),
        FOLLOWER(CalyrexIceRider, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_CALYREX_SHADOW_RIDER] =
    {
        ...
        ICON(CalyrexShadowRider),
        FOLLOWER(CalyrexShadowRider, SHADOW_SIZE_M, TRACKS_FOOT)
...
#define ENAMORUS_MISC_INFO                                                              \
    ...
    [SPECIES_ENAMORUS_INCARNATE] =
    {
        ...
        ICON(EnamorusIncarnate),
        FOLLOWER(EnamorusIncarnate, SHADOW_SIZE_M, TRACKS_NONE)
    ...
    [SPECIES_ENAMORUS_THERIAN] =
    {
        ...
        ICON(EnamorusTherian),
        FOLLOWER(EnamorusTherian, SHADOW_SIZE_M, TRACKS_NONE)
        //FOOTPRINT(Enamorus)
    },
