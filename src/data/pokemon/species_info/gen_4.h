...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TURTWIG] =
    {
        ...
        ICON(Turtwig),
        FOOTPRINT(Turtwig)
        FOLLOWER(Turtwig, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Turtwig),
    ...
    [SPECIES_GROTLE] =
    {
        ...
        ICON(Grotle),
        FOOTPRINT(Grotle)
        FOLLOWER(Grotle, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Grotle),
    ...
    [SPECIES_TORTERRA] =
    {
        ...
        ICON(Torterra),
        FOOTPRINT(Torterra)
        FOLLOWER(Torterra, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Torterra),
    },
    ...
    [SPECIES_CHIMCHAR] =
    {
        ...
        ICON(Chimchar),
        FOOTPRINT(Chimchar)
        FOLLOWER(Chimchar, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Chimchar),
    ...
    [SPECIES_MONFERNO] =
    {
        ...
        ICON(Monferno),
        FOOTPRINT(Monferno)
        FOLLOWER(Monferno, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Monferno),
    ...
    [SPECIES_INFERNAPE] =
    {
        ...
        ICON(Infernape),
        FOOTPRINT(Infernape)
        FOLLOWER(Infernape, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Infernape),
    },
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        ICON(Piplup),
        FOOTPRINT(Piplup)
        FOLLOWER(Piplup, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Piplup),
    ...
    [SPECIES_PRINPLUP] =
    {
        ...
        ICON(Prinplup),
        FOOTPRINT(Prinplup)
        FOLLOWER(Prinplup, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Prinplup),
    ...
    [SPECIES_EMPOLEON] =
    {
        ...
        ICON(Empoleon),
        FOOTPRINT(Empoleon)
        FOLLOWER(Empoleon, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Empoleon),
    },
    ...
    [SPECIES_STARLY] =
    {
        ...
        ICON(Starly),
        FOOTPRINT(Starly)
        FOLLOWER(Starly, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Starly),
    ...
    [SPECIES_STARAVIA] =
    {
        ...
        ICON(Staravia),
        FOOTPRINT(Staravia)
        FOLLOWER(Staravia, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Staravia),
    ...
    [SPECIES_STARAPTOR] =
    {
        ...
        ICON(Staraptor),
        FOOTPRINT(Staraptor)
        FOLLOWER(Staraptor, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Staraptor),
    },
    ...
    [SPECIES_BIDOOF] =
    {
        ...
        ICON(Bidoof),
        FOOTPRINT(Bidoof)
        FOLLOWER(Bidoof, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Bidoof),
    ...
    [SPECIES_BIBAREL] =
    {
        ...
        ICON(Bibarel),
        FOOTPRINT(Bibarel)
        FOLLOWER(Bibarel, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Bibarel),
    },
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        ICON(Kricketot),
        FOOTPRINT(Kricketot)
        FOLLOWER(Kricketot, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Kricketot),
        .tmIlliterate = TRUE,
    ...
    [SPECIES_KRICKETUNE] =
    {
        ...
        FOLLOWER(Kricketune, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_SHINX] =
    {
        ...
        ICON(Shinx),
        FOOTPRINT(Shinx)
        FOLLOWER(Shinx, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Shinx),
    ...
    [SPECIES_LUXIO] =
    {
        ...
        ICON(Luxio),
        FOOTPRINT(Luxio)
        FOLLOWER(Luxio, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Luxio),
    ...
    [SPECIES_LUXRAY] =
    {
        ...
        ICON(Luxray),
        FOOTPRINT(Luxray)
        FOLLOWER(Luxray, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Luxray),
    },
    ...
    [SPECIES_CRANIDOS] =
    {
        ...
        ICON(Cranidos),
        FOOTPRINT(Cranidos)
        FOLLOWER(Cranidos, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Cranidos),
    ...
    [SPECIES_RAMPARDOS] =
    {
        ...
        ICON(Rampardos),
        FOOTPRINT(Rampardos)
        FOLLOWER(Rampardos, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Rampardos),
    },
    ...
    [SPECIES_SHIELDON] =
    {
        ...
        ICON(Shieldon),
        FOOTPRINT(Shieldon)
        FOLLOWER(Shieldon, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Shieldon),
    ...
    [SPECIES_BASTIODON] =
    {
        ...
        ICON(Bastiodon),
        FOOTPRINT(Bastiodon)
        FOLLOWER(Bastiodon, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Bastiodon),
    },
...
#define BURMY_MISC_INFO                                                     \
    ...
    [SPECIES_BURMY_PLANT_CLOAK] =
    {
        ...
        ICON(BurmyPlantCloak),
        FOLLOWER(BurmyPlantCloak, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_BURMY_SANDY_CLOAK] =
    {
        ...
        ICON(BurmySandyCloak),
        FOLLOWER(BurmySandyCloak, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_BURMY_TRASH_CLOAK] =
    {
        ...
        ICON(BurmyTrashCloak),
        FOLLOWER(BurmyTrashCloak, SHADOW_SIZE_M, TRACKS_FOOT)
...
#define WORMADAM_MISC_INFO                                                      \
    ...
    [SPECIES_WORMADAM_PLANT_CLOAK] =
    {
        ...
        ICON(WormadamPlantCloak),
        FOLLOWER(WormadamPlantCloak, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_WORMADAM_SANDY_CLOAK] =
    {
        ...
        ICON(WormadamSandyCloak),
        FOLLOWER(WormadamSandyCloak, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_WORMADAM_TRASH_CLOAK] =
    {
        ...
        ICON(WormadamTrashCloak),
        FOLLOWER(WormadamTrashCloak, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_MOTHIM] =
    {
        ...
        ICON(Mothim),
        FOOTPRINT(Mothim)
        FOLLOWER(Mothim, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Mothim),
    },
    ...
    [SPECIES_COMBEE] =
    {
        ...
        ICON(Combee),
        FOOTPRINT(Combee)
        FOLLOWER(Combee, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Combee),
        .tmIlliterate = TRUE,
    ...
    [SPECIES_VESPIQUEN] =
    {
        ...
        ICON(Vespiquen),
        FOOTPRINT(Vespiquen)
        FOLLOWER(Vespiquen, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Vespiquen),
    },
    ...
    [SPECIES_PACHIRISU] =
    {
        ...
        ICON(Pachirisu),
        FOOTPRINT(Pachirisu)
        FOLLOWER(Pachirisu, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Pachirisu),
    },
    ...
    [SPECIES_BUIZEL] =
    {
        ...
        ICON(Buizel),
        FOOTPRINT(Buizel)
        FOLLOWER(Buizel, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Buizel),
    ...
    [SPECIES_FLOATZEL] =
    {
        ...
        ICON(Floatzel),
        FOOTPRINT(Floatzel)
        FOLLOWER(Floatzel, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Floatzel),
    },
    ...
    [SPECIES_CHERUBI] =
    {
        ...
        ICON(Cherubi),
        FOOTPRINT(Cherubi)
        FOLLOWER(Cherubi, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Cherubi),
...
#define CHERRIM_MISC_INFO                                            \
    ...
    [SPECIES_CHERRIM_OVERCAST] =
    {
        ...
        ICON(CherrimOvercast),
        FOLLOWER(CherrimOvercast, SHADOW_SIZE_M, TRACKS_FOOT)
    },
...
#define SHELLOS_MISC_INFO                                                               \
    ...
    [SPECIES_SHELLOS_WEST_SEA] =
    {
        ...
        ICON(ShellosWestSea),
        FOLLOWER(ShellosWestSea, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_SHELLOS_EAST_SEA] =
    {
        ...
        ICON(ShellosEastSea),
        FOLLOWER(ShellosEastSea, SHADOW_SIZE_M, TRACKS_FOOT)
...
#define GASTRODON_MISC_INFO                                                             \
    ...
    [SPECIES_GASTRODON_WEST_SEA] =
    {
        ...
        ICON(GastrodonWestSea),
        FOLLOWER(GastrodonWestSea, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_GASTRODON_EAST_SEA] =
    {
        ...
        FOLLOWER(GastrodonEastSea, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        ICON(Drifloon),
        FOOTPRINT(Drifloon)
        FOLLOWER(Drifloon, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Drifloon),
    ...
    [SPECIES_DRIFBLIM] =
    {
        ...
        ICON(Drifblim),
        FOOTPRINT(Drifblim)
        FOLLOWER(Drifblim, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Drifblim),
    },
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        ICON(Buneary),
        FOOTPRINT(Buneary)
        FOLLOWER(Buneary, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Buneary),
...
#define LOPUNNY_MISC_INFO                                                 \
    ...
    [SPECIES_LOPUNNY] =
    {
        ...
        PALETTES(Lopunny),
        ICON(Lopunny),
        FOLLOWER(Lopunny, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_GLAMEOW] =
    {
        ...
        ICON(Glameow),
        FOOTPRINT(Glameow)
        FOLLOWER(Glameow, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Glameow),
    ...
    [SPECIES_PURUGLY] =
    {
        ...
        ICON(Purugly),
        FOOTPRINT(Purugly)
        FOLLOWER(Purugly, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Purugly),
    },
    ...
    [SPECIES_STUNKY] =
    {
        ...
        ICON(Stunky),
        FOOTPRINT(Stunky)
        FOLLOWER(Stunky, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Stunky),
    ...
    [SPECIES_SKUNTANK] =
    {
        ...
        ICON(Skuntank),
        FOOTPRINT(Skuntank)
        FOLLOWER(Skuntank, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Skuntank),
    },
    ...
    [SPECIES_BRONZOR] =
    {
        ...
        ICON(Bronzor),
        FOOTPRINT(Bronzor)
        FOLLOWER(Bronzor, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Bronzor),
    ...
    [SPECIES_BRONZONG] =
    {
        ...
        ICON(Bronzong),
        FOOTPRINT(Bronzong)
        FOLLOWER(Bronzong, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Bronzong),
    },
    ...
    [SPECIES_CHATOT] =
    {
        ...
        ICON(Chatot),
        FOOTPRINT(Chatot)
        FOLLOWER(Chatot, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Chatot),
    },
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        ICON(Spiritomb),
        FOOTPRINT(Spiritomb)
        FOLLOWER(Spiritomb, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Spiritomb),
    },
    ...
    [SPECIES_GIBLE] =
    {
        ...
        ICON(Gible),
        FOOTPRINT(Gible)
        FOLLOWER(Gible, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Gible),
    ...
    [SPECIES_GABITE] =
    {
        ...
        ICON(Gabite),
        FOOTPRINT(Gabite)
        FOLLOWER(Gabite, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Gabite),
...
#define GARCHOMP_MISC_INFO                                              \
    ...
    [SPECIES_GARCHOMP] =
    {
        ...
        PALETTES(Garchomp),
        ICON(Garchomp),
        FOLLOWER(Garchomp, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_RIOLU] =
    {
        ...
        ICON(Riolu),
        FOOTPRINT(Riolu)
        FOLLOWER(Riolu, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Riolu),
...
#define LUCARIO_MISC_INFO                                                  \
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        PALETTES(Lucario),
        ICON(Lucario),
        FOLLOWER(Lucario, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_HIPPOPOTAS] =
    {
        ...
        FOLLOWER(Hippopotas, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    #endif
        FOOTPRINT(Hippowdon)
        FOLLOWER(Hippowdon, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Hippowdon),
    },
    ...
    [SPECIES_SKORUPI] =
    {
        ...
        ICON(Skorupi),
        FOOTPRINT(Skorupi)
        FOLLOWER(Skorupi, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Skorupi),
    ...
    [SPECIES_DRAPION] =
    {
        ...
        ICON(Drapion),
        FOOTPRINT(Drapion)
        FOLLOWER(Drapion, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Drapion),
    },
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        ICON(Croagunk),
        FOOTPRINT(Croagunk)
        FOLLOWER(Croagunk, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Croagunk),
    ...
    [SPECIES_TOXICROAK] =
    {
        ...
        ICON(Toxicroak),
        FOOTPRINT(Toxicroak)
        FOLLOWER(Toxicroak, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Toxicroak),
    },
    ...
    [SPECIES_CARNIVINE] =
    {
        ...
        .abilities = {ABILITY_LEVITATE, ABILITY_MATAMOSCAS},
        .bodyColor = BODY_COLOR_GREEN,
        ...
        ICON(Carnivine),
        FOOTPRINT(Carnivine)
        FOLLOWER(Carnivine, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Carnivine),
    },
    ...
    [SPECIES_FINNEON] =
    {
        ...
        ICON(Finneon),
        FOOTPRINT(Finneon)
        FOLLOWER(Finneon, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Finneon),
    ...
    [SPECIES_LUMINEON] =
    {
        ...
        ICON(Lumineon),
        FOOTPRINT(Lumineon)
        FOLLOWER(Lumineon, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Lumineon),
    },
    ...
    [SPECIES_SNOVER] =
    {
        ...
        ICON(Snover),
        FOOTPRINT(Snover)
        FOLLOWER(Snover, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Snover),
...
#define ABOMASNOW_MISC_INFO                                            \
    ...
    [SPECIES_ABOMASNOW] =
    {
        ...
        PALETTES(Abomasnow),
        ICON(Abomasnow),
        FOLLOWER(Abomasnow, SHADOW_SIZE_M, TRACKS_FOOT)
    },
...
#define ROTOM_MISC_INFO                                             \
    ...
    [SPECIES_ROTOM] =
    {
        ...
        PALETTES(Rotom),
        ICON(Rotom),
        FOLLOWER(Rotom, SHADOW_SIZE_M, TRACKS_FOOT)
    },
...
#define ROTOM_APPLIANCE_INFO(form)                                  \
    ...
    [SPECIES_ROTOM_HEAT] =
    {
        ...
        PALETTES(RotomHeat),
        ICON(RotomHeat),
        FOLLOWER(RotomHeat, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_ROTOM_WASH] =
    {
        ...
        PALETTES(RotomWash),
        ICON(RotomWash),
        FOLLOWER(RotomWash, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_ROTOM_FROST] =
    {
        ...
        PALETTES(RotomFrost),
        ICON(RotomFrost),
        FOLLOWER(RotomFrost, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_ROTOM_FAN] =
    {
        ...
        PALETTES(RotomFan),
        ICON(RotomFan),
        FOLLOWER(RotomFan, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_ROTOM_MOW] =
    {
        ...
        PALETTES(RotomMow),
        ICON(RotomMow),
        FOLLOWER(RotomMow, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_UXIE] =
    {
        ...
        ICON(Uxie),
        FOOTPRINT(Uxie)
        FOLLOWER(Uxie, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Uxie),
    },
#endif //P_FAMILY_UXIE
    ...
    [SPECIES_MESPRIT] =
    {
        ...
        ICON(Mesprit),
        FOOTPRINT(Mesprit)
        FOLLOWER(Mesprit, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Mesprit),
    },
    ...
    [SPECIES_AZELF] =
    {
        ...
        ICON(Azelf),
        FOOTPRINT(Azelf)
        FOLLOWER(Azelf, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Azelf),
    },
...
#define DIALGA_MISC_INFO                                                                \
    ...
    [SPECIES_DIALGA] =
    {
        ...
        PALETTES(Dialga),
        ICON(Dialga),
        FOLLOWER(Dialga, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_DIALGA_ORIGIN] =
    {
        ...
        ICON(DialgaOrigin),
        FOLLOWER(DialgaOrigin, SHADOW_SIZE_M, TRACKS_NONE)
    },
...
#define PALKIA_MISC_INFO                                                                \
    ...
    [SPECIES_PALKIA] =
    {
        ...
        PALETTES(Palkia),
        ICON(Palkia),
        FOLLOWER(Palkia, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_PALKIA_ORIGIN] =
    {
        ...
        ICON(PalkiaOrigin),
        FOLLOWER(PalkiaOrigin, SHADOW_SIZE_M, TRACKS_NONE)
    },
    ...
    [SPECIES_HEATRAN] =
    {
        ...
        ICON(Heatran),
        FOOTPRINT(Heatran)
        FOLLOWER(Heatran, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Heatran),
    },
    ...
    [SPECIES_REGIGIGAS] =
    {
        ...
        ICON(Regigigas),
        FOOTPRINT(Regigigas)
        FOLLOWER(Regigigas, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Regigigas),
    },
...
#define GIRATINA_MISC_INFO                                                              \
    ...
    [SPECIES_GIRATINA_ALTERED] =
    {
        ...
        ICON(GiratinaAltered),
        FOLLOWER(GiratinaAltered, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_GIRATINA_ORIGIN] =
    {
        ...
        ICON(GiratinaOrigin),
        FOLLOWER(GiratinaOrigin, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_CRESSELIA] =
    {
        ...
        ICON(Cresselia),
        FOOTPRINT(Cresselia)
        FOLLOWER(Cresselia, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Cresselia),
    },
    ...
    [SPECIES_MANAPHY] =
    {
        ...
        ICON(Manaphy),
        FOOTPRINT(Manaphy)
        FOLLOWER(Manaphy, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Manaphy),
    },
    ...
    [SPECIES_DARKRAI] =
    {
        ...
        ICON(Darkrai),
        FOOTPRINT(Darkrai)
        FOLLOWER(Darkrai, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Darkrai),
    },
...
#define SHAYMIN_MISC_INFO                                                               \
    ...
    [SPECIES_SHAYMIN_LAND] =
    {
        ...
        ICON(ShayminLand),
        FOLLOWER(ShayminLand, SHADOW_SIZE_M, TRACKS_FOOT)
