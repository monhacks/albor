...
#define GRENINJA_MISC_INFO                              \
    ...
    [SPECIES_SCATTERBUG] =
    {
        ...
        FOLLOWER(Scatterbug, TRACKS_FOOT)
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
        ...
        FOOTPRINT(Vivillon)                                                                 \
        FOLLOWER(Vivillon ##form, TRACKS_FOOT)                   \
        LEARNSETS(Vivillon),                                                                \
...
#define FLABEBE_MISC_INFO(Form, FORM, iconPal)                                  \
        ...
        FOOTPRINT(Flabebe)                                                      \
        FOLLOWER(Flabebe##Form##Flower, TRACKS_FOOT) \
        LEARNSETS(Flabebe),                                                     \
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
        ...
        FOOTPRINT(Florges)                                                      \
        FOLLOWER(Florges##Form##Flower, TRACKS_FOOT) \
        LEARNSETS(Florges),                                                     \
...
#define FURFROU_MISC_INFO                                   \
    ...
    [SPECIES_FURFROU_NATURAL] =
    {
        ...
        ICON(FurfrouNatural),
        FOLLOWER(FurfrouNatural, TRACKS_FOOT)
    },
    [SPECIES_FURFROU_HEART_TRIM] =
    {
        ...
        FOLLOWER(FurfrouHeartTrim, TRACKS_FOOT)
    },
    [SPECIES_FURFROU_STAR_TRIM] =
    {
        ...
        FOLLOWER(FurfrouStarTrim, TRACKS_FOOT)
    },
    [SPECIES_FURFROU_DIAMOND_TRIM] =
    {
        ...
        FOLLOWER(FurfrouDiamondTrim, TRACKS_FOOT)
    },
    [SPECIES_FURFROU_DEBUTANTE_TRIM] =
    {
        ...
        FOLLOWER(FurfrouDebutanteTrim, TRACKS_FOOT)
    },
    [SPECIES_FURFROU_MATRON_TRIM] =
    {
        ...
        FOLLOWER(FurfrouMatronTrim, TRACKS_FOOT)
    },
    [SPECIES_FURFROU_DANDY_TRIM] =
    {
        ...
        FOLLOWER(FurfrouDandyTrim, TRACKS_FOOT)
    },
    [SPECIES_FURFROU_LA_REINE_TRIM] =
    {
        ...
        FOLLOWER(FurfrouLaReineTrim, TRACKS_FOOT)
    },
    [SPECIES_FURFROU_KABUKI_TRIM] =
    {
        ...
        FOLLOWER(FurfrouKabukiTrim, TRACKS_FOOT)
    },
    [SPECIES_FURFROU_PHARAOH_TRIM] =
    {
        ...
        FOLLOWER(FurfrouPharaohTrim, TRACKS_FOOT)
    },
...
#define MEOWSTIC_MISC_INFO                                  \
    ...
    [SPECIES_MEOWSTIC_MALE] =
    {
        ...
        ICON(MeowsticMale),
        FOLLOWER(MeowsticMale, TRACKS_FOOT)
    ...
    [SPECIES_MEOWSTIC_FEMALE] =
    {
        ...
        ICON(MeowsticFemale),
        FOLLOWER(MeowsticFemale, TRACKS_FOOT)
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_AROMATISSE] =
    {
        ...
        FOLLOWER(Aromatisse, TRACKS_FOOT)
    ...
    [SPECIES_BARBARACLE] =
    {
        ...
        FOLLOWER(Barbaracle, TRACKS_FOOT)
    ...
    [SPECIES_CLAUNCHER] =
    {
        ...
        ICON(Clauncher),
        FOOTPRINT(Clauncher)
        FOLLOWER(Clauncher, TRACKS_FOOT)
        LEARNSETS(Clauncher),
    ...
    [SPECIES_CLAWITZER] =
    {
        ...
        ICON(Clawitzer),
        FOOTPRINT(Clawitzer)
        FOLLOWER(Clawitzer, TRACKS_FOOT)
        LEARNSETS(Clawitzer),
    },
    ...
    [SPECIES_HELIOPTILE] =
    {
        ...
        FOLLOWER(Helioptile, TRACKS_FOOT)
    ...
    [SPECIES_HELIOLISK] =
    {
        ...
        ICON(Heliolisk),
        FOOTPRINT(Heliolisk)
        FOLLOWER(Heliolisk, TRACKS_FOOT)
        LEARNSETS(Heliolisk),
    },
...
#define PUMPKABOO_MISC_INFO                                                 \
    ...
    [SPECIES_PUMPKABOO_AVERAGE] =
    {
        ...
        .backPicYOffset = 13,
        FOLLOWER(PumpkabooAverage, TRACKS_FOOT)
...
#define GOURGEIST_MISC_INFO                                                 \
    ...
    [SPECIES_GOURGEIST_AVERAGE] =
    {
        ...
        .backPicYOffset = 3,
        FOLLOWER(GourgeistAverage, TRACKS_FOOT)
    },
...
#define XERNEAS_MISC_INFO(Form)                                                         \
    {                                                                                   \
        ...
        ICON(Xerneas##Form),                                                         \
        FOOTPRINT(Xerneas)                                                              \
        FOLLOWER(XerneasNeutral, TRACKS_FOOT)                       \
        LEARNSETS(Xerneas),                                                             \
...
#define ZYGARDE_50_SPECIES_INFO(ability)                            \
    {                                                               \
        ...
        PALETTES(Zygarde50),                                        \
        ICON(Zygarde50),                                         \
        FOLLOWER(Zygarde50, TRACKS_FOOT) \
...
#define HOOPA_MISC_INFO                                                                 \
    ...
    [SPECIES_HOOPA_CONFINED] =
    {
        ...
        ICON(HoopaConfined),
        FOLLOWER(HoopaConfined, TRACKS_FOOT)
    ...
    [SPECIES_HOOPA_UNBOUND] =
    {
        ...
        ICON(HoopaUnbound),
        FOLLOWER(HoopaUnbound, TRACKS_FOOT)
    ...
    [SPECIES_VOLCANION] =
    {
        ...
        ICON(Volcanion),
        FOOTPRINT(Volcanion)
        FOLLOWER(Volcanion, TRACKS_FOOT)
        LEARNSETS(Volcanion),
    },
