...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_VICTINI] =
    {
        ...
        ICON(Victini),
        FOOTPRINT(Victini)
        FOLLOWER(Victini, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Victini),
    },
    ...
    [SPECIES_SNIVY] =
    {
        ...
        ICON(Snivy),
        FOOTPRINT(Snivy)
        FOLLOWER(Snivy, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Snivy),
    ...
    [SPECIES_SERVINE] =
    {
        ...
        ICON(Servine),
        FOOTPRINT(Servine)
        FOLLOWER(Servine, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Servine),
    ...
    [SPECIES_SERPERIOR] =
    {
        ...
        ICON(Serperior),
        FOOTPRINT(Serperior)
        FOLLOWER(Serperior, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Serperior),
    },
    ...
    [SPECIES_TEPIG] =
    {
        ...
        ICON(Tepig),
        FOOTPRINT(Tepig)
        FOLLOWER(Tepig, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Tepig),
    ...
    [SPECIES_PIGNITE] =
    {
        ...
        ICON(Pignite),
        FOOTPRINT(Pignite)
        FOLLOWER(Pignite, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Pignite),
    ...
    [SPECIES_EMBOAR] =
    {
        ...
        ICON(Emboar),
        FOOTPRINT(Emboar)
        FOLLOWER(Emboar, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Emboar),
    },
    ...
    [SPECIES_OSHAWOTT] =
    {
        ...
        ICON(Oshawott),
        FOOTPRINT(Oshawott)
        FOLLOWER(Oshawott, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Oshawott),
    ...
    [SPECIES_DEWOTT] =
    {
        ...
        ICON(Dewott),
        FOOTPRINT(Dewott)
        FOLLOWER(Dewott, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Dewott),
...
#define SAMUROTT_MISC_INFO                                                  \
    ...
    [SPECIES_SAMUROTT] =
    {
        ...
        PALETTES(Samurott),
        ICON(Samurott),
        FOLLOWER(Samurott, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Samurott),
    },
    ...
    [SPECIES_SAMUROTT_HISUIAN] =
    {
        ...
        ICON(SamurottHisuian),
        FOLLOWER(SamurottHisuian, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_PATRAT] =
    {
        ...
        ICON(Patrat),
        FOOTPRINT(Patrat)
        FOLLOWER(Patrat, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Patrat),
    ...
    [SPECIES_WATCHOG] =
    {
        ...
        ICON(Watchog),
        FOOTPRINT(Watchog)
        FOLLOWER(Watchog, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Watchog),
    },
    ...
    [SPECIES_LILLIPUP] =
    {
        ...
        ICON(Lillipup),
        FOOTPRINT(Lillipup)
        FOLLOWER(Lillipup, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Lillipup),
    ...
    [SPECIES_HERDIER] =
    {
        ...
        ICON(Herdier),
        FOOTPRINT(Herdier)
        FOLLOWER(Herdier, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Herdier),
    ...
    [SPECIES_STOUTLAND] =
    {
        ...
        ICON(Stoutland),
        FOOTPRINT(Stoutland)
        FOLLOWER(Stoutland, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Stoutland),
    },
    ...
    [SPECIES_PURRLOIN] =
    {
        ...
        ICON(Purrloin),
        FOOTPRINT(Purrloin)
        FOLLOWER(Purrloin, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Purrloin),
    ...
    [SPECIES_LIEPARD] =
    {
        ...
        ICON(Liepard),
        FOOTPRINT(Liepard)
        FOLLOWER(Liepard, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Liepard),
    },
    ...
    [SPECIES_PANSAGE] =
    {
        ...
        ICON(Pansage),
        FOOTPRINT(Pansage)
        FOLLOWER(Pansage, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Pansage),
    ...
    [SPECIES_SIMISAGE] =
    {
        ...
        ICON(Simisage),
        FOOTPRINT(Simisage)
        FOLLOWER(Simisage, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Simisage),
    },
    ...
    [SPECIES_PANSEAR] =
    {
        ...
        ICON(Pansear),
        FOOTPRINT(Pansear)
        FOLLOWER(Pansear, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Pansear),
    ...
    [SPECIES_SIMISEAR] =
    {
        ...
        ICON(Simisear),
        FOOTPRINT(Simisear)
        FOLLOWER(Simisear, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Simisear),
    },
    ...
    [SPECIES_PANPOUR] =
    {
        ...
        ICON(Panpour),
        FOOTPRINT(Panpour)
        FOLLOWER(Panpour, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Panpour),
    ...
    [SPECIES_SIMIPOUR] =
    {
        ...
        ICON(Simipour),
        FOOTPRINT(Simipour)
        FOLLOWER(Simipour, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Simipour),
    },
    ...
    [SPECIES_MUNNA] =
    {
        ...
        ICON(Munna),
        FOOTPRINT(Munna)
        FOLLOWER(Munna, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Munna),
    ...
    [SPECIES_MUSHARNA] =
    {
        ...
        ICON(Musharna),
        FOOTPRINT(Musharna)
        FOLLOWER(Musharna, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Musharna),
    },
    ...
    [SPECIES_PIDOVE] =
    {
        ...
        ICON(Pidove),
        FOOTPRINT(Pidove)
        FOLLOWER(Pidove, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Pidove),
    ...
    [SPECIES_TRANQUILL] =
    {
        ...
        ICON(Tranquill),
        FOOTPRINT(Tranquill)
        FOLLOWER(Tranquill, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Tranquill),
    ...
    [SPECIES_UNFEZANT] =
    {
        ...
        ICON(Unfezant),
        ICON_FEMALE(Unfezant),
        FOOTPRINT(Unfezant)
        FOLLOWER(Unfezant, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Unfezant),
    },
    ...
    [SPECIES_BLITZLE] =
    {
        ...
        ICON(Blitzle),
        FOOTPRINT(Blitzle)
        FOLLOWER(Blitzle, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Blitzle),
    ...
    [SPECIES_ZEBSTRIKA] =
    {
        ...
        ICON(Zebstrika),
        FOOTPRINT(Zebstrika)
        FOLLOWER(Zebstrika, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Zebstrika),
    },
    ...
    [SPECIES_ROGGENROLA] =
    {
        ...
        FOLLOWER(Roggenrola, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_BOLDORE] =
    {
        ...
        ICON(Boldore),
        FOOTPRINT(Boldore)
        FOLLOWER(Boldore, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Boldore),
    ...
    [SPECIES_GIGALITH] =
    {
        ...
        ICON(Gigalith),
        FOOTPRINT(Gigalith)
        FOLLOWER(Gigalith, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Gigalith),
    },
    ...
    [SPECIES_WOOBAT] =
    {
        ...
        ICON(Woobat),
        FOOTPRINT(Woobat)
        FOLLOWER(Woobat, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Woobat),
    ...
    [SPECIES_SWOOBAT] =
    {
        ...
        ICON(Swoobat),
        FOOTPRINT(Swoobat)
        FOLLOWER(Swoobat, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Swoobat),
    },
    ...
    [SPECIES_DRILBUR] =
    {
        ...
        ICON(Drilbur),
        FOOTPRINT(Drilbur)
        FOLLOWER(Drilbur, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Drilbur),
    ...
    [SPECIES_EXCADRILL] =
    {
        ...
        ICON(Excadrill),
        FOOTPRINT(Excadrill)
        FOLLOWER(Excadrill, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Excadrill),
    },
...
#define AUDINO_MISC_INFO                                    \
    ...
    [SPECIES_AUDINO] =
    {
        ...
        PALETTES(Audino),
        ICON(Audino),
        FOLLOWER(Audino, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_TIMBURR] =
    {
        ...
        ICON(Timburr),
        FOOTPRINT(Timburr)
        FOLLOWER(Timburr, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Timburr),
    ...
    [SPECIES_GURDURR] =
    {
        ...
        ICON(Gurdurr),
        FOOTPRINT(Gurdurr)
        FOLLOWER(Gurdurr, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Gurdurr),
    ...
    [SPECIES_CONKELDURR] =
    {
        ...
        FOLLOWER(Conkeldurr, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_TYMPOLE] =
    {
        ...
        ICON(Tympole),
        FOOTPRINT(Tympole)
        FOLLOWER(Tympole, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Tympole),
    ...
    [SPECIES_PALPITOAD] =
    {
        ...
        ICON(Palpitoad),
        FOOTPRINT(Palpitoad)
        FOLLOWER(Palpitoad, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Palpitoad),
    ...
    [SPECIES_SEISMITOAD] =
    {
        ...
        FOLLOWER(Seismitoad, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_THROH] =
    {
        ...
        ICON(Throh),
        FOOTPRINT(Throh)
        FOLLOWER(Throh, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Throh),
    },
    ...
    [SPECIES_SAWK] =
    {
        ...
        ICON(Sawk),
        FOOTPRINT(Sawk)
        FOLLOWER(Sawk, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Sawk),
    },
#endif //P_FAMILY_SAWK
    ...
    [SPECIES_SEWADDLE] =
    {
        ...
        ICON(Sewaddle),
        FOOTPRINT(Sewaddle)
        FOLLOWER(Sewaddle, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Sewaddle),
    ...
    [SPECIES_SWADLOON] =
    {
        ...
        ICON(Swadloon),
        FOOTPRINT(Swadloon)
        FOLLOWER(Swadloon, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Swadloon),
    ...
    [SPECIES_LEAVANNY] =
    {
        ...
        ICON(Leavanny),
        FOOTPRINT(Leavanny)
        FOLLOWER(Leavanny, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Leavanny),
    },
    ...
    [SPECIES_VENIPEDE] =
    {
        ...
        ICON(Venipede),
        FOOTPRINT(Venipede)
        FOLLOWER(Venipede, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Venipede),
    ...
    [SPECIES_WHIRLIPEDE] =
    {
        ...
        FOLLOWER(Whirlipede, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_SCOLIPEDE] =
    {
        ...
        ICON(Scolipede),
        FOOTPRINT(Scolipede)
        FOLLOWER(Scolipede, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Scolipede),
    },
    ...
    [SPECIES_COTTONEE] =
    {
        ...
        ICON(Cottonee),
        FOOTPRINT(Cottonee)
        FOLLOWER(Cottonee, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Cottonee),
    ...
    [SPECIES_WHIMSICOTT] =
    {
        ...
        FOLLOWER(Whimsicott, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_PETILIL] =
    {
        ...
        ICON(Petilil),
        FOOTPRINT(Petilil)
        FOLLOWER(Petilil, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Petilil),
...
#define LILLIGANT_MISC_INFO                                 \
    ...
    [SPECIES_LILLIGANT] =
    {
        ...
        PALETTES(Lilligant),
        ICON(Lilligant),
        FOLLOWER(Lilligant, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Lilligant),
    },
    ...
    [SPECIES_LILLIGANT_HISUIAN] =
    {
        ...
        FOLLOWER(LilligantHisuian, SHADOW_SIZE_M, TRACKS_FOOT)
...
#define BASCULIN_MISC_INFO                                      \
    ...
    [SPECIES_BASCULIN_RED_STRIPED] =
    {
        ...
        ICON(BasculinRedStriped),
        FOLLOWER(BasculinRedStriped, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Basculin),
    },
    ...
    [SPECIES_BASCULIN_BLUE_STRIPED] =
    {
        ...
        ICON(BasculinBlueStriped),
        FOLLOWER(BasculinBlueStriped, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Basculin),
    },
    ...
    [SPECIES_BASCULIN_WHITE_STRIPED] =
    {
        ...
        ICON(BasculinWhiteStriped),
        FOLLOWER(BasculinWhiteStriped, SHADOW_SIZE_M, TRACKS_FOOT)
...
#define BASCULEGION_MISC_INFO                                                               \
    ...
    [SPECIES_BASCULEGION_MALE] =
    {
        ...
        ICON(BasculegionMale),
        FOLLOWER(BasculegionMale, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_BASCULEGION_FEMALE] =
    {
        ...
        ICON(BasculegionFemale),
        FOLLOWER(BasculegionFemale, SHADOW_SIZE_M, TRACKS_FOOT)
    },
#endif //P_HISUIAN_FORMS
    ...
    [SPECIES_SANDILE] =
    {
        ...
        ICON(Sandile),
        FOOTPRINT(Sandile)
        FOLLOWER(Sandile, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Sandile),
    ...
    [SPECIES_KROKOROK] =
    {
        ...
        ICON(Krokorok),
        FOOTPRINT(Krokorok)
        FOLLOWER(Krokorok, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Krokorok),
    ...
    [SPECIES_KROOKODILE] =
    {
        ...
        FOLLOWER(Krookodile, SHADOW_SIZE_M, TRACKS_FOOT)
...
#define DARUMAKA_MISC_INFO                                                  \
    ...
    [SPECIES_DARUMAKA] =
    {
        ...
        PALETTES(Darumaka),
        ICON(Darumaka),
        FOLLOWER(Darumaka, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Darumaka),
...
#define DARMANITAN_UNOVAN_MISC_INFO                                         \
    ...
    [SPECIES_DARMANITAN_STANDARD_MODE] =
    {
        ...
        ICON(DarmanitanStandardMode),
        FOLLOWER(DarmanitanStandardMode, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_DARUMAKA_GALARIAN] =
    {
        ...
        ICON(DarumakaGalarian),
        FOLLOWER(DarumakaGalarian, SHADOW_SIZE_M, TRACKS_FOOT)
...
#define DARMANITAN_GALARIAN_MISC_INFO                                           \
    ...
    [SPECIES_DARMANITAN_GALARIAN_STANDARD_MODE] =
    {
        ...
        .itemRare = ITEM_SNOWBALL,
        ICON(DarmanitanGalarianStandardMode),
        FOLLOWER(DarmanitanGalarianStandardMode, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_MARACTUS] =
    {
        ...
        ICON(Maractus),
        FOOTPRINT(Maractus)
        FOLLOWER(Maractus, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Maractus),
    },
    ...
    [SPECIES_DWEBBLE] =
    {
        ...
        ICON(Dwebble),
        FOOTPRINT(Dwebble)
        FOLLOWER(Dwebble, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Dwebble),
    ...
    [SPECIES_CRUSTLE] =
    {
        ...
        ICON(Crustle),
        FOOTPRINT(Crustle)
        FOLLOWER(Crustle, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Crustle),
    },
    ...
    [SPECIES_SCRAGGY] =
    {
        ...
        ICON(Scraggy),
        FOOTPRINT(Scraggy)
        FOLLOWER(Scraggy, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Scraggy),
    ...
    [SPECIES_SCRAFTY] =
    {
        ...
        ICON(Scrafty),
        FOOTPRINT(Scrafty)
        FOLLOWER(Scrafty, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Scrafty),
    },
    ...
    [SPECIES_SIGILYPH] =
    {
        ...
        ICON(Sigilyph),
        FOOTPRINT(Sigilyph)
        FOLLOWER(Sigilyph, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Sigilyph),
    },
...
#define YAMASK_MISC_INFO                                                   \
    ...
    [SPECIES_YAMASK] =
    {
        ...
        PALETTES(Yamask),
        ICON(Yamask),
        FOLLOWER(Yamask, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Yamask),
    ...
    [SPECIES_COFAGRIGUS] =
    {
        ...
        FOLLOWER(Cofagrigus, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_YAMASK_GALARIAN] =
    {
        ...
        ICON(YamaskGalarian),
        FOLLOWER(YamaskGalarian, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_RUNERIGUS] =
    {
        ...
        ICON(Runerigus),
        FOOTPRINT(Runerigus)
        FOLLOWER(Runerigus, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Runerigus),
    },
#endif //P_GALARIAN_FORMS
    ...
    [SPECIES_TIRTOUGA] =
    {
        ...
        ICON(Tirtouga),
        FOOTPRINT(Tirtouga)
        FOLLOWER(Tirtouga, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Tirtouga),
    ...
    [SPECIES_CARRACOSTA] =
    {
        ...
        FOLLOWER(Carracosta, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_ARCHEN] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING, EGG_GROUP_INVERTEBRADO),
        ...
        ICON(Archen),
        FOOTPRINT(Archen)
        FOLLOWER(Archen, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Archen),
    ...
    [SPECIES_ARCHEOPS] =
    {
        ...
        ICON(Archeops),
        FOOTPRINT(Archeops)
        FOLLOWER(Archeops, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Archeops),
    },
    ...
    [SPECIES_TRUBBISH] =
    {
        ...
        ICON(Trubbish),
        FOOTPRINT(Trubbish)
        FOLLOWER(Trubbish, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Trubbish),
...
#define GARBODOR_MISC_INFO                                                      \
    ...
    [SPECIES_GARBODOR] =
    {
        ...
        PALETTES(Garbodor),
        ICON(Garbodor),
        FOLLOWER(Garbodor, SHADOW_SIZE_M, TRACKS_FOOT)
    },
...
#define ZOROARK_MISC_INFO                                   \
    ...
    [SPECIES_ZORUA] =
    {
        ...
        PALETTES(Zorua),
        ICON(Zorua),
        FOLLOWER(Zorua, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Zorua),
    ...
    [SPECIES_ZOROARK] =
    {
        ...
        PALETTES(Zoroark),
        ICON(Zoroark),
        FOLLOWER(Zoroark, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Zoroark),
    },
    ...
    [SPECIES_ZORUA_HISUIAN] =
    {
        ...
        ICON(ZoruaHisuian),
        FOLLOWER(ZoruaHisuian, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_ZOROARK_HISUIAN] =
    {
        ...
        ICON(ZoroarkHisuian),
        FOLLOWER(ZoroarkHisuian, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_MINCCINO] =
    {
        ...
        ICON(Minccino),
        FOOTPRINT(Minccino)
        FOLLOWER(Minccino, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Minccino),
    ...
    [SPECIES_CINCCINO] =
    {
        ...
        ICON(Cinccino),
        FOOTPRINT(Cinccino)
        FOLLOWER(Cinccino, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Cinccino),
    },
    ...
    [SPECIES_GOTHITA] =
    {
        ...
        ICON(Gothita),
        FOOTPRINT(Gothita)
        FOLLOWER(Gothita, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Gothita),
    ...
    [SPECIES_GOTHORITA] =
    {
        ...
        ICON(Gothorita),
        FOOTPRINT(Gothorita)
        FOLLOWER(Gothorita, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Gothorita),
    ...
    [SPECIES_GOTHITELLE] =
    {
        ...
        FOLLOWER(Gothitelle, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_SOLOSIS] =
    {
        ...
        ICON(Solosis),
        FOOTPRINT(Solosis)
        FOLLOWER(Solosis, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Solosis),
    ...
    [SPECIES_DUOSION] =
    {
        ...
        ICON(Duosion),
        FOOTPRINT(Duosion)
        FOLLOWER(Duosion, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Duosion),
    ...
    [SPECIES_REUNICLUS] =
    {
        ...
        ICON(Reuniclus),
        FOOTPRINT(Reuniclus)
        FOLLOWER(Reuniclus, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Reuniclus),
    },
    ...
    [SPECIES_DUCKLETT] =
    {
        ...
        ICON(Ducklett),
        FOOTPRINT(Ducklett)
        FOLLOWER(Ducklett, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Ducklett),
    ...
    [SPECIES_SWANNA] =
    {
        ...
        ICON(Swanna),
        FOOTPRINT(Swanna)
        FOLLOWER(Swanna, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Swanna),
    },
    ...
    [SPECIES_VANILLITE] =
    {
        ...
        ICON(Vanillite),
        FOOTPRINT(Vanillite)
        FOLLOWER(Vanillite, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Vanillite),
    ...
    [SPECIES_VANILLISH] =
    {
        ...
        ICON(Vanillish),
        FOOTPRINT(Vanillish)
        FOLLOWER(Vanillish, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Vanillish),
    ...
    [SPECIES_VANILLUXE] =
    {
        ...
        ICON(Vanilluxe),
        FOOTPRINT(Vanilluxe)
        FOLLOWER(Vanilluxe, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Vanilluxe),
    },
...
#define DEERLING_MISC_INFO                                                              \
    ...
    [SPECIES_DEERLING_SPRING] =
    {
        ...
        ICON(DeerlingSpring),
        FOLLOWER(DeerlingSpring, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_DEERLING_SUMMER] =
    {
        ...
        ICON(DeerlingSummer),
        FOLLOWER(DeerlingSummer, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_DEERLING_AUTUMN] =
    {
        ...
        ICON(DeerlingAutumn),
        FOLLOWER(DeerlingAutumn, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_DEERLING_WINTER] =
    {
        ...
        ICON(DeerlingWinter),
        FOLLOWER(DeerlingWinter, SHADOW_SIZE_M, TRACKS_FOOT)
...
#define SAWSBUCK_MISC_INFO                                                              \
    ...
    [SPECIES_SAWSBUCK_SPRING] =
    {
        ...
        ICON(SawsbuckSpring),
        FOLLOWER(SawsbuckSpring, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_SAWSBUCK_SUMMER] =
    {
        ...
        ICON(SawsbuckSummer),
        FOLLOWER(SawsbuckSummer, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_SAWSBUCK_AUTUMN] =
    {
        ...
        ICON(SawsbuckAutumn),
        FOLLOWER(SawsbuckAutumn, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_SAWSBUCK_WINTER] =
    {
        ...
        ICON(SawsbuckWinter),
        FOLLOWER(SawsbuckWinter, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_EMOLGA] =
    {
        ...
        ICON(Emolga),
        FOOTPRINT(Emolga)
        FOLLOWER(Emolga, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Emolga),
    },
    ...
    [SPECIES_KARRABLAST] =
    {
        ...
        FOLLOWER(Karrablast, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_ESCAVALIER] =
    {
        ...
        FOLLOWER(Escavalier, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_FOONGUS] =
    {
        ...
        ICON(Foongus),
        FOOTPRINT(Foongus)
        FOLLOWER(Foongus, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Foongus),
    ...
    [SPECIES_AMOONGUSS] =
    {
        ...
        ICON(Amoonguss),
        FOOTPRINT(Amoonguss)
        FOLLOWER(Amoonguss, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Amoonguss),
    },
    ...
    [SPECIES_FRILLISH] =
    {
        ...
        ICON(Frillish),
        ICON_FEMALE(Frillish),
        FOOTPRINT(Frillish)
        FOLLOWER(Frillish, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Frillish),
    ...
    [SPECIES_JELLICENT] =
    {
        ...
        ICON(Jellicent),
        ICON_FEMALE(Jellicent),
        FOOTPRINT(Jellicent)
        FOLLOWER(Jellicent, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Jellicent),
    },
    ...
    [SPECIES_ALOMOMOLA] =
    {
        ...
        ICON(Alomomola),
        FOOTPRINT(Alomomola)
        FOLLOWER(Alomomola, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Alomomola),
    },
    ...
    [SPECIES_JOLTIK] =
    {
        ...
        ICON(Joltik),
        FOOTPRINT(Joltik)
        FOLLOWER(Joltik, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Joltik),
    ...
    [SPECIES_GALVANTULA] =
    {
        ...
        FOLLOWER(Galvantula, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_FERROSEED] =
    {
        ...
        ICON(Ferroseed),
        FOOTPRINT(Ferroseed)
        FOLLOWER(Ferroseed, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Ferroseed),
    ...
    [SPECIES_FERROTHORN] =
    {
        ...
        FOLLOWER(Ferrothorn, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_KLINK] =
    {
        ...
        ICON(Klink),
        FOOTPRINT(Klink)
        FOLLOWER(Klink, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Klink),
    ...
    [SPECIES_KLANG] =
    {
        ...
        ICON(Klang),
        FOOTPRINT(Klang)
        FOLLOWER(Klang, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Klang),
    ...
    [SPECIES_KLINKLANG] =
    {
        ...
        ICON(Klinklang),
        FOOTPRINT(Klinklang)
        FOLLOWER(Klinklang, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Klinklang),
    },
    ...
    [SPECIES_TYNAMO] =
    {
        ...
        ICON(Tynamo),
        FOOTPRINT(Tynamo)
        FOLLOWER(Tynamo, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Tynamo),
        .tmIlliterate = TRUE,
    ...
    [SPECIES_EELEKTRIK] =
    {
        ...
        ICON(Eelektrik),
        FOOTPRINT(Eelektrik)
        FOLLOWER(Eelektrik, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Eelektrik),
    ...
    [SPECIES_EELEKTROSS] =
    {
        ...
        FOLLOWER(Eelektross, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_ELGYEM] =
    {
        ...
        ICON(Elgyem),
        FOOTPRINT(Elgyem)
        FOLLOWER(Elgyem, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Elgyem),
    ...
    [SPECIES_BEHEEYEM] =
    {
        ...
        ICON(Beheeyem),
        FOOTPRINT(Beheeyem)
        FOLLOWER(Beheeyem, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Beheeyem),
    },
    ...
    [SPECIES_LITWICK] =
    {
        ...
        ICON(Litwick),
        FOOTPRINT(Litwick)
        FOLLOWER(Litwick, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Litwick),
    ...
    [SPECIES_LAMPENT] =
    {
        ...
        ICON(Lampent),
        FOOTPRINT(Lampent)
        FOLLOWER(Lampent, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Lampent),
    ...
    [SPECIES_CHANDELURE] =
    {
        ...
        FOLLOWER(Chandelure, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_AXEW] =
    {
        ...
        ICON(Axew),
        FOOTPRINT(Axew)
        FOLLOWER(Axew, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Axew),
    ...
    [SPECIES_FRAXURE] =
    {
        ...
        ICON(Fraxure),
        FOOTPRINT(Fraxure)
        FOLLOWER(Fraxure, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Fraxure),
    ...
    [SPECIES_HAXORUS] =
    {
        ...
        ICON(Haxorus),
        FOOTPRINT(Haxorus)
        FOLLOWER(Haxorus, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Haxorus),
    },
#endif //P_FAMILY_AXEW
    ...
    [SPECIES_CUBCHOO] =
    {
        ...
        ICON(Cubchoo),
        FOOTPRINT(Cubchoo)
        FOLLOWER(Cubchoo, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Cubchoo),
    ...
    [SPECIES_BEARTIC] =
    {
        ...
        ICON(Beartic),
        FOOTPRINT(Beartic)
        FOLLOWER(Beartic, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Beartic),
    },
    ...
    [SPECIES_CRYOGONAL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = {ABILITY_LEVITATE, ABILITY_CERO_ABSOLUTO},
        .bodyColor = BODY_COLOR_BLUE,
        ...
        ICON(Cryogonal),
        FOOTPRINT(Cryogonal)
        FOLLOWER(Cryogonal, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Cryogonal),
    },
    ...
    [SPECIES_SHELMET] =
    {
        ...
        ICON(Shelmet),
        FOOTPRINT(Shelmet)
        FOLLOWER(Shelmet, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Shelmet),
    ...
    [SPECIES_ACCELGOR] =
    {
        ...
        ICON(Accelgor),
        FOOTPRINT(Accelgor)
        FOLLOWER(Accelgor, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Accelgor),
    },
...
#define STUNFISK_MISC_INFO                                                 \
    ...
    [SPECIES_STUNFISK] =
    {
        ...
        PALETTES(Stunfisk),
        ICON(Stunfisk),
        FOLLOWER(Stunfisk, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Stunfisk),
    },
    ...
    [SPECIES_STUNFISK_GALARIAN] =
    {
        ...
        ICON(StunfiskGalarian),
        FOLLOWER(StunfiskGalarian, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_MIENFOO] =
    {
        ...
        ICON(Mienfoo),
        FOOTPRINT(Mienfoo)
        FOLLOWER(Mienfoo, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Mienfoo),
    ...
    [SPECIES_MIENSHAO] =
    {
        ...
        ICON(Mienshao),
        FOOTPRINT(Mienshao)
        FOLLOWER(Mienshao, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Mienshao),
    },
    ...
    [SPECIES_DRUDDIGON] =
    {
        ...
        ICON(Druddigon),
        FOOTPRINT(Druddigon)
        FOLLOWER(Druddigon, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Druddigon),
    },
    ...
    [SPECIES_GOLETT] =
    {
        ...
        ICON(Golett),
        FOOTPRINT(Golett)
        FOLLOWER(Golett, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Golett),
    ...
    [SPECIES_GOLURK] =
    {
        ...
        ICON(Golurk),
        FOOTPRINT(Golurk)
        FOLLOWER(Golurk, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Golurk),
    },
    ...
    [SPECIES_PAWNIARD] =
    {
        ...
        ICON(Pawniard),
        FOOTPRINT(Pawniard)
        FOLLOWER(Pawniard, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Pawniard),
    ...
    [SPECIES_BISHARP] =
    {
        ...
        ICON(Bisharp),
        FOOTPRINT(Bisharp)
        FOLLOWER(Bisharp, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Bisharp),
    },
    ...
    [SPECIES_BOUFFALANT] =
    {
        ...
        FOLLOWER(Bouffalant, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_RUFFLET] =
    {
        ...
        ICON(Rufflet),
        FOOTPRINT(Rufflet)
        FOLLOWER(Rufflet, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Rufflet),
...
#define BRAVIARY_MISC_INFO                                      \
    ...
    [SPECIES_BRAVIARY] =
    {
        ...
        PALETTES(Braviary),
        ICON(Braviary),
        FOLLOWER(Braviary, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Braviary),
    },
    ...
    [SPECIES_BRAVIARY_HISUIAN] =
    {
        ...
        ICON(BraviaryHisuian),
        FOLLOWER(BraviaryHisuian, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_VULLABY] =
    {
        ...
        ICON(Vullaby),
        FOOTPRINT(Vullaby)
        FOLLOWER(Vullaby, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Vullaby),
    ...
    [SPECIES_MANDIBUZZ] =
    {
        ...
        ICON(Mandibuzz),
        FOOTPRINT(Mandibuzz)
        FOLLOWER(Mandibuzz, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Mandibuzz),
    },
    ...
    [SPECIES_HEATMOR] =
    {
        ...
        ICON(Heatmor),
        FOOTPRINT(Heatmor)
        FOLLOWER(Heatmor, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Heatmor),
    },
    ...
    [SPECIES_DURANT] =
    {
        ...
        ICON(Durant),
        FOOTPRINT(Durant)
        FOLLOWER(Durant, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Durant),
    },
    ...
    [SPECIES_DEINO] =
    {
        ...
        ICON(Deino),
        FOOTPRINT(Deino)
        FOLLOWER(Deino, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Deino),
    ...
    [SPECIES_ZWEILOUS] =
    {
        ...
        ICON(Zweilous),
        FOOTPRINT(Zweilous)
        FOLLOWER(Zweilous, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Zweilous),
    ...
    [SPECIES_HYDREIGON] =
    {
        ...
        ICON(Hydreigon),
        FOOTPRINT(Hydreigon)
        FOLLOWER(Hydreigon, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Hydreigon),
    },
    ...
    [SPECIES_LARVESTA] =
    {
        ...
        ICON(Larvesta),
        FOOTPRINT(Larvesta)
        FOLLOWER(Larvesta, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Larvesta),
    ...
    [SPECIES_VOLCARONA] =
    {
        ...
        ICON(Volcarona),
        FOOTPRINT(Volcarona)
        FOLLOWER(Volcarona, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Volcarona),
    },
    ...
    [SPECIES_COBALION] =
    {
        ...
        ICON(Cobalion),
        FOOTPRINT(Cobalion)
        FOLLOWER(Cobalion, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Cobalion),
    },
    ...
    [SPECIES_TERRAKION] =
    {
        ...
        ICON(Terrakion),
        FOOTPRINT(Terrakion)
        FOLLOWER(Terrakion, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Terrakion),
    },
    ...
    [SPECIES_VIRIZION] =
    {
        ...
        ICON(Virizion),
        FOOTPRINT(Virizion)
        FOLLOWER(Virizion, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Virizion),
    },
...
#define TORNADUS_MISC_INFO                                                              \
    ...
    [SPECIES_TORNADUS_INCARNATE] =
    {
        ...
        ICON(TornadusIncarnate),
        FOLLOWER(TornadusIncarnate, SHADOW_SIZE_M, TRACKS_FOOT)
    },
...
#define THUNDURUS_MISC_INFO                                                             \
    ...
    [SPECIES_THUNDURUS_INCARNATE] =
    {
        ...
        ICON(ThundurusIncarnate),
        FOLLOWER(ThundurusIncarnate, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_RESHIRAM] =
    {
        ...
        ICON(Reshiram),
        FOOTPRINT(Reshiram)
        FOLLOWER(Reshiram, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Reshiram),
    },
    ...
    [SPECIES_ZEKROM] =
    {
        ...
        ICON(Zekrom),
        FOOTPRINT(Zekrom)
        FOLLOWER(Zekrom, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Zekrom),
    },
...
#define LANDORUS_MISC_INFO                                                              \
    ...
    [SPECIES_LANDORUS_INCARNATE] =
    {
        ...
        ICON(LandorusIncarnate),
        FOLLOWER(LandorusIncarnate, SHADOW_SIZE_M, TRACKS_FOOT)
    },
...
#define KYUREM_MISC_INFO                                                                \
    ...
    [SPECIES_KYUREM] =
    {
        ...
        PALETTES(Kyurem),
        ICON(Kyurem),
        FOLLOWER(Kyurem, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Kyurem),
    },
...
#define KELDEO_MISC_INFO                                                                \
    ...
    [SPECIES_KELDEO_ORDINARY] =
    {
        ...
        ICON(KeldeoOrdinary),
        FOLLOWER(KeldeoOrdinary, SHADOW_SIZE_M, TRACKS_FOOT)
    },
...
#define MELOETTA_MISC_INFO                                                              \
    ...
    [SPECIES_MELOETTA_ARIA] =
    {
        ...
        ICON(MeloettaAria),
        FOLLOWER(MeloettaAria, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_MELOETTA_PIROUETTE] =
    {
        ...
        ICON(MeloettaPirouette),
        FOLLOWER(MeloettaPirouette, SHADOW_SIZE_M, TRACKS_FOOT)
    },
...
#define GENESECT_SPECIES_INFO(form)                                                     \
    {                                                                                   \
        ...
        ICON(Genesect),                                                              \
        FOOTPRINT(Genesect)                                                             \
        FOLLOWER(Genesect, SHADOW_SIZE_M, TRACKS_FOOT)                      \
        LEARNSETS(Genesect),                                                            \
