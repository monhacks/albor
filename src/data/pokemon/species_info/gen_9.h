...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_QUAXLY] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING, EGG_GROUP_ANFIBIO),
...
#define SQUAWKABILLY_MISC_INFO                                  \
    ...
    [SPECIES_ESPATHRA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { , ABILITY_FRISK, ABILITY_SPEED_BOOST},
        .bodyColor = BODY_COLOR_YELLOW,
...
#define OGERPON_SPECIES_INFO(Form, type, ability, color, iconpalette, isTeraform)       \
    {                                                                                   \
        ...
        ICON(OgerponTealMask), /* Each form should have its own icon */              \
        /*FOOTPRINT(Ogerpon)*/                                                          \
        LEARNSETS(Ogerpon),                                                             \
