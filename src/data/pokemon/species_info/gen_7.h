...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_ROWLET] =
    {
        ...
        ICON(Rowlet),
        FOOTPRINT(Rowlet)
        FOLLOWER(Rowlet, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Rowlet),
    ...
    [SPECIES_DARTRIX] =
    {
        ...
        ICON(Dartrix, 1),
        FOOTPRINT(Dartrix)
        FOLLOWER(Dartrix, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Dartrix),
...
#define DECIDUEYE_MISC_INFO                                     \
    ...
    [SPECIES_DECIDUEYE] =
    {
        ...
        PALETTES(Decidueye),
        ICON(Decidueye, 1),
        FOLLOWER(Decidueye, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Decidueye),
    },
    ...
    [SPECIES_DECIDUEYE_HISUIAN] =
    {
        ...
        FOLLOWER(DecidueyeHisuian, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_LITTEN] =
    {
        ...
        ICON(Litten),
        FOOTPRINT(Litten)
        FOLLOWER(Litten, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Litten),
    ...
    [SPECIES_TORRACAT] =
    {
        ...
        ICON(Torracat),
        FOOTPRINT(Torracat)
        FOLLOWER(Torracat, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Torracat),
    ...
    [SPECIES_INCINEROAR] =
    {
        ...
        FOLLOWER(Incineroar, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_POPPLIO] =
    {
        ...
        ICON(Popplio),
        FOOTPRINT(Popplio)
        FOLLOWER(Popplio, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Popplio),
    ...
    [SPECIES_BRIONNE] =
    {
        ...
        ICON(Brionne),
        FOOTPRINT(Brionne)
        FOLLOWER(Brionne, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Brionne),
    ...
    [SPECIES_PRIMARINA] =
    {
        ...
        ICON(Primarina),
        FOOTPRINT(Primarina)
        FOLLOWER(Primarina, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Primarina),
    },
    ...
    [SPECIES_PIKIPEK] =
    {
        ...
        ICON(Pikipek),
        FOOTPRINT(Pikipek)
        FOLLOWER(Pikipek, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Pikipek),
    ...
    [SPECIES_TRUMBEAK] =
    {
        ...
        ICON(Trumbeak),
        FOOTPRINT(Trumbeak)
        FOLLOWER(Trumbeak, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Trumbeak),
    ...
    [SPECIES_TOUCANNON] =
    {
        ...
        ICON(Toucannon),
        FOOTPRINT(Toucannon)
        FOLLOWER(Toucannon, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Toucannon),
    },
    ...
    [SPECIES_YUNGOOS] =
    {
        ...
        ICON(Yungoos),
        FOOTPRINT(Yungoos)
        FOLLOWER(Yungoos, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Yungoos),
    ...
    [SPECIES_GUMSHOOS] =
    {
        ...
        ICON(Gumshoos),
        FOOTPRINT(Gumshoos)
        FOLLOWER(Gumshoos, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Gumshoos),
    },
    ...
    [SPECIES_GRUBBIN] =
    {
        ...
        ICON(Grubbin),
        FOOTPRINT(Grubbin)
        FOLLOWER(Grubbin, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Grubbin),
    ...
    [SPECIES_CHARJABUG] =
    {
        ...
        ICON(Charjabug, 1),
        FOOTPRINT(Charjabug)
        FOLLOWER(Charjabug, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Charjabug),
    ...
    [SPECIES_VIKAVOLT] =
    {
        ...
        ICON(Vikavolt),
        FOOTPRINT(Vikavolt)
        FOLLOWER(Vikavolt, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Vikavolt),
    },
    ...
    [SPECIES_CRABRAWLER] =
    {
        ...
        FOLLOWER(Crabrawler, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_CRABOMINABLE] =
    {
        ...
        FOLLOWER(Crabominable, SHADOW_SIZE_M, TRACKS_FOOT)
...
#define ORICORIO_MISC_INFO                                      \
    ...
    [SPECIES_ORICORIO_BAILE] =
    {
        ...
        ICON(OricorioBaile),
        FOLLOWER(OricorioBaile, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_CUTIEFLY] =
    {
        ...
        ICON(Cutiefly),
        FOOTPRINT(Cutiefly)
        FOLLOWER(Cutiefly, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Cutiefly),
    ...
    [SPECIES_RIBOMBEE] =
    {
        ...
        ICON(Ribombee),
        FOOTPRINT(Ribombee)
        FOLLOWER(Ribombee, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Ribombee),
    },
...
#define LYCANROC_MISC_INFO                                  \
    ...
    [SPECIES_LYCANROC_MIDDAY] =
    {
        ...
        ICON(LycanrocMidday),
        FOLLOWER(LycanrocMidday, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_LYCANROC_MIDNIGHT] =
    {
        ...
        FOLLOWER(LycanrocMidnight, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_LYCANROC_DUSK] =
    {
        ...
        ICON(LycanrocDusk),
        FOLLOWER(LycanrocDusk, SHADOW_SIZE_M, TRACKS_FOOT)
...
#define WISHIWASHI_MISC_INFO                                    \
    ...
    [SPECIES_WISHIWASHI_SOLO] =
    {
        ...
        ICON(WishiwashiSolo),
        FOLLOWER(WishiwashiSolo, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_MAREANIE] =
    {
        ...
        ICON(Mareanie),
        FOOTPRINT(Mareanie)
        FOLLOWER(Mareanie, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Mareanie),
    ...
    [SPECIES_TOXAPEX] =
    {
        ...
        ICON(Toxapex),
        FOOTPRINT(Toxapex)
        FOLLOWER(Toxapex, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Toxapex),
    },
    ...
    [SPECIES_MUDBRAY] =
    {
        ...
        ICON(Mudbray),
        FOOTPRINT(Mudbray)
        FOLLOWER(Mudbray, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Mudbray),
    ...
    [SPECIES_MUDSDALE] =
    {
        ...
        ICON(Mudsdale),
        FOOTPRINT(Mudsdale)
        FOLLOWER(Mudsdale, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Mudsdale),
    },
    ...
    [SPECIES_DEWPIDER] =
    {
        ...
        ICON(Dewpider),
        FOOTPRINT(Dewpider)
        FOLLOWER(Dewpider, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Dewpider),
    ...
    [SPECIES_ARAQUANID] =
    {
        ...
        ICON(Araquanid),
        FOOTPRINT(Araquanid)
        FOLLOWER(Araquanid, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Araquanid),
    },
    ...
    [SPECIES_FOMANTIS] =
    {
        ...
        ICON(Fomantis, 1),
        FOOTPRINT(Fomantis)
        FOLLOWER(Fomantis, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Fomantis),
    ...
    [SPECIES_LURANTIS] =
    {
        ...
        ICON(Lurantis, 1),
        FOOTPRINT(Lurantis)
        FOLLOWER(Lurantis, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Lurantis),
    },
    ...
    [SPECIES_MORELULL] =
    {
        ...
        ICON(Morelull),
        FOOTPRINT(Morelull)
        FOLLOWER(Morelull, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Morelull),
    ...
    [SPECIES_SHIINOTIC] =
    {
        ...
        ICON(Shiinotic, 1),
        FOOTPRINT(Shiinotic)
        FOLLOWER(Shiinotic, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Shiinotic),
    },
    ...
    [SPECIES_SALANDIT] =
    {
        ...
        ICON(Salandit),
        FOOTPRINT(Salandit)
        FOLLOWER(Salandit, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Salandit),
    ...
    [SPECIES_SALAZZLE] =
    {
        ...
        ICON(Salazzle),
        FOOTPRINT(Salazzle)
        FOLLOWER(Salazzle, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Salazzle),
    },
    ...
    [SPECIES_STUFFUL] =
    {
        ...
        ICON(Stufful),
        FOOTPRINT(Stufful)
        FOLLOWER(Stufful, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Stufful),
    ...
    [SPECIES_BEWEAR] =
    {
        ...
        ICON(Bewear),
        FOOTPRINT(Bewear)
        FOLLOWER(Bewear, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Bewear),
    },
    ...
    [SPECIES_BOUNSWEET] =
    {
        ...
        ICON(Bounsweet, 1),
        FOOTPRINT(Bounsweet)
        FOLLOWER(Bounsweet, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Bounsweet),
    ...
    [SPECIES_STEENEE] =
    {
        ...
        ICON(Steenee, 1),
        FOOTPRINT(Steenee)
        FOLLOWER(Steenee, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Steenee),
    ...
    [SPECIES_TSAREENA] =
    {
        ...
        ICON(Tsareena, 1),
        FOOTPRINT(Tsareena)
        FOLLOWER(Tsareena, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Tsareena),
    },
    ...
    [SPECIES_COMFEY] =
    {
        ...
        ICON(Comfey, 1),
        FOOTPRINT(Comfey)
        FOLLOWER(Comfey, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Comfey),
    },
    ...
    [SPECIES_ORANGURU] =
    {
        ...
        ICON(Oranguru),
        FOOTPRINT(Oranguru)
        FOLLOWER(Oranguru, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Oranguru),
    },
    ...
    [SPECIES_PASSIMIAN] =
    {
        ...
        ICON(Passimian, 1),
        FOOTPRINT(Passimian)
        FOLLOWER(Passimian, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Passimian),
    },
    ...
    [SPECIES_WIMPOD] =
    {
        ...
        ICON(Wimpod),
        FOOTPRINT(Wimpod)
        FOLLOWER(Wimpod, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Wimpod),
    ...
    [SPECIES_GOLISOPOD] =
    {
        ...
        ICON(Golisopod),
        FOOTPRINT(Golisopod)
        FOLLOWER(Golisopod, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Golisopod),
    },
    ...
    [SPECIES_SANDYGAST] =
    {
        ...
        ICON(Sandygast, 1),
        FOOTPRINT(Sandygast)
        FOLLOWER(Sandygast, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Sandygast),
    ...
    [SPECIES_PALOSSAND] =
    {
        ...
        ICON(Palossand),
        FOOTPRINT(Palossand)
        FOLLOWER(Palossand, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Palossand),
    },
    ...
    [SPECIES_PYUKUMUKU] =
    {
        ...
        ICON(Pyukumuku),
        FOOTPRINT(Pyukumuku)
        FOLLOWER(Pyukumuku, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Pyukumuku),
    },
    ...
    [SPECIES_TYPE_NULL] =
    {
        ...
        PALETTES(TypeNull),
        ICON(TypeNull),
        FOLLOWER(TypeNull, SHADOW_SIZE_M, TRACKS_FOOT)
        FOOTPRINT(Type_Null)
        LEARNSETS(TypeNull),
...
#define SILVALLY_SPECIES_INFO(type, palette)                                            \
    {                                                                                   \
        ...
        ICON(Silvally),                                                              \
        FOOTPRINT(Silvally)                                                             \
        FOLLOWER(Silvally, SHADOW_SIZE_M, TRACKS_FOOT)                      \
        LEARNSETS(Silvally),                                                            \
...
#define MINIOR_METEOR_SPECIES_INFO(Form)                                \
    {                                                                   \
        ...
        ICON(MiniorMeteor),                                          \
        FOLLOWER(MiniorMeteor, SHADOW_SIZE_M, TRACKS_FOOT)  \
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_KOMALA] =
    {
        ...
        ICON(Komala),
        FOOTPRINT(Komala)
        FOLLOWER(Komala, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Komala),
    },
    ...
    [SPECIES_TURTONATOR] =
    {
        ...
        FOLLOWER(Turtonator, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_TOGEDEMARU] =
    {
        ...
        FOLLOWER(Togedemaru, SHADOW_SIZE_M, TRACKS_FOOT)
...
#define MIMIKYU_MISC_INFO                                           \
    ...
    [SPECIES_MIMIKYU_DISGUISED] =
    {
        ...
        FOLLOWER(MimikyuDisguised, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_BRUXISH] =
    {
        ...
        ICON(Bruxish),
        FOOTPRINT(Bruxish)
        FOLLOWER(Bruxish, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Bruxish),
    },
    ...
    [SPECIES_DRAMPA] =
    {
        ...
        ICON(Drampa),
        FOOTPRINT(Drampa)
        FOLLOWER(Drampa, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Drampa),
    },
    ...
    [SPECIES_DHELMISE] =
    {
        ...
        ICON(Dhelmise, 1),
        FOOTPRINT(Dhelmise)
        FOLLOWER(Dhelmise, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Dhelmise),
    },
    ...
    [SPECIES_JANGMO_O] =
    {
        ...
        ICON(JangmoO),
        FOOTPRINT(JangmoO)
        FOLLOWER(JangmoO, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(JangmoO),
    ...
    [SPECIES_HAKAMO_O] =
    {
        ...
        ICON(HakamoO),
        FOOTPRINT(HakamoO)
        FOLLOWER(HakamoO, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(HakamoO),
    ...
    [SPECIES_KOMMO_O] =
    {
        ...
        ICON(KommoO),
        FOOTPRINT(KommoO)
        FOLLOWER(KommoO, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(KommoO),
    },
    ...
    [SPECIES_TAPU_KOKO] =
    {
        ...
        PALETTES(TapuKoko),
        ICON(TapuKoko),
        FOLLOWER(TapuKoko, SHADOW_SIZE_M, TRACKS_FOOT)
        FOOTPRINT(TapuKoko)
        LEARNSETS(TapuKoko),
    },
    ...
    [SPECIES_TAPU_LELE] =
    {
        ...
        PALETTES(TapuLele),
        ICON(TapuLele),
        FOLLOWER(TapuLele, SHADOW_SIZE_M, TRACKS_FOOT)
        FOOTPRINT(TapuLele)
        LEARNSETS(TapuLele),
    },
    ...
    [SPECIES_TAPU_BULU] =
    {
        ...
        PALETTES(TapuBulu),
        ICON(TapuBulu),
        FOLLOWER(TapuBulu, SHADOW_SIZE_M, TRACKS_FOOT)
        FOOTPRINT(TapuBulu)
        LEARNSETS(TapuBulu),
    },
    ...
    [SPECIES_TAPU_FINI] =
    {
        ...
        PALETTES(TapuFini),
        ICON(TapuFini),
        FOLLOWER(TapuFini, SHADOW_SIZE_M, TRACKS_FOOT)
        FOOTPRINT(TapuFini)
        LEARNSETS(TapuFini),
    },
    ...
    [SPECIES_NIHILEGO] =
    {
        ...
        ICON(Nihilego),
        FOOTPRINT(Nihilego)
        FOLLOWER(Nihilego, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Nihilego),
    },
    ...
    [SPECIES_BUZZWOLE] =
    {
        ...
        ICON(Buzzwole),
        FOOTPRINT(Buzzwole)
        FOLLOWER(Buzzwole, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Buzzwole),
    },
    ...
    [SPECIES_PHEROMOSA] =
    {
        ...
        ICON(Pheromosa),
        FOOTPRINT(Pheromosa)
        FOLLOWER(Pheromosa, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Pheromosa),
    },
    ...
    [SPECIES_XURKITREE] =
    {
        ...
        ICON(Xurkitree),
        FOOTPRINT(Xurkitree)
        FOLLOWER(Xurkitree, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Xurkitree),
    },
    ...
    [SPECIES_CELESTEELA] =
    {
        ...
        FOLLOWER(Celesteela, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_KARTANA] =
    {
        ...
        ICON(Kartana),
        FOOTPRINT(Kartana)
        FOLLOWER(Kartana, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Kartana),
    },
    ...
    [SPECIES_GUZZLORD] =
    {
        ...
        ICON(Guzzlord),
        FOOTPRINT(Guzzlord)
        FOLLOWER(Guzzlord, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Guzzlord),
    },
...
#define NECROZMA_MISC_INFO                                                              \
    ...
    [SPECIES_NECROZMA] =
    {
        ...
        PALETTES(Necrozma),
        ICON(Necrozma),
        FOLLOWER(Necrozma, SHADOW_SIZE_M, TRACKS_FOOT)
    },
    ...
    [SPECIES_NECROZMA_DUSK_MANE] =
    {
        ...
        FOLLOWER(NecrozmaDuskMane, SHADOW_SIZE_M, TRACKS_FOOT)
        .cannotBeTraded = TRUE,
    ...
    [SPECIES_NECROZMA_DAWN_WINGS] =
    {
        ...
        FOLLOWER(NecrozmaDawnWings, SHADOW_SIZE_M, TRACKS_FOOT)
        .cannotBeTraded = TRUE,
...
#define MAGEARNA_MISC_INFO(Form)                                                        \
    ...
    [SPECIES_MAGEARNA] =
    {
        ...
        .bodyColor = BODY_COLOR_GRAY,
        FOLLOWER(Magearna, SHADOW_SIZE_M, TRACKS_FOOT)
        .description = COMPOUND_STRING(
    ...
    [SPECIES_MARSHADOW] =
    {
        ...
        ICON(Marshadow),
        FOOTPRINT(Marshadow)
        FOLLOWER(Marshadow, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Marshadow),
        .isMythical = TRUE,
    },
    ...
    [SPECIES_POIPOLE] =
    {
        ...
        ICON(Poipole),
        FOOTPRINT(Poipole)
        FOLLOWER(Poipole, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Poipole),
    ...
    [SPECIES_NAGANADEL] =
    {
        ...
        ICON(Naganadel),
        FOOTPRINT(Naganadel)
        FOLLOWER(Naganadel, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Naganadel),
    },
    ...
    [SPECIES_STAKATAKA] =
    {
        ...
        ICON(Stakataka),
        FOOTPRINT(Stakataka)
        FOLLOWER(Stakataka, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Stakataka),
    },
    ...
    [SPECIES_BLACEPHALON] =
    {
        ...
        FOLLOWER(Blacephalon, SHADOW_SIZE_M, TRACKS_FOOT)
    ...
    [SPECIES_ZERAORA] =
    {
        ...
        ICON(Zeraora),
        FOOTPRINT(Zeraora)
        FOLLOWER(Zeraora, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Zeraora),
    },
    ...
    [SPECIES_MELTAN] =
    {
        ...
        ICON(Meltan),
        FOOTPRINT(Meltan)
        FOLLOWER(Meltan, SHADOW_SIZE_M, TRACKS_FOOT)
        LEARNSETS(Meltan),
    },
...
#define MELMETAL_MISC_INFO                                                              \
    ...
    [SPECIES_MELMETAL] =
    {
        ...
        PALETTES(Melmetal),
        ICON(Melmetal),
        FOLLOWER(Melmetal, SHADOW_SIZE_M, TRACKS_FOOT)
    },
