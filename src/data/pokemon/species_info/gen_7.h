...
#define DECIDUEYE_MISC_INFO                                     \
    ...
    [SPECIES_DECIDUEYE_HISUIAN] =
    {
        ...
        FOLLOWER(DecidueyeHisuian, TRACKS_FOOT)
    ...
    [SPECIES_TOUCANNON] =
    {
        ...
        ICON(Toucannon),
        FOOTPRINT(Toucannon)
        FOLLOWER(Toucannon, TRACKS_FOOT)
        LEARNSETS(Toucannon),
    },
    ...
    [SPECIES_CHARJABUG] =
    {
        ...
        ICON(Charjabug, 1),
        FOOTPRINT(Charjabug)
        FOLLOWER(Charjabug, TRACKS_FOOT)
        LEARNSETS(Charjabug),
    ...
    [SPECIES_CRABRAWLER] =
    {
        ...
        FOLLOWER(Crabrawler, TRACKS_FOOT)
    ...
    [SPECIES_CRABOMINABLE] =
    {
        ...
        FOLLOWER(Crabominable, TRACKS_FOOT)
...
#define ORICORIO_MISC_INFO                                      \
    ...
    [SPECIES_ORICORIO_BAILE] =
    {
        ...
        ICON(OricorioBaile),
        FOLLOWER(OricorioBaile, TRACKS_FOOT)
    },
...
#define WISHIWASHI_MISC_INFO                                    \
    ...
    [SPECIES_WISHIWASHI_SOLO] =
    {
        ...
        ICON(WishiwashiSolo),
        FOLLOWER(WishiwashiSolo, TRACKS_FOOT)
    },
    ...
    [SPECIES_ARAQUANID] =
    {
        ...
        ICON(Araquanid),
        FOOTPRINT(Araquanid)
        FOLLOWER(Araquanid, TRACKS_FOOT)
        LEARNSETS(Araquanid),
    },
    ...
    [SPECIES_SHIINOTIC] =
    {
        ...
        ICON(Shiinotic, 1),
        FOOTPRINT(Shiinotic)
        FOLLOWER(Shiinotic, TRACKS_FOOT)
        LEARNSETS(Shiinotic),
    },
    ...
    [SPECIES_BOUNSWEET] =
    {
        ...
        ICON(Bounsweet, 1),
        FOOTPRINT(Bounsweet)
        FOLLOWER(Bounsweet, TRACKS_FOOT)
        LEARNSETS(Bounsweet),
    ...
    [SPECIES_PASSIMIAN] =
    {
        ...
        ICON(Passimian, 1),
        FOOTPRINT(Passimian)
        FOLLOWER(Passimian, TRACKS_FOOT)
        LEARNSETS(Passimian),
    },
    ...
    [SPECIES_GOLISOPOD] =
    {
        ...
        ICON(Golisopod),
        FOOTPRINT(Golisopod)
        FOLLOWER(Golisopod, TRACKS_FOOT)
        LEARNSETS(Golisopod),
    },
    ...
    [SPECIES_PYUKUMUKU] =
    {
        ...
        ICON(Pyukumuku),
        FOOTPRINT(Pyukumuku)
        FOLLOWER(Pyukumuku, TRACKS_FOOT)
        LEARNSETS(Pyukumuku),
    },
...
#define MINIOR_METEOR_SPECIES_INFO(Form)                                \
    {                                                                   \
        ...
        ICON(MiniorMeteor),                                          \
        FOLLOWER(MiniorMeteor, TRACKS_FOOT)  \
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_TURTONATOR] =
    {
        ...
        FOLLOWER(Turtonator, TRACKS_FOOT)
    ...
    [SPECIES_TOGEDEMARU] =
    {
        ...
        FOLLOWER(Togedemaru, TRACKS_FOOT)
...
#define MIMIKYU_MISC_INFO                                           \
    ...
    [SPECIES_PHEROMOSA] =
    {
        ...
        ICON(Pheromosa),
        FOOTPRINT(Pheromosa)
        FOLLOWER(Pheromosa, TRACKS_FOOT)
        LEARNSETS(Pheromosa),
    },
    ...
    [SPECIES_XURKITREE] =
    {
        ...
        ICON(Xurkitree),
        FOOTPRINT(Xurkitree)
        FOLLOWER(Xurkitree, TRACKS_FOOT)
        LEARNSETS(Xurkitree),
    },
    ...
    [SPECIES_CELESTEELA] =
    {
        ...
        FOLLOWER(Celesteela, TRACKS_FOOT)
...
#define NECROZMA_MISC_INFO                                                              \
    ...
    [SPECIES_NECROZMA_DUSK_MANE] =
    {
        ...
        FOLLOWER(NecrozmaDuskMane, TRACKS_FOOT)
        .cannotBeTraded = TRUE,
    ...
    [SPECIES_NECROZMA_DAWN_WINGS] =
    {
        ...
        FOLLOWER(NecrozmaDawnWings, TRACKS_FOOT)
        .cannotBeTraded = TRUE,
...
#define MAGEARNA_MISC_INFO(Form)                                                        \
    ...
    [SPECIES_MARSHADOW] =
    {
        ...
        ICON(Marshadow),
        FOOTPRINT(Marshadow)
        FOLLOWER(Marshadow, TRACKS_FOOT)
        LEARNSETS(Marshadow),
        .isMythical = TRUE,
    },
    ...
    [SPECIES_NAGANADEL] =
    {
        ...
        ICON(Naganadel),
        FOOTPRINT(Naganadel)
        FOLLOWER(Naganadel, TRACKS_FOOT)
        LEARNSETS(Naganadel),
    },
    ...
    [SPECIES_STAKATAKA] =
    {
        ...
        ICON(Stakataka),
        FOOTPRINT(Stakataka)
        FOLLOWER(Stakataka, TRACKS_FOOT)
        LEARNSETS(Stakataka),
    },
    ...
    [SPECIES_BLACEPHALON] =
    {
        ...
        FOLLOWER(Blacephalon, TRACKS_FOOT)
