...
const u32 gObjectEventPic_MagikarpF[] = INCBIN_U32("graphics/pokemon/magikarp/followerf.4bpp");
...
const u32 gObjectEventPic_GyaradosF[] = INCBIN_U32("graphics/pokemon/gyarados/followerf.4bpp");
