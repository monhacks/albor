...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(ELITE_FOUR_GLACIA, EliteFourGlacia, -4, 4, 432),
    TRAINER_SPRITE(ELITE_FOUR_DRAKE, EliteFourDrake, 0, 5, 416),
    ...
    TRAINER_SPRITE(CHAMPION_WALLACE, ChampionWallace, -8, 7, 392),
    ...
    TRAINER_SPRITE(STEVEN, Steven, 0, 7, 392),
