...
const struct CompressedSpriteSheet gBattleAnimPicTable[] =
{
    ...
    {gBattleAnimSpriteGfx_Pencil, 512, ANIM_TAG_PENCIL},
    {gBattleAnimSpriteGfx_AirWave, 256, ANIM_TAG_AIR_WAVE},
    {gBattleAnimSpriteGfx_Orb, 512, ANIM_TAG_ORB},
#if B_NEW_SWORD_PARTICLE
    {gBattleAnimSpriteGfx_NewSword, 1024, ANIM_TAG_SWORD},
#else
    {gBattleAnimSpriteGfx_Sword, 1024, ANIM_TAG_SWORD},
#endif
#if B_NEW_LEECH_SEED_PARTICLE
    {gBattleAnimSpriteGfx_NewLeechSeed, 384, ANIM_TAG_SEED},
#else
    {gBattleAnimSpriteGfx_Seed, 384, ANIM_TAG_SEED},
#endif
    {gBattleAnimSpriteGfx_Explosion6, 2048, ANIM_TAG_EXPLOSION_6},
    {gBattleAnimSpriteGfx_PinkOrb, 32, ANIM_TAG_PINK_ORB},
    {gBattleAnimSpriteGfx_Gust, 1024, ANIM_TAG_GUST},
    {gBattleAnimSpriteGfx_IceCube, 4608, ANIM_TAG_ICE_CUBE},
    {gBattleAnimSpriteGfx_Spark2, 384, ANIM_TAG_SPARK_2},
    {gBattleAnimSpriteGfx_Orange, 128, ANIM_TAG_ORANGE},
    {gBattleAnimSpriteGfx_YellowBall, 128, ANIM_TAG_YELLOW_BALL},
    {gBattleAnimSpriteGfx_LockOn, 640, ANIM_TAG_LOCK_ON},
    {gBattleAnimSpriteGfx_TiedBag, 128, ANIM_TAG_TIED_BAG},
    {gBattleAnimSpriteGfx_BlackSmoke, 256, ANIM_TAG_BLACK_SMOKE},
    {gBattleAnimSpriteGfx_BlackBall, 32, ANIM_TAG_BLACK_BALL},
    {gBattleAnimSpriteGfx_Conversion, 128, ANIM_TAG_CONVERSION},
    {gBattleAnimSpriteGfx_Glass, 1024, ANIM_TAG_GLASS},
    {gBattleAnimSpriteGfx_HornHit, 512, ANIM_TAG_HORN_HIT},
    {gBattleAnimSpriteGfx_Hit, 2560, ANIM_TAG_HIT},
    {gBattleAnimSpriteGfx_Hit, 2560, ANIM_TAG_HIT_2},
    {gBattleAnimSpriteGfx_BlueShards, 896, ANIM_TAG_BLUE_SHARDS},
    {gBattleAnimSpriteGfx_ClosingEye, 768, ANIM_TAG_CLOSING_EYE},
    {gBattleAnimSpriteGfx_WavingHand, 2560, ANIM_TAG_WAVING_HAND},
    {gBattleAnimSpriteGfx_HitDuplicate, 2560, ANIM_TAG_HIT_DUPLICATE},
    {gBattleAnimSpriteGfx_Leer, 2560, ANIM_TAG_LEER},
    {gBattleAnimSpriteGfx_BlueBurst, 2560, ANIM_TAG_BLUE_BURST},
    {gBattleAnimSpriteGfx_NewEmbers, 2560, ANIM_TAG_SMALL_EMBER},
    {gBattleAnimSpriteGfx_GraySmoke, 2560, ANIM_TAG_GRAY_SMOKE},
    {gBattleAnimSpriteGfx_BlueStar, 3584, ANIM_TAG_BLUE_STAR},
    {gBattleAnimSpriteGfx_BubbleBurst, 896, ANIM_TAG_BUBBLE_BURST},
    {gBattleAnimSpriteGfx_Fire, 4096, ANIM_TAG_FIRE},
    {gBattleAnimSpriteGfx_SpinningFire, 2048, ANIM_TAG_SPINNING_FIRE},
    {gBattleAnimSpriteGfx_FirePlume, 2560, ANIM_TAG_FIRE_PLUME},
    {gBattleAnimSpriteGfx_Lightning2, 2048, ANIM_TAG_LIGHTNING_2},
    {gBattleAnimSpriteGfx_Lightning, 2560, ANIM_TAG_LIGHTNING},
    {gBattleAnimSpriteGfx_ClawSlash2, 2560, ANIM_TAG_CLAW_SLASH_2},
    {gBattleAnimSpriteGfx_ClawSlash, 2560, ANIM_TAG_CLAW_SLASH},
    {gBattleAnimSpriteGfx_Scratch3, 2560, ANIM_TAG_SCRATCH_3},
    {gBattleAnimSpriteGfx_Scratch2, 2560, ANIM_TAG_SCRATCH_2},
    {gBattleAnimSpriteGfx_BubbleBurst2, 2560, ANIM_TAG_BUBBLE_BURST_2},
    {gBattleAnimSpriteGfx_IceChunk, 2560, ANIM_TAG_ICE_CHUNK},
    {gBattleAnimSpriteGfx_Glass2, 2560, ANIM_TAG_GLASS_2},
    {gBattleAnimSpriteGfx_PinkHeart2, 2560, ANIM_TAG_PINK_HEART_2},
    {gBattleAnimSpriteGfx_SapDrip, 4096, ANIM_TAG_SAP_DRIP},
    {gBattleAnimSpriteGfx_SapDrip, 4096, ANIM_TAG_SAP_DRIP_2},
    {gBattleAnimSpriteGfx_Sparkle1, 4096, ANIM_TAG_SPARKLE_1},
    {gBattleAnimSpriteGfx_Sparkle1, 4096, ANIM_TAG_SPARKLE_2},
    {gBattleAnimSpriteGfx_HumanoidFoot, 512, ANIM_TAG_HUMANOID_FOOT},
    ...
    {gBattleAnimSpriteGfx_NewRocks, 3072, ANIM_TAG_ROCKS},
#else
    ...
    {gBattleAnimSpriteGfx_NewLeaf, 1152, ANIM_TAG_LEAF},
#else
    {gBattleAnimSpriteGfx_Leaf, 1152, ANIM_TAG_LEAF},
#endif
    {gBattleAnimSpriteGfx_Finger, 512, ANIM_TAG_FINGER},
    {gBattleAnimSpriteGfx_PoisonPowder, 512, ANIM_TAG_POISON_POWDER},
    {gBattleAnimSpriteGfx_BrownTriangle, 256, ANIM_TAG_BROWN_TRIANGLE},
    {gBattleAnimSpriteGfx_PoisonPowder, 512, ANIM_TAG_SLEEP_POWDER},
    {gBattleAnimSpriteGfx_PoisonPowder, 512, ANIM_TAG_STUN_SPORE},
    {gBattleAnimSpriteGfx_PoisonPowder, 512, ANIM_TAG_POWDER},
    {gBattleAnimSpriteGfx_Sparkle3, 512, ANIM_TAG_SPARKLE_3},
    {gBattleAnimSpriteGfx_Sparkle4, 2560, ANIM_TAG_SPARKLE_4},
    {gBattleAnimSpriteGfx_MusicNotes, 768, ANIM_TAG_MUSIC_NOTES},
    {gBattleAnimSpriteGfx_Duck, 384, ANIM_TAG_DUCK},
    {gBattleAnimSpriteGfx_MudSand, 160, ANIM_TAG_MUD_SAND},
    {gBattleAnimSpriteGfx_Alert, 1792, ANIM_TAG_ALERT},
    {gBattleAnimSpriteGfx_BlueFlames, 1024, ANIM_TAG_BLUE_FLAMES},
    {gBattleAnimSpriteGfx_BlueFlames2, 512, ANIM_TAG_BLUE_FLAMES_2},
    {gBattleAnimSpriteGfx_Shock4, 768, ANIM_TAG_SHOCK_4},
    {gBattleAnimSpriteGfx_Shock, 3072, ANIM_TAG_SHOCK},
    {gBattleAnimSpriteGfx_Bell2, 2560, ANIM_TAG_BELL_2},
    {gBattleAnimSpriteGfx_PinkGlove, 128, ANIM_TAG_PINK_GLOVE},
    {gBattleAnimSpriteGfx_BlueLines, 64, ANIM_TAG_BLUE_LINES},
    {gBattleAnimSpriteGfx_Impact3, 3584, ANIM_TAG_IMPACT_3},
    {gBattleAnimSpriteGfx_Impact2, 3584, ANIM_TAG_IMPACT_2},
    {gBattleAnimSpriteGfx_Reticle, 640, ANIM_TAG_RETICLE},
    {gBattleAnimSpriteGfx_Breath, 512, ANIM_TAG_BREATH},
    {gBattleAnimSpriteGfx_Anger, 128, ANIM_TAG_ANGER},
    {gBattleAnimSpriteGfx_Snowball, 192, ANIM_TAG_SNOWBALL},
    {gBattleAnimSpriteGfx_Vine, 2560, ANIM_TAG_VINE},
    {gBattleAnimSpriteGfx_Sword2, 512, ANIM_TAG_SWORD_2},
    {gBattleAnimSpriteGfx_Clapping, 384, ANIM_TAG_CLAPPING},
    {gBattleAnimSpriteGfx_RedTube, 128, ANIM_TAG_RED_TUBE},
    {gBattleAnimSpriteGfx_Amnesia, 4096, ANIM_TAG_AMNESIA},
    {gBattleAnimSpriteGfx_String2, 2560, ANIM_TAG_STRING_2},
    {gBattleAnimSpriteGfx_Pencil2, 384, ANIM_TAG_PENCIL_2},
    {gBattleAnimSpriteGfx_Petal, 896, ANIM_TAG_PETAL},
    {gBattleAnimSpriteGfx_BentSpoon, 3072, ANIM_TAG_BENT_SPOON},
    {gBattleAnimSpriteGfx_Web, 512, ANIM_TAG_WEB},
    {gBattleAnimSpriteGfx_MilkBottle, 512, ANIM_TAG_MILK_BOTTLE},
    {gBattleAnimSpriteGfx_Coin, 512, ANIM_TAG_COIN},
    {gBattleAnimSpriteGfx_CrackedEgg, 512, ANIM_TAG_CRACKED_EGG},
    {gBattleAnimSpriteGfx_HatchedEgg, 1024, ANIM_TAG_HATCHED_EGG},
    {gBattleAnimSpriteGfx_FreshEgg, 128, ANIM_TAG_FRESH_EGG},
    {gBattleAnimSpriteGfx_Fangs, 1024, ANIM_TAG_FANGS},
    {gBattleAnimSpriteGfx_Explosion2, 3072, ANIM_TAG_EXPLOSION_2},
    {gBattleAnimSpriteGfx_Explosion3, 512, ANIM_TAG_EXPLOSION_3},
    {gBattleAnimSpriteGfx_WaterDroplet, 4096, ANIM_TAG_WATER_DROPLET},
    {gBattleAnimSpriteGfx_WaterDroplet2, 2560, ANIM_TAG_WATER_DROPLET_2},
    {gBattleAnimSpriteGfx_Seed2, 32, ANIM_TAG_SEED_2},
    {gBattleAnimSpriteGfx_Sprout, 3584, ANIM_TAG_SPROUT},
    {gBattleAnimSpriteGfx_RedWand, 128, ANIM_TAG_RED_WAND},
    {gBattleAnimSpriteGfx_PurpleGreenUnk, 2560, ANIM_TAG_PURPLE_GREEN_UNK},
    {gBattleAnimSpriteGfx_WaterColumn, 1024, ANIM_TAG_WATER_COLUMN},
    {gBattleAnimSpriteGfx_MudUnk, 512, ANIM_TAG_MUD_UNK},
    {gBattleAnimSpriteGfx_RainDrops, 1792, ANIM_TAG_RAIN_DROPS},
    {gBattleAnimSpriteGfx_FurySwipes, 2048, ANIM_TAG_FURY_SWIPES},
    {gBattleAnimSpriteGfx_Vine2, 2560, ANIM_TAG_VINE_2},
    {gBattleAnimSpriteGfx_Teeth, 1536, ANIM_TAG_TEETH},
    {gBattleAnimSpriteGfx_Bone2, 2048, ANIM_TAG_BONE_2},
    {gBattleAnimSpriteGfx_WhiteBag, 512, ANIM_TAG_WHITE_BAG},
    {gBattleAnimSpriteGfx_WhiteBag, 512, ANIM_TAG_UNKNOWN},
    {gBattleAnimSpriteGfx_PurpleCoral, 384, ANIM_TAG_PURPLE_CORAL},
    {gBattleAnimSpriteGfx_PurpleDroplet, 1536, ANIM_TAG_PURPLE_DROPLET},
    {gBattleAnimSpriteGfx_Shock2, 1536, ANIM_TAG_SHOCK_2},
    {gBattleAnimSpriteGfx_ClosingEye2, 512, ANIM_TAG_CLOSING_EYE_2},
    {gBattleAnimSpriteGfx_MetalBall, 128, ANIM_TAG_METAL_BALL},
    {gBattleAnimSpriteGfx_MonsterDoll, 512, ANIM_TAG_MONSTER_DOLL},
    {gBattleAnimSpriteGfx_Whirlwind, 2048, ANIM_TAG_WHIRLWIND},
    {gBattleAnimSpriteGfx_Whirlwind2, 128, ANIM_TAG_WHIRLWIND_2},
    {gBattleAnimSpriteGfx_Explosion4, 2560, ANIM_TAG_EXPLOSION_4},
    {gBattleAnimSpriteGfx_Explosion5, 640, ANIM_TAG_EXPLOSION_5},
    {gBattleAnimSpriteGfx_Tongue, 640, ANIM_TAG_TONGUE},
    {gBattleAnimSpriteGfx_Smoke, 256, ANIM_TAG_SMOKE},
    {gBattleAnimSpriteGfx_Smoke2, 512, ANIM_TAG_SMOKE_2},
    {gBattleAnimSpriteGfx_Impact, 512, ANIM_TAG_IMPACT},
    {gBattleAnimSpriteGfx_CircleImpact, 32, ANIM_TAG_CIRCLE_IMPACT},
    {gBattleAnimSpriteGfx_Scratch, 2560, ANIM_TAG_SCRATCH},
    {gBattleAnimSpriteGfx_Cut, 2048, ANIM_TAG_CUT},
#if B_NEW_TEETH_PARTICLE
    {gBattleAnimSpriteGfx_NewTeeth, 2048, ANIM_TAG_SHARP_TEETH},
#else
    {gBattleAnimSpriteGfx_SharpTeeth, 2048, ANIM_TAG_SHARP_TEETH},
#endif
    {gBattleAnimSpriteGfx_RainbowRings, 192, ANIM_TAG_RAINBOW_RINGS},
    {gBattleAnimSpriteGfx_IceCrystals, 448, ANIM_TAG_ICE_CRYSTALS},
    {gBattleAnimSpriteGfx_IceSpikes, 256, ANIM_TAG_ICE_SPIKES},
#if B_NEW_HANDS_FEET_PARTICLE
    {gBattleAnimSpriteGfx_NewHandsAndFeet, 2048, ANIM_TAG_HANDS_AND_FEET},
#else
    {gBattleAnimSpriteGfx_HandsAndFeet, 2048, ANIM_TAG_HANDS_AND_FEET},
#endif
    {gBattleAnimSpriteGfx_MistCloud, 512, ANIM_TAG_MIST_CLOUD},
    {gBattleAnimSpriteGfx_Clamp, 2048, ANIM_TAG_CLAMP},
    {gBattleAnimSpriteGfx_Bubble, 384, ANIM_TAG_BUBBLE},
    {gBattleAnimSpriteGfx_Orbs, 384, ANIM_TAG_ORBS},
    {gBattleAnimSpriteGfx_WaterImpact, 512, ANIM_TAG_WATER_IMPACT},
    {gBattleAnimSpriteGfx_WaterOrb, 512, ANIM_TAG_WATER_ORB},
    {gBattleAnimSpriteGfx_PoisonBubble, 384, ANIM_TAG_POISON_BUBBLE},
    {gBattleAnimSpriteGfx_ToxicBubble, 1024, ANIM_TAG_TOXIC_BUBBLE},
#if B_NEW_SPIKES_PARTICLE
    {gBattleAnimSpriteGfx_NewSpikes, 128, ANIM_TAG_SPIKES},
#else
    {gBattleAnimSpriteGfx_Spikes, 128, ANIM_TAG_SPIKES},
#endif
    {gBattleAnimSpriteGfx_HornHit2, 256, ANIM_TAG_HORN_HIT_2},
    {gBattleAnimSpriteGfx_AirWave2, 256, ANIM_TAG_AIR_WAVE_2},
    {gBattleAnimSpriteGfx_SmallBubbles, 320, ANIM_TAG_SMALL_BUBBLES},
#if B_NEW_FLY_BUBBLE_PARTICLE
    {gBattleAnimSpriteGfx_NewFly, 2048, ANIM_TAG_ROUND_SHADOW},
#else
    {gBattleAnimSpriteGfx_RoundShadow, 2048, ANIM_TAG_ROUND_SHADOW},
#endif
    {gBattleAnimSpriteGfx_Sunlight, 512, ANIM_TAG_SUNLIGHT},
    {gBattleAnimSpriteGfx_Spore, 256, ANIM_TAG_SPORE},
    {gBattleAnimSpriteGfx_Flower, 160, ANIM_TAG_FLOWER},
    {gBattleAnimSpriteGfx_RazorLeaf, 256, ANIM_TAG_RAZOR_LEAF},
    {gBattleAnimSpriteGfx_Needle, 128, ANIM_TAG_NEEDLE},
    {gBattleAnimSpriteGfx_WhirlwindLines, 768, ANIM_TAG_WHIRLWIND_LINES},
    {gBattleAnimSpriteGfx_GoldRing, 256, ANIM_TAG_GOLD_RING},
    {gBattleAnimSpriteGfx_GoldRing, 256, ANIM_TAG_PURPLE_RING},
    {gBattleAnimSpriteGfx_GoldRing, 256, ANIM_TAG_BLUE_RING},
    {gBattleAnimSpriteGfx_GreenLightWall, 2048, ANIM_TAG_GREEN_LIGHT_WALL},
    {gBattleAnimSpriteGfx_GreenLightWall, 2048, ANIM_TAG_BLUE_LIGHT_WALL},
    {gBattleAnimSpriteGfx_GreenLightWall, 2048, ANIM_TAG_RED_LIGHT_WALL},
    {gBattleAnimSpriteGfx_GreenLightWall, 2048, ANIM_TAG_GRAY_LIGHT_WALL},
    {gBattleAnimSpriteGfx_GreenLightWall, 2048, ANIM_TAG_ORANGE_LIGHT_WALL},
    {gBattleAnimSpriteGfx_BlackBall2, 128, ANIM_TAG_BLACK_BALL_2},
    {gBattleAnimSpriteGfx_MistCloud, 512, ANIM_TAG_PURPLE_GAS_CLOUD},
    {gBattleAnimSpriteGfx_SparkH, 512, ANIM_TAG_SPARK_H},
    {gBattleAnimSpriteGfx_YellowStar, 512, ANIM_TAG_YELLOW_STAR},
    {gBattleAnimSpriteGfx_LargeFreshEgg, 128, ANIM_TAG_LARGE_FRESH_EGG},
    {gBattleAnimSpriteGfx_ShadowBall, 512, ANIM_TAG_SHADOW_BALL},
    {gBattleAnimSpriteGfx_Lick, 1280, ANIM_TAG_LICK},
    {gBattleAnimSpriteGfx_VoidLines, 2048, ANIM_TAG_VOID_LINES},
    {gBattleAnimSpriteGfx_String, 1024, ANIM_TAG_STRING},
    {gBattleAnimSpriteGfx_WebThread, 32, ANIM_TAG_WEB_THREAD},
    {gBattleAnimSpriteGfx_SpiderWeb, 2048, ANIM_TAG_SPIDER_WEB},
    {gBattleAnimSpriteGfx_Lightbulb, 256, ANIM_TAG_LIGHTBULB},
    {gBattleAnimSpriteGfx_Slash, 2048, ANIM_TAG_SLASH},
    {gBattleAnimSpriteGfx_FocusEnergy, 1024, ANIM_TAG_FOCUS_ENERGY},
    {gBattleAnimSpriteGfx_SphereToCube, 2560, ANIM_TAG_SPHERE_TO_CUBE},
    {gBattleAnimSpriteGfx_Tendrils, 4096, ANIM_TAG_TENDRILS},
#if B_NEW_MEAN_LOOK_PARTICLE
    {gBattleAnimSpriteGfx_NewEye, 2048, ANIM_TAG_EYE},
#else
    {gBattleAnimSpriteGfx_Eye, 2048, ANIM_TAG_EYE},
#endif
    {gBattleAnimSpriteGfx_WhiteShadow, 1024, ANIM_TAG_WHITE_SHADOW},
    {gBattleAnimSpriteGfx_TealAlert, 512, ANIM_TAG_TEAL_ALERT},
    {gBattleAnimSpriteGfx_OpeningEye, 2048, ANIM_TAG_OPENING_EYE},
    {gBattleAnimSpriteGfx_RoundWhiteHalo, 2048, ANIM_TAG_ROUND_WHITE_HALO},
    {gBattleAnimSpriteGfx_FangAttack, 2048, ANIM_TAG_FANG_ATTACK},
    {gBattleAnimSpriteGfx_PurpleHandOutline, 512, ANIM_TAG_PURPLE_HAND_OUTLINE},
    {gBattleAnimSpriteGfx_Moon, 2048, ANIM_TAG_MOON},
    {gBattleAnimSpriteGfx_GreenSparkle, 512, ANIM_TAG_GREEN_SPARKLE},
    {gBattleAnimSpriteGfx_Spiral, 2048, ANIM_TAG_SPIRAL},
    {gBattleAnimSpriteGfx_SnoreZ, 512, ANIM_TAG_SNORE_Z},
    {gBattleAnimSpriteGfx_Explosion, 2048, ANIM_TAG_EXPLOSION},
#if B_NEW_CURSE_NAIL_PARTICLE
    {gBattleAnimSpriteGfx_NewNail, 1024, ANIM_TAG_NAIL},
#else
    {gBattleAnimSpriteGfx_Nail, 1024, ANIM_TAG_NAIL},
#endif
    {gBattleAnimSpriteGfx_GhostlySpirit, 512, ANIM_TAG_GHOSTLY_SPIRIT},
    {gBattleAnimSpriteGfx_WarmRock, 2688, ANIM_TAG_WARM_ROCK},
    {gBattleAnimSpriteGfx_BreakingEgg, 1536, ANIM_TAG_BREAKING_EGG},
    {gBattleAnimSpriteGfx_ThinRing, 2048, ANIM_TAG_THIN_RING},
    {gBattleAnimSpriteGfx_PunchImpact, 512, ANIM_TAG_PUNCH_IMPACT},
    {gBattleAnimSpriteGfx_Bell, 1536, ANIM_TAG_BELL},
    {gBattleAnimSpriteGfx_MusicNotes2, 2048, ANIM_TAG_MUSIC_NOTES_2},
    {gBattleAnimSpriteGfx_SpeedDust, 384, ANIM_TAG_SPEED_DUST},
    {gBattleAnimSpriteGfx_TornMetal, 2048, ANIM_TAG_TORN_METAL},
    {gBattleAnimSpriteGfx_ThoughtBubble, 2048, ANIM_TAG_THOUGHT_BUBBLE},
    {gBattleAnimSpriteGfx_MagentaHeart, 128, ANIM_TAG_MAGENTA_HEART},
    {gBattleAnimSpriteGfx_ElectricOrbs, 128, ANIM_TAG_ELECTRIC_ORBS},
    {gBattleAnimSpriteGfx_CircleOfLight, 2048, ANIM_TAG_CIRCLE_OF_LIGHT},
    {gBattleAnimSpriteGfx_Electricity, 2048, ANIM_TAG_ELECTRICITY},
    {gBattleAnimSpriteGfx_Finger2, 1536, ANIM_TAG_FINGER_2},
    {gBattleAnimSpriteGfx_MovementWaves, 1536, ANIM_TAG_MOVEMENT_WAVES},
    {gBattleAnimSpriteGfx_MagentaHeart, 128, ANIM_TAG_RED_HEART},
    {gBattleAnimSpriteGfx_RedOrb, 128, ANIM_TAG_RED_ORB},
    {gBattleAnimSpriteGfx_EyeSparkle, 384, ANIM_TAG_EYE_SPARKLE},
    {gBattleAnimSpriteGfx_MagentaHeart, 128, ANIM_TAG_PINK_HEART},
    {gBattleAnimSpriteGfx_Angel, 512, ANIM_TAG_ANGEL},
    {gBattleAnimSpriteGfx_Devil, 1024, ANIM_TAG_DEVIL},
    {gBattleAnimSpriteGfx_Swipe, 2560, ANIM_TAG_SWIPE},
    {gBattleAnimSpriteGfx_Roots, 2048, ANIM_TAG_ROOTS},
    {gBattleAnimSpriteGfx_ItemBag, 512, ANIM_TAG_ITEM_BAG},
    {gBattleAnimSpriteGfx_JaggedMusicNote, 1024, ANIM_TAG_JAGGED_MUSIC_NOTE},
#if B_NEW_BATON_PASS_BALL_PARTICLE
    {gBattleAnimSpriteGfx_NewPokeball, 128, ANIM_TAG_POKEBALL},
#else
    {gBattleAnimSpriteGfx_Pokeball, 128, ANIM_TAG_POKEBALL},
#endif
    {gBattleAnimSpriteGfx_Spotlight, 2048, ANIM_TAG_SPOTLIGHT},
    {gBattleAnimSpriteGfx_LetterZ, 512, ANIM_TAG_LETTER_Z},
    {gBattleAnimSpriteGfx_RapidSpin, 768, ANIM_TAG_RAPID_SPIN},
    {gBattleAnimSpriteGfx_TriAttackTriangle, 2048, ANIM_TAG_TRI_ATTACK_TRIANGLE},
    {gBattleAnimSpriteGfx_WispOrb, 896, ANIM_TAG_WISP_ORB},
    {gBattleAnimSpriteGfx_WispFire, 2048, ANIM_TAG_WISP_FIRE},
    {gBattleAnimSpriteGfx_GoldStars, 192, ANIM_TAG_GOLD_STARS},
    {gBattleAnimSpriteGfx_EclipsingOrb, 2048, ANIM_TAG_ECLIPSING_ORB},
    {gBattleAnimSpriteGfx_GrayOrb, 96, ANIM_TAG_GRAY_ORB},
    {gBattleAnimSpriteGfx_GrayOrb, 96, ANIM_TAG_BLUE_ORB},
    {gBattleAnimSpriteGfx_GrayOrb, 96, ANIM_TAG_RED_ORB_2},
    {gBattleAnimSpriteGfx_PinkPetal, 128, ANIM_TAG_PINK_PETAL},
    {gBattleAnimSpriteGfx_PainSplit, 384, ANIM_TAG_PAIN_SPLIT},
    {gBattleAnimSpriteGfx_Confetti, 384, ANIM_TAG_CONFETTI},
#if B_NEW_MORNING_SUN_STAR_PARTICLE
    {gBattleAnimSpriteGfx_NewGreenStar, 512, ANIM_TAG_GREEN_STAR},
#else
    {gBattleAnimSpriteGfx_GreenStar, 512, ANIM_TAG_GREEN_STAR},
#endif
    {gBattleAnimSpriteGfx_PinkCloud, 512, ANIM_TAG_PINK_CLOUD},
    {gBattleAnimSpriteGfx_SweatDrop, 32, ANIM_TAG_SWEAT_DROP},
    {gBattleAnimSpriteGfx_GuardRing, 1024, ANIM_TAG_GUARD_RING},
    {gBattleAnimSpriteGfx_PurpleScratch, 1536, ANIM_TAG_PURPLE_SCRATCH},
    {gBattleAnimSpriteGfx_PurpleSwipe, 4096, ANIM_TAG_PURPLE_SWIPE},
    {gBattleAnimSpriteGfx_TagHand, 1024, ANIM_TAG_TAG_HAND},
    {gBattleAnimSpriteGfx_SmallRedEye, 32, ANIM_TAG_SMALL_RED_EYE},
    {gBattleAnimSpriteGfx_HollowOrb, 128, ANIM_TAG_HOLLOW_ORB},
    {gBattleAnimSpriteGfx_XSign, 2048, ANIM_TAG_X_SIGN},
    {gBattleAnimSpriteGfx_BluegreenOrb, 128, ANIM_TAG_BLUEGREEN_ORB},
    {gBattleAnimSpriteGfx_PawPrint, 512, ANIM_TAG_PAW_PRINT},
    {gBattleAnimSpriteGfx_PurpleFlame, 1024, ANIM_TAG_PURPLE_FLAME},
    {gBattleAnimSpriteGfx_RedBall, 512, ANIM_TAG_RED_BALL},
    {gBattleAnimSpriteGfx_SmellingsaltEffect, 512, ANIM_TAG_SMELLINGSALT_EFFECT},
    {gBattleAnimSpriteGfx_Meteor, 2048, ANIM_TAG_METEOR},
    {gBattleAnimSpriteGfx_FlatRock, 640, ANIM_TAG_FLAT_ROCK},
    {gBattleAnimSpriteGfx_MagnifyingGlass, 512, ANIM_TAG_MAGNIFYING_GLASS},
    {gBattleAnimSpriteGfx_WaterOrb, 512, ANIM_TAG_BROWN_ORB},
    {gBattleAnimSpriteGfx_MetalSoundWaves, 1024, ANIM_TAG_METAL_SOUND_WAVES},
    {gBattleAnimSpriteGfx_FlyingDirt, 512, ANIM_TAG_FLYING_DIRT},
    {gBattleAnimSpriteGfx_IcicleSpear, 512, ANIM_TAG_ICICLE_SPEAR},
    {gBattleAnimSpriteGfx_Hail, 128, ANIM_TAG_HAIL},
    {gBattleAnimSpriteGfx_GlowyRedOrb, 32, ANIM_TAG_GLOWY_RED_ORB},
    {gBattleAnimSpriteGfx_GlowyRedOrb, 32, ANIM_TAG_GLOWY_GREEN_ORB},
    {gBattleAnimSpriteGfx_GreenSpike, 128, ANIM_TAG_GREEN_SPIKE},
    {gBattleAnimSpriteGfx_CircleOfLight, 2048, ANIM_TAG_WHITE_CIRCLE_OF_LIGHT},
    {gBattleAnimSpriteGfx_GlowyRedOrb, 32, ANIM_TAG_GLOWY_BLUE_ORB},
    {gBattleAnimSpriteGfx_Pokeblock, 128, ANIM_TAG_POKEBLOCK},
    {gBattleAnimSpriteGfx_WhiteFeather, 1024, ANIM_TAG_WHITE_FEATHER},
    {gBattleAnimSpriteGfx_Sparkle6, 128, ANIM_TAG_SPARKLE_6},
    {gBattleAnimSpriteGfx_Splash, 2048, ANIM_TAG_SPLASH},
    {gBattleAnimSpriteGfx_SweatBead, 32, ANIM_TAG_SWEAT_BEAD},
    {gBattleAnimSpriteGfx_Gem1, 2048, ANIM_TAG_GEM_1},
    {gBattleAnimSpriteGfx_Gem2, 2048, ANIM_TAG_GEM_2},
    {gBattleAnimSpriteGfx_Gem3, 2048, ANIM_TAG_GEM_3},
    {gBattleAnimSpriteGfx_SlamHit2, 4096, ANIM_TAG_SLAM_HIT_2},
    {gBattleAnimSpriteGfx_Recycle, 2048, ANIM_TAG_RECYCLE},
    {gBattleAnimSpriteGfx_RedParticles, 160, ANIM_TAG_RED_PARTICLES},
    {gBattleAnimSpriteGfx_Protect, 2048, ANIM_TAG_PROTECT},
    {gBattleAnimSpriteGfx_DirtMound, 512, ANIM_TAG_DIRT_MOUND},
    {gBattleAnimSpriteGfx_Shock3, 1536, ANIM_TAG_SHOCK_3},
    {gBattleAnimSpriteGfx_WeatherBall, 512, ANIM_TAG_WEATHER_BALL},
    {gBattleAnimSpriteGfx_Bird, 2048, ANIM_TAG_BIRD},
    {gBattleAnimSpriteGfx_CrossImpact, 512, ANIM_TAG_CROSS_IMPACT},
    {gBattleAnimSpriteGfx_Slash, 2048, ANIM_TAG_SLASH_2},
    {gBattleAnimSpriteGfx_SlamHit, 4096, ANIM_TAG_WHIP_HIT},
    {gBattleAnimSpriteGfx_GoldRing, 256, ANIM_TAG_BLUE_RING_2},
    {gBattleAnimSpriteGfx_WhiteStreak, 512, ANIM_TAG_WHITE_STREAK},
    {gBattleAnimSpriteGfx_PurpleJab, 256, ANIM_TAG_PURPLE_JAB},
    {gBattleAnimSpriteGfx_Spikes, 128, ANIM_TAG_TOXIC_SPIKES},
    {gBattleAnimSpriteGfx_EnergyBall, 512, ANIM_TAG_ENERGY_BALL},
    {gBattleAnimSpriteGfx_SeedBrown, 128, ANIM_TAG_SEED_BROWN},
    {gBattleAnimSpriteGfx_Feint, 2048, ANIM_TAG_FEINT},
    {gBattleAnimSpriteGfx_MegaStone, 2048, ANIM_TAG_MEGA_STONE},
    {gBattleAnimSpriteGfx_MegaSymbol, 512, ANIM_TAG_MEGA_SYMBOL},
    {gBattleAnimSpriteGfx_MegaParticles, 384, ANIM_TAG_MEGA_PARTICLES},
    {gBattleAnimSpriteGfx_TrumpCard, 384, ANIM_TAG_TRUMP_CARD},
    {gBattleAnimSpriteGfx_TrumpCardParticles, 96, ANIM_TAG_TRUMP_CARD_PARTICLES},
    {gBattleAnimSpriteGfx_Acupressure, 512, ANIM_TAG_ACUPRESSURE},
    {gBattleAnimSpriteGfx_WringOut, 512, ANIM_TAG_WRING_OUT},
    {gBattleAnimSpriteGfx_ColoredOrbs, 768, ANIM_TAG_COLORED_ORBS},
    {gBattleAnimSpriteGfx_WorrySeed, 128, ANIM_TAG_WORRY_SEED},
    {gBattleAnimSpriteGfx_SmallCloud, 128, ANIM_TAG_SMALL_CLOUD},
    {gBattleAnimSpriteGfx_AttackOrder, 1152, ANIM_TAG_ATTACK_ORDER},
    {gBattleAnimSpriteGfx_DragonPulse, 256, ANIM_TAG_DRAGON_PULSE},
    {gBattleAnimSpriteGfx_WoodHammer, 3072, ANIM_TAG_WOOD_HAMMER},
    {gBattleAnimSpriteGfx_PsychoCut, 512, ANIM_TAG_PSYCHO_CUT},
    {gBattleAnimSpriteGfx_PowerGem, 128, ANIM_TAG_POWER_GEM},
    {gBattleAnimSpriteGfx_StoneEdge, 2560, ANIM_TAG_STONE_EDGE},
    {gBattleAnimSpriteGfx_StealthRock, 128, ANIM_TAG_STEALTH_ROCK},
    {gBattleAnimSpriteGfx_PoisonJab, 128, ANIM_TAG_POISON_JAB},
    {gBattleAnimSpriteGfx_PoisonBubble, 384, ANIM_TAG_GREEN_POISON_BUBBLE},
    {gBattleAnimSpriteGfx_FlashCannonBall, 512, ANIM_TAG_FLASH_CANNON_BALL},
    {gBattleAnimSpriteGfx_WaterGun, 384, ANIM_TAG_WATER_GUN},
    {gBattleAnimSpriteGfx_Punishment, 2560, ANIM_TAG_PUNISHMENT_BLADES},
    {gBattleAnimSpriteGfx_QuickGuard, 512, ANIM_TAG_QUICK_GUARD_HAND},
    {gBattleAnimSpriteGfx_ShellRight, 2048, ANIM_TAG_SHELL_RIGHT},
    {gBattleAnimSpriteGfx_ShellLeft, 2048, ANIM_TAG_SHELL_LEFT},
    {gBattleAnimSpriteGfx_RazorShell, 512, ANIM_TAG_RAZOR_SHELL},
    {gBattleAnimSpriteGfx_HydroPump, 512, ANIM_TAG_HYDRO_PUMP},
    {gBattleAnimSpriteGfx_Brine, 3072, ANIM_TAG_BRINE},
    {gBattleAnimSpriteGfx_Gear, 512, ANIM_TAG_GEAR},
    {gBattleAnimSpriteGfx_AssuranceHand, 512, ANIM_TAG_ASSURANCE_HAND},
    {gBattleAnimSpriteGfx_Fishies, 1152, ANIM_TAG_WISHIWASHI_FISH},
    {gBattleAnimSpriteGfx_ZygardeHexes, 1152, ANIM_TAG_ZYGARDE_HEXES},
    {gBattleAnimSpriteGfx_AuraSphere, 512, ANIM_TAG_AURA_SPHERE},
    {gBattleAnimSpriteGfx_OmegaStone, 2048, ANIM_TAG_OMEGA_STONE},
    {gBattleAnimSpriteGfx_AlphaStone, 2048, ANIM_TAG_ALPHA_STONE},
    {gBattleAnimSpriteGfx_BerryNormal, 1024, ANIM_TAG_BERRY_NORMAL},
    {gBattleAnimSpriteGfx_BerryEaten, 512, ANIM_TAG_BERRY_EATEN},
    {gBattleAnimSpriteGfx_PurpleDrake, 2048, ANIM_TAG_DRAGON_ASCENT},
    {gBattleAnimSpriteGfx_PinkDiamond, 64, ANIM_TAG_PINK_DIAMOND},
    {gBattleAnimSpriteGfx_SteamEruption, 2560, ANIM_TAG_STEAM_ERUPTION},
    ...
    {gBattleAnimSpriteGfx_HorseshoeFist, 2048, ANIM_TAG_HORSESHOE_SIDE_FIST},
    {gBattleAnimSpriteGfx_PurpleDrake, 2048, ANIM_TAG_DRAGON_ASCENT_FOE},
    {gBattleAnimSpriteGfx_CraftyShield, 128, ANIM_TAG_CRAFTY_SHIELD},
    {gBattleAnimSpriteGfx_BlacephalonHead, 512, ANIM_TAG_BLACEPHALON_HEAD},
    {gBattleAnimSpriteGfx_FairyLockChains, 1024, ANIM_TAG_FAIRY_LOCK_CHAINS},
    {gBattleAnimSpriteGfx_LightningRain, 1792, ANIM_TAG_IONS},
    {gBattleAnimSpriteGfx_Chop, 512, ANIM_TAG_CHOP},
    {gBattleAnimSpriteGfx_HeartStamp, 1024, ANIM_TAG_HEART_STAMP},
    {gBattleAnimSpriteGfx_HornLeech, 512, ANIM_TAG_HORN_LEECH},
    {gBattleAnimSpriteGfx_Steamroller, 2048, ANIM_TAG_STEAMROLLER},
    {gBattleAnimSpriteGfx_HoopaHand, 128, ANIM_TAG_HOOPA_HAND},
    {gBattleAnimSpriteGfx_HoopaRing, 512, ANIM_TAG_HOOPA_RING},
    {gBattleAnimSpriteGfx_MetalBits, 320, ANIM_TAG_METAL_BITS},
    {gBattleAnimSpriteGfx_RocksSmall, 320, ANIM_TAG_SMALL_ROCK},
    {gBattleAnimSpriteGfx_SpiritShackleArrow, 512, ANIM_TAG_SPIRIT_ARROW},
    {gBattleAnimSpriteGfx_NecrozmaStar, 512, ANIM_TAG_ULTRA_BURST_SYMBOL},
    {gBattleAnimSpriteGfx_ZMoveSymbol, 2048, ANIM_TAG_Z_MOVE_SYMBOL},
    {gBattleAnimSpriteGfx_BigRock, 2048, ANIM_TAG_REALLY_BIG_ROCK},
    {gBattleAnimSpriteGfx_Cacoon, 2048, ANIM_TAG_COCOON},
    {gBattleAnimSpriteGfx_Drill, 2048, ANIM_TAG_CORKSCREW},
    {gBattleAnimSpriteGfx_GigavoltHavocSpear, 2048, ANIM_TAG_HAVOC_SPEAR},
    {gBattleAnimSpriteGfx_PurpleDrake, 2048, ANIM_TAG_PURPLE_DRAKE},
    {gBattleAnimSpriteGfx_MudBomb, 2048, ANIM_TAG_MUD_BOMB},
    {gBattleAnimSpriteGfx_Branch, 512, ANIM_TAG_BRANCH},
    {gBattleAnimSpriteGfx_Apple, 512, ANIM_TAG_APPLE},
    {gBattleAnimSpriteGfx_Obstruct, 512, ANIM_TAG_OBSTRUCT_CROSS},
    {gBattleAnimSpriteGfx_PoisonColumn, 8192, ANIM_TAG_POISON_COLUMN},
    {gBattleAnimSpriteGfx_PoisonColumn, 8192, ANIM_TAG_GARBAGE_COLUMN},
    {gBattleAnimSpriteGfx_LargeSpike, 4096, ANIM_TAG_LARGE_SPIKE},
    {gBattleAnimSpriteGfx_DragonPulseRing, 512, ANIM_TAG_DRAGON_PULSE_RING},
    {gBattleAnimSpriteGfx_StonePillar, 8192, ANIM_TAG_STONE_PILLAR},
    {gBattleAnimSpriteGfx_Mushroom, 2048, ANIM_TAG_MUSHROOM},
    {gBattleAnimSpriteGfx_GoldenApple, 2048, ANIM_TAG_GOLDEN_APPLE},
    {gBattleAnimSpriteGfx_IceRock, 10240, ANIM_TAG_ICE_ROCK},
    {gBattleAnimSpriteGfx_Tornado, 6144, ANIM_TAG_TORNADO},
    {gBattleAnimSpriteGfx_StraightBeam, 384, ANIM_TAG_STRAIGHT_BEAM},
    {gBattleAnimSpriteGfx_DreepyMissile, 512, ANIM_TAG_DREEPY},
    {gBattleAnimSpriteGfx_IceRock, 6144, ANIM_TAG_ICE_ROCK_SINGLE},
    {gBattleAnimSpriteGfx_StonePillar, 6144, ANIM_TAG_STONE_PILLAR_MULTI},
    {gBattleAnimSpriteGfx_AlphaSymbol, 512, ANIM_TAG_ALPHA_SYMBOL},
    {gBattleAnimSpriteGfx_OmegaSymbol, 512, ANIM_TAG_OMEGA_SYMBOL},
    {gBattleAnimSpriteGfx_Orbs, 384, ANIM_TAG_STEEL_BEAM},
    {gBattleAnimSpriteGfx_AuraSphere, 512, ANIM_TAG_POLTERGEIST},
    {gBattleAnimSpriteGfx_Teapot, 6144, ANIM_TAG_TEAPOT},
    {gBattleAnimSpriteGfx_WoodHammerHammer, 2048, ANIM_TAG_WOOD_HAMMER_HAMMER},
    {gBattleAnimSpriteGfx_Snowflakes, 1792, ANIM_TAG_SNOWFLAKES},
    {gBattleAnimSpriteGfx_SyrupBlob, 1024, ANIM_TAG_SYRUP_BLOB_RED},
    {gBattleAnimSpriteGfx_SyrupShell, 8192, ANIM_TAG_SYRUP_SHELL_RED},
    {gBattleAnimSpriteGfx_SyrupBlob, 1024, ANIM_TAG_SYRUP_BLOB_YELLOW},
    {gBattleAnimSpriteGfx_SyrupShell, 8192, ANIM_TAG_SYRUP_SHELL_YELLOW},
    {gBattleAnimSpriteGfx_SyrupSplat, 1024, ANIM_TAG_SYRUP_SPLAT_RED},
    {gBattleAnimSpriteGfx_SyrupSplat, 1024, ANIM_TAG_SYRUP_SPLAT_YELLOW},
    {gBattleAnimSpriteGfx_TeraCrystal, 2048, ANIM_TAG_TERA_CRYSTAL},
    {gBattleAnimSpriteGfx_TeraShatter, 384, ANIM_TAG_TERA_SHATTER},
    {gBattleAnimSpriteGfx_DreepyMissile, 512, ANIM_TAG_DREEPY_SHINY},
    {gBattleAnimSpriteGfx_EmboarCarga, 2048, ANIM_TAG_EMBOAR},
    {gBattleAnimSpriteGfx_BloodMoon, 2048, ANIM_TAG_BLOOD_MOON},
    {gBattleAnimSpriteGfx_RedExplosion, 2048, ANIM_TAG_RED_EXPLOSION},
    {gBattleAnimSpriteGfx_Beam, 2048, ANIM_TAG_BEAM},
    {gBattleAnimSpriteGfx_PurpleChain, 4096, ANIM_TAG_PURPLE_CHAIN},
    {gBattleAnimSpriteGfx_PinkVioletOrb, 128, ANIM_TAG_PINKVIO_ORB},
};
...
const struct CompressedSpritePalette gBattleAnimPaletteTable[] =
{
    ...
    {gBattleAnimSpritePal_WhiteBag, ANIM_TAG_UNKNOWN},
    ...
    {gBattleAnimSpritePal_Emboar, ANIM_TAG_EMBOAR},
