...
const u8 gBerryTreePaletteTagTable[] = {
    [ITEM_CHERI_BERRY - FIRST_BERRY_INDEX]              = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_CHESTO_BERRY - FIRST_BERRY_INDEX]             = 0, //OBJ_EVENT_PAL_TAG_NPC_1
    [ITEM_PECHA_BERRY - FIRST_BERRY_INDEX]              = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_RAWST_BERRY - FIRST_BERRY_INDEX]              = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_ASPEAR_BERRY - FIRST_BERRY_INDEX]             = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_LEPPA_BERRY - FIRST_BERRY_INDEX]              = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_ORAN_BERRY - FIRST_BERRY_INDEX]               = 0, //OBJ_EVENT_PAL_TAG_NPC_1
    [ITEM_PERSIM_BERRY - FIRST_BERRY_INDEX]             = 0, //OBJ_EVENT_PAL_TAG_NPC_1
    [ITEM_LUM_BERRY - FIRST_BERRY_INDEX]                = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_SITRUS_BERRY - FIRST_BERRY_INDEX]             = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_FIGY_BERRY - FIRST_BERRY_INDEX]               = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_WIKI_BERRY - FIRST_BERRY_INDEX]               = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_MAGO_BERRY - FIRST_BERRY_INDEX]               = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_AGUAV_BERRY - FIRST_BERRY_INDEX]              = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_IAPAPA_BERRY - FIRST_BERRY_INDEX]             = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_RAZZ_BERRY - FIRST_BERRY_INDEX]               = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_BLUK_BERRY - FIRST_BERRY_INDEX]               = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_NANAB_BERRY - FIRST_BERRY_INDEX]              = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_WEPEAR_BERRY - FIRST_BERRY_INDEX]             = 0, //OBJ_EVENT_PAL_TAG_NPC_1
    [ITEM_PINAP_BERRY - FIRST_BERRY_INDEX]              = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_POMEG_BERRY - FIRST_BERRY_INDEX]              = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_KELPSY_BERRY - FIRST_BERRY_INDEX]             = 0, //OBJ_EVENT_PAL_TAG_NPC_1
    [ITEM_QUALOT_BERRY - FIRST_BERRY_INDEX]             = 0, //OBJ_EVENT_PAL_TAG_NPC_1
    [ITEM_HONDEW_BERRY - FIRST_BERRY_INDEX]             = 3, //OBJ_EVENT_PAL_TAG_NPC_4
    [ITEM_GREPA_BERRY - FIRST_BERRY_INDEX]              = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_TAMATO_BERRY - FIRST_BERRY_INDEX]             = 0, //OBJ_EVENT_PAL_TAG_NPC_1
    [ITEM_CORNN_BERRY - FIRST_BERRY_INDEX]              = 0, //OBJ_EVENT_PAL_TAG_NPC_1
    [ITEM_MAGOST_BERRY - FIRST_BERRY_INDEX]             = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_RABUTA_BERRY - FIRST_BERRY_INDEX]             = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_NOMEL_BERRY - FIRST_BERRY_INDEX]              = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_SPELON_BERRY - FIRST_BERRY_INDEX]             = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_PAMTRE_BERRY - FIRST_BERRY_INDEX]             = 0, //OBJ_EVENT_PAL_TAG_NPC_1
    [ITEM_WATMEL_BERRY - FIRST_BERRY_INDEX]             = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_DURIN_BERRY - FIRST_BERRY_INDEX]              = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_BELUE_BERRY - FIRST_BERRY_INDEX]              = 3, //OBJ_EVENT_PAL_TAG_NPC_4
    [ITEM_CHILAN_BERRY - FIRST_BERRY_INDEX]             = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_OCCA_BERRY - FIRST_BERRY_INDEX]               = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_PASSHO_BERRY - FIRST_BERRY_INDEX]             = 0, //OBJ_EVENT_PAL_TAG_NPC_1
    [ITEM_WACAN_BERRY - FIRST_BERRY_INDEX]              = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_RINDO_BERRY - FIRST_BERRY_INDEX]              = 0, //OBJ_EVENT_PAL_TAG_NPC_1
    [ITEM_YACHE_BERRY - FIRST_BERRY_INDEX]              = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_CHOPLE_BERRY - FIRST_BERRY_INDEX]             = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_KEBIA_BERRY - FIRST_BERRY_INDEX]              = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_SHUCA_BERRY - FIRST_BERRY_INDEX]              = 3, //OBJ_EVENT_PAL_TAG_NPC_4
    [ITEM_COBA_BERRY - FIRST_BERRY_INDEX]               = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_PAYAPA_BERRY - FIRST_BERRY_INDEX]             = 3, //OBJ_EVENT_PAL_TAG_NPC_4
    [ITEM_TANGA_BERRY - FIRST_BERRY_INDEX]              = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_CHARTI_BERRY - FIRST_BERRY_INDEX]             = 0, //OBJ_EVENT_PAL_TAG_NPC_1
    [ITEM_KASIB_BERRY - FIRST_BERRY_INDEX]              = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_HABAN_BERRY - FIRST_BERRY_INDEX]              = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_COLBUR_BERRY - FIRST_BERRY_INDEX]             = 3, //OBJ_EVENT_PAL_TAG_NPC_4
    [ITEM_BABIRI_BERRY - FIRST_BERRY_INDEX]             = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_ROSELI_BERRY - FIRST_BERRY_INDEX]             = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_LIECHI_BERRY - FIRST_BERRY_INDEX]             = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_GANLON_BERRY - FIRST_BERRY_INDEX]             = 3, //OBJ_EVENT_PAL_TAG_NPC_4
    [ITEM_SALAC_BERRY - FIRST_BERRY_INDEX]              = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_PETAYA_BERRY - FIRST_BERRY_INDEX]             = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_APICOT_BERRY - FIRST_BERRY_INDEX]             = 1, //OBJ_EVENT_PAL_TAG_NPC_2
    [ITEM_LANSAT_BERRY - FIRST_BERRY_INDEX]             = 0, //OBJ_EVENT_PAL_TAG_NPC_1
    [ITEM_STARF_BERRY - FIRST_BERRY_INDEX]              = 0, //OBJ_EVENT_PAL_TAG_NPC_1
    [ITEM_ENIGMA_BERRY - FIRST_BERRY_INDEX]             = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_MICLE_BERRY - FIRST_BERRY_INDEX]              = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_CUSTAP_BERRY - FIRST_BERRY_INDEX]             = 3, //OBJ_EVENT_PAL_TAG_NPC_4
    [ITEM_JABOCA_BERRY - FIRST_BERRY_INDEX]             = 3, //OBJ_EVENT_PAL_TAG_NPC_4
    [ITEM_ROWAP_BERRY - FIRST_BERRY_INDEX]              = 3, //OBJ_EVENT_PAL_TAG_NPC_4
    [ITEM_KEE_BERRY - FIRST_BERRY_INDEX]                = 2, //OBJ_EVENT_PAL_TAG_NPC_3
    [ITEM_MARANGA_BERRY - FIRST_BERRY_INDEX]            = 2, //OBJ_EVENT_PAL_TAG_NPC_3
};
