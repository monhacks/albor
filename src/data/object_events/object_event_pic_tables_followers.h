...
const struct SpriteFrameImage sPicTable_PikachuF[] = {
...
const struct SpriteFrameImage sPicTable_RaichuF[] = {
...
const struct SpriteFrameImage sPicTable_ZubatF[] = {
...
const struct SpriteFrameImage sPicTable_GolbatF[] = {
...
static const struct SpriteFrameImage sPicTable_ShellosWest[] = {
    overworld_ascending_frames(gObjectEventPic_ShellosWest, 4, 4),
};
static const struct SpriteFrameImage sPicTable_ShellosEast[] = {
    overworld_ascending_frames(gObjectEventPic_ShellosEast, 4, 4),
};
static const struct SpriteFrameImage sPicTable_GastrodonWest[] = {
    overworld_ascending_frames(gObjectEventPic_GastrodonWest, 4, 4),
};
