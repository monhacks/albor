...
static const union AnimCmd sAnim_FaceNorthFollower[] =
{
    ANIMCMD_FRAME(3, 16),
    ANIMCMD_JUMP(0),
};

static const union AnimCmd sAnim_FaceWestFollower[] =
{
    ANIMCMD_FRAME(5, 16),
    ANIMCMD_JUMP(0),
};

static const union AnimCmd sAnim_FaceEastFollower[] =
{
    ANIMCMD_FRAME(5, 16, .hFlip = TRUE),
    ANIMCMD_JUMP(0),
};

static const union AnimCmd sAnim_FaceEastFollowerAsym[] =
{
    ANIMCMD_FRAME(7, 16),
    ANIMCMD_JUMP(0),
};

static const union AnimCmd sAnim_GoSouthFollower[] =
{
    ANIMCMD_FRAME(1, 6),
    ANIMCMD_FRAME(2, 6),
    ANIMCMD_FRAME(2, 6),
...
static const union AnimCmd sAnim_GoNorthFollower[] =
{
    ANIMCMD_FRAME(3, 6),
    ANIMCMD_FRAME(4, 6),
    ANIMCMD_FRAME(4, 6),
...
static const union AnimCmd sAnim_GoWestFollower[] =
{
    ANIMCMD_FRAME(5, 6),
    ANIMCMD_FRAME(6, 6),
    ANIMCMD_FRAME(6, 6),
...
static const union AnimCmd sAnim_GoEastFollower[] =
{
    ANIMCMD_FRAME(5, 6, .hFlip = TRUE),
    ANIMCMD_FRAME(6, 6, .hFlip = TRUE),
    ANIMCMD_FRAME(6, 6, .hFlip = TRUE),
    ANIMCMD_FRAME(5, 6, .hFlip = TRUE),
    ANIMCMD_JUMP(0),
};

static const union AnimCmd sAnim_GoEastFollowerAsym[] =
{
    ANIMCMD_FRAME(7, 6),
    ANIMCMD_FRAME(8, 6),
    ANIMCMD_FRAME(8, 6),
...
static const union AnimCmd sAnim_GoFastSouthFollower[] =
{
    ANIMCMD_FRAME(1, 4),
    ANIMCMD_FRAME(2, 4),
    ANIMCMD_FRAME(2, 4),
...
static const union AnimCmd sAnim_GoFastNorthFollower[] =
{
    ANIMCMD_FRAME(3, 4),
    ANIMCMD_FRAME(4, 4),
    ANIMCMD_FRAME(4, 4),
...
static const union AnimCmd sAnim_GoFastWestFollower[] =
{
    ANIMCMD_FRAME(5, 4),
    ANIMCMD_FRAME(6, 4),
    ANIMCMD_FRAME(6, 4),
...
static const union AnimCmd sAnim_GoFastEastFollower[] =
{
...
static const union AnimCmd sAnim_GoFastEastFollowerAsym[] =
{
    ANIMCMD_FRAME(7, 4),
    ANIMCMD_FRAME(8, 4),
    ANIMCMD_FRAME(8, 4),
...
static const union AnimCmd sAnim_ExitPokeballEastAsym[] =
{
    ANIMCMD_FRAME(1, 1),
    ANIMCMD_FRAME(1, 3),
    ANIMCMD_FRAME(1, 1),
...
static const union AnimCmd sAnim_EnterEastAsym[] =
{
    ANIMCMD_FRAME(7, 8),
    ANIMCMD_FRAME(5, 1),
    ANIMCMD_FRAME(4, 1),
...
static const union AnimCmd sAnim_ExitPokeballFastEastAsym[] =
{
    ANIMCMD_FRAME(1, 1),
    ANIMCMD_FRAME(2, 1),
    ANIMCMD_FRAME(3, 1),
...
const union AnimCmd *const sAnimTable_Following[] = {
    [ANIM_STD_FACE_SOUTH] = sAnim_FaceSouthFollower,
    [ANIM_STD_FACE_NORTH] = sAnim_FaceNorthFollower,
    [ANIM_STD_FACE_WEST] = sAnim_FaceWestFollower,
    [ANIM_STD_FACE_EAST] = sAnim_FaceEastFollower,
    [ANIM_STD_GO_SOUTH] = sAnim_GoSouthFollower,
    [ANIM_STD_GO_NORTH] = sAnim_GoNorthFollower,
    [ANIM_STD_GO_WEST] = sAnim_GoWestFollower,
    [ANIM_STD_GO_EAST] = sAnim_GoEastFollower,
    [ANIM_STD_GO_FAST_SOUTH] = sAnim_GoFastSouthFollower,
    [ANIM_STD_GO_FAST_NORTH] = sAnim_GoFastNorthFollower,
    [ANIM_STD_GO_FAST_WEST] = sAnim_GoFastWestFollower,
    [ANIM_STD_GO_FAST_EAST] = sAnim_GoFastEastFollower,
...
const union AnimCmd *const sAnimTable_FollowingAsym[] = {
    [ANIM_STD_FACE_SOUTH] = sAnim_FaceSouthFollower,
    [ANIM_STD_FACE_NORTH] = sAnim_FaceNorthFollower,
    [ANIM_STD_FACE_WEST] = sAnim_FaceWestFollower,
    [ANIM_STD_FACE_EAST] = sAnim_FaceEastFollowerAsym,
    [ANIM_STD_GO_SOUTH] = sAnim_GoSouthFollower,
    [ANIM_STD_GO_NORTH] = sAnim_GoNorthFollower,
    [ANIM_STD_GO_WEST] = sAnim_GoWestFollower,
    [ANIM_STD_GO_EAST] = sAnim_GoEastFollowerAsym,
    [ANIM_STD_GO_FAST_SOUTH] = sAnim_GoFastSouthFollower,
    [ANIM_STD_GO_FAST_NORTH] = sAnim_GoFastNorthFollower,
    [ANIM_STD_GO_FAST_WEST] = sAnim_GoFastWestFollower,
    [ANIM_STD_GO_FAST_EAST] = sAnim_GoFastEastFollowerAsym,
    [ANIM_STD_GO_FASTER_SOUTH] = sAnim_EnterSouth,
    [ANIM_STD_GO_FASTER_NORTH] = sAnim_EnterNorth,
    [ANIM_STD_GO_FASTER_WEST] = sAnim_EnterWest,
    [ANIM_STD_GO_FASTER_EAST] = sAnim_EnterEastAsym,
    [ANIM_STD_GO_FASTEST_SOUTH] = sAnim_ExitPokeballSouth,
    [ANIM_STD_GO_FASTEST_NORTH] = sAnim_ExitPokeballNorth,
    [ANIM_STD_GO_FASTEST_WEST] = sAnim_ExitPokeballWest,
    [ANIM_STD_GO_FASTEST_EAST] = sAnim_ExitPokeballEastAsym,
    [ANIM_EXIT_POKEBALL_FAST_SOUTH] = sAnim_ExitPokeballFastSouth,
    [ANIM_EXIT_POKEBALL_FAST_NORTH] = sAnim_ExitPokeballFastNorth,
    [ANIM_EXIT_POKEBALL_FAST_WEST] = sAnim_ExitPokeballFastWest,
    [ANIM_EXIT_POKEBALL_FAST_EAST] = sAnim_ExitPokeballFastEastAsym,
};
