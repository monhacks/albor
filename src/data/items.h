...
// Mints
    ...
    [ITEM_LONELY_MINT] =
    {
        ...
        .secondaryId = NATURALEZA_OFENSIVA,
        .flingPower = 10,
    ...
    [ITEM_BOLD_MINT] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_Mint,
        .secondaryId = NATURALEZA_DEFENSIVA,
        .flingPower = 10,
        .iconPic = gItemIcon_Mint,
    ...
    [ITEM_MODEST_MINT] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_Mint,
        .secondaryId = NATURALEZA_OFENSIVA_ESPECIAL,
        .flingPower = 10,
        .iconPic = gItemIcon_Mint,
    ...
    [ITEM_CALM_MINT] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_Mint,
        .secondaryId = NATURALEZA_DEFENSIVA_ESPECIAL,
        .flingPower = 10,
        .iconPic = gItemIcon_Mint,
...
// Evolution Items
    ...
    [ITEM_ELECTIRIZER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "sube a su línea evolutiva\n"
            "25% de potencia."),
        .holdEffect = HOLD_EFFECT_ELECTRIZADOR,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_EvolutionStone,
        .effect = gItemEffect_EvoItem,
    ...
    [ITEM_MAGMARIZER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "sube a su línea evolutiva\n"
            "25% de potencia."),
        .holdEffect = HOLD_EFFECT_MAGMATIZADOR,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_EvolutionStone,
        .effect = gItemEffect_EvoItem,
...
// EV Gain Modifiers
    ...
    [ITEM_POWER_BRACER] =
    {
        ...
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .secondaryId = ESTADISTICA_ATAQUE,
        .flingPower = 70,
    ...
    [ITEM_POWER_BELT] =
    {
        ...
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .secondaryId = ESTADISTICA_DEFENSA,
        .flingPower = 70,
    ...
    [ITEM_POWER_LENS] =
    {
        ...
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .secondaryId = ESTADISTICA_ATAQUE_ESPECIAL,
        .flingPower = 70,
    ...
    [ITEM_POWER_BAND] =
    {
        ...
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .secondaryId = ESTADISTICA_DEFENSA_ESPECIAL,
        .flingPower = 70,
    ...
    [ITEM_POWER_ANKLET] =
    {
        ...
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .secondaryId = ESTADISTICA_VELOCIDAD,
        .flingPower = 70,
...
// Misc. Held Items
    ...
    {
        .name = _("Lodo negro"),
        .pluralName = _("Lodo negro"),
        .price = 2000,
        .holdEffect = HOLD_EFFECT_BLACK_SLUDGE,
        .description = COMPOUND_STRING(
            "Cura 6,25% de PS cada\n"
            "turno a tipo Veneno.\n"
            "Al resto, los daña."),
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
...
// Berries
    ...
    [ITEM_WACAN_BERRY] =
    {
        ...
        .price = (I_BERRY_PRICE >= GEN_8) ? 80 : 20,
        .holdEffect = HOLD_EFFECT_RESIST_BERRY,
        .holdEffectParam = TIPO_ELECTRICO,
        .description = COMPOUND_STRING(
            "A hold item that\n"
            "weakens a Electric\n"
            "move if weak to it."),
    ...
    [ITEM_COLBUR_BERRY] =
    {
        ...
        .price = (I_BERRY_PRICE >= GEN_8) ? 80 : 20,
        .holdEffect = HOLD_EFFECT_RESIST_BERRY,
        .holdEffectParam = TIPO_SINIESTRO,
        .description = COMPOUND_STRING(
            "A hold item that\n"
            "weakens a Dark\n"
            "move if weak to it."),
...
// Story Key Items
    ...
    [ITEM_RUBY] =
    {
        ...
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .iconPic = gItemIcon_RubySapphire,
