...
extern const struct UCoords8 sBattlerCoords[NUMERO_DE_MODOS][MAX_BATTLERS_COUNT] ;
...
{
    const u16 *paletteData; = GetMonSpritePalFromSpecies(species, isShiny, isFemale);
