...
{
    [NATURE_OFENSIVA]           = { ANIM_QUIRKY,  AFFINE_NONE },
    [NATURE_DEFENSIVA]          = { ANIM_QUIRKY,  AFFINE_NONE },
    [NATURE_OFENSIVA_ESPECIAL]  = { ANIM_QUIRKY,  AFFINE_NONE },
    [NATURE_DEFENSIVA_ESPECIAL] = { ANIM_QUIRKY,  AFFINE_NONE },
    [NATURE_RAPIDA]             = { ANIM_QUIRKY,  AFFINE_NONE },
};
