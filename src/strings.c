...
const u8 gText_Var1CantBeHeld[] = _("{STR_VAR_1} no puede llevarse.");
...
const u8 gText_12PoofForgotMove[] = _("1, {PAUSE 15}2, and{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_A}Poof!\p{STR_VAR_1} forgot how to\nuse {STR_VAR_2}.\pAnd…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnFueTransferidoAlPC[] = _("Se mandó a {STR_VAR_2} a\n{STR_VAR_1} del PC.");
const u8 gText_CajasLlenas[] = _("Todas las cajas están llenas.");
const u8 gText_HallOfFame[] = _("Paseo de la Fama");
...
const u8 gText_BattleBag[] = _("Mochila");
...
const u8 gText_DepositInWhichBox[] = _("¿En qué caja lo guardas?");
const u8 gText_PkmnWasDeposited[] = _("{DYNAMIC 0} fue depositado.");
const u8 gText_BoxIsFull2[] = _("La caja está llena.");
const u8 gText_ReleaseThisPokemon[] = _("¿Quieres liberar a {DYNAMIC 0}?");
...
const u8 gText_WithdrawMonDescription[] = _("Recoge los Pokémon de las cajas\na tu equipo.");
const u8 gText_DepositMonDescription[] = _("Guarda tus Pokémon en las cajas.");
const u8 gText_MoveMonDescription[] = _("Organiza los Pokémon en las cajas\no en el equipo.");
const u8 gText_MoveItemsDescription[] = _("Mueve los objetos equipados de\nlos Pokémon en cajas o en tu equipo.");
...
const u8 gText_MoveRelearnerAndPoof[] = _("{PAUSE 32}1, {PAUSE 15}2, and {PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_A}Poof!\p");
...
const u8 gText_Close[] = _("Salir");
const u8 gText_TMCaseWillBePutAway[] = _("Se apagará la\nmáquina de discos.");
