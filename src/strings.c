...
const u8 gText_TrainerCardTime[] = _("Tiempo de juego");
...
const u8 gText_ContinueMenuTime[] = _("Tiempo de juego");
...
const u8 gEasyChatGroupName_Time[] = _("Tiempo de juego");
...
const u8 gText_SavingTime[] = _("Tiempo de juego");
