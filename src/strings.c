...
const u8 gText_WithdrawMonDescription[] = _("Recoge los Pokémon\nde la caja a tu equipo.");
const u8 gText_DepositMonDescription[] = _("Guarda tus Pokémon\nen la caja.");
const u8 gText_MoveMonDescription[] = _("Organiza los Pokémon\nen caja o en el equipo.");
const u8 gText_MoveItemsDescription[] = _("Mueve los objetos equipados\nde Pokémon en caja o tu equipo.");
