...
const u32 gMoveTypePalNormal[] = INCBIN_U32("graphics/battle_interface/types/move_normal.gbapal.lz");
const u32 gMoveTypePalBug[] = INCBIN_U32("graphics/battle_interface/types/move_bug.gbapal.lz");
const u32 gMoveTypePalFire[] = INCBIN_U32("graphics/battle_interface/types/move_fire.gbapal.lz");
const u32 gMoveTypePalFairy[] = INCBIN_U32("graphics/battle_interface/types/move_fairy.gbapal.lz");
const u32 gMoveTypePalGrass[] = INCBIN_U32("graphics/battle_interface/types/move_grass.gbapal.lz");
const u32 gMoveTypePalFight[] = INCBIN_U32("graphics/battle_interface/types/move_fight.gbapal.lz");
const u32 gMoveTypePalFlying[] = INCBIN_U32("graphics/battle_interface/types/move_flying.gbapal.lz");
const u32 gMoveTypePalSteel[] = INCBIN_U32("graphics/battle_interface/types/move_steel.gbapal.lz");
const u32 gMoveTypePalWater[] = INCBIN_U32("graphics/battle_interface/types/move_water.gbapal.lz");
const u32 gMoveTypePalRock[] = INCBIN_U32("graphics/battle_interface/types/move_rock.gbapal.lz");
const u32 gMoveTypePalGround[] = INCBIN_U32("graphics/battle_interface/types/move_ground.gbapal.lz");
const u32 gMoveTypePalGhost[] = INCBIN_U32("graphics/battle_interface/types/move_ghost.gbapal.lz");
const u32 gMoveTypePalDragon[] = INCBIN_U32("graphics/battle_interface/types/move_dragon.gbapal.lz");
const u32 gMoveTypePalDark[] = INCBIN_U32("graphics/battle_interface/types/move_dark.gbapal.lz");
...
const u32 gBattleAnimSpriteGfx_EmboarCarga[] = INCBIN_U32("graphics/battle_anims/sprites/emboar_carga.4bpp.lz");
const u32 gBattleAnimSpritePal_Emboar[] = INCBIN_U32("graphics/battle_anims/sprites/emboar_carga.gbapal.lz");
