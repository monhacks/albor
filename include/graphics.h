...
extern const u32 gItemIconPalette_ChalecoAsalto[];
extern const u32 gItemIconPalette_ChalecoTactico[];
...
extern const u32 gMoveTypePalNormal[];
extern const u32 gMoveTypePalBug[];
extern const u32 gMoveTypePalFire[];
extern const u32 gMoveTypePalFairy[];
extern const u32 gMoveTypePalGrass[];
extern const u32 gMoveTypePalFight[];
extern const u32 gMoveTypePalFlying[];
extern const u32 gMoveTypePalSteel[];
extern const u32 gMoveTypePalWater[];
extern const u32 gMoveTypePalRock[];
extern const u32 gMoveTypePalGround[];
extern const u32 gMoveTypePalGhost[];
extern const u32 gMoveTypePalDragon[];
extern const u32 gMoveTypePalDark[];
...
extern const u32 gBattleAnimSpriteGfx_EmboarCarga[];
...
extern const u32 gBattleAnimSpritePal_Emboar[];
