...
enum Species
{
    ...
    SPECIES_DRAKLOAK,
    SPECIES_DRAGAPULT,
    SPECIES_ZIGZAGOON_GALAR, //FUERA
    SPECIES_LINOONE_GALAR, //FUERA
    SPECIES_TYPHLOSION_HISUI, //FUERA
    SPECIES_SNEASEL_HISUI, ////FUERA
    SPECIES_SAMUROTT_HISUI, //FUERA
    SPECIES_DECIDUEYE_HISUI, //FUERA
