...
enum BattleCommunication
{
    MULTIUSE_STATE,
    CURSOR_POSITION,
    TASK_ID = CURSOR_POSITION,
    SPRITES_INIT_STATE1 = CURSOR_POSITION,
    SPRITES_INIT_STATE2,
    MOVE_EFFECT_BYTE,
...
enum Various
{
    ...
    VARIOUS_SET_BEAK_BLAST,
    VARIOUS_SWAP_SIDE_STATUSES,
    VARIOUS_SWAP_STATS,
    VARIOUS_TEATIME_INVUL,
    VARIOUS_TEATIME_TARGETS,
    VARIOUS_TRY_WIND_RIDER_POWER,
    VARIOUS_ACTIVATE_WEATHER_CHANGE_ABILITIES,
    VARIOUS_ACTIVATE_TERRAIN_CHANGE_ABILITIES,
    VARIOUS_STORE_HEALING_WISH,
    VARIOUS_HIT_SWITCH_TARGET_FAILED,
    VARIOUS_TRY_REVIVAL_BLESSING,
