...
enum HoldEffects
{
    ...
    HOLD_EFFECT_MIRROR_HERB, // Not implemented.
    HOLD_EFFECT_PUNCHING_GLOVE,
    HOLD_EFFECT_COVERT_CLOAK,
    HOLD_EFFECT_LOADED_DICE,
    HOLD_EFFECT_BOOSTER_ENERGY, // Not implemented.
    HOLD_EFFECT_BERSERK_GENE,
    HOLD_EFFECT_CHALECO_TACTICO,
    HOLD_EFFECT_CUCHARA_TORCIDA,
    HOLD_EFFECT_ELECTRIZADOR,
    HOLD_EFFECT_MAGMATIZADOR,
    HOLD_EFFECT_DISCO_EXTRANO,
...
// Eliminar
enum HoldEffectParamsTerrain
{
    HOLD_EFFECT_PARAM_ELECTRIC_TERRAIN,
    HOLD_EFFECT_PARAM_GRASSY_TERRAIN,
    HOLD_EFFECT_PARAM_MISTY_TERRAIN,
