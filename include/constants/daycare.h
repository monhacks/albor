...
#define EGG_GENDER_MALE 32768  // used to create a male egg from a female-only parent species (e.g. Nidoran)
...
// Array buffers
#define EGG_MOVES_ARRAY_COUNT           19 //Revisar y aumentar
