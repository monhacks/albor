...
enum TextosBatalla
{
    TEXTO_BATALLA_INTRO, //hecho
    TEXTO_BATALLA_ENVIAR_POKEMON, //hecho
    STRINGID_RETURNMON,
    ...
    STRINGID_XFOUNDONEY,
    STRINGID_PLAYERDEFEATEDTRAINER,
    ...
    TEXTO_BATALLA_VICTORIA_ENTRENADOR,
