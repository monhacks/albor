...
#define BATTLE_TOWER_FUNC_LOAD_PARTNERS         8
#define BATTLE_TOWER_FUNC_PARTNER_MSG           9
#define BATTLE_TOWER_FUNC_LOAD_LINK_OPPONENTS   10
#define BATTLE_TOWER_FUNC_TRY_CLOSE_LINK        11
#define BATTLE_TOWER_FUNC_SET_PARTNER_GFX       12
#define BATTLE_TOWER_FUNC_SET_INTERVIEW_DATA    13
